...
class GEditor extends GObject {
    ...
    toParallax() {
        ...
        lHtml += sprintf(
            "<a href='#' class='Parallax4'>Ajouter un titre...</a>\n"
        );
        lHtml += sprintf("</div>\n");
        lHtml += sprintf("</div>\n");
    ...
    toSection() {
        ...
        lHtml += sprintf(
            "<a class='Section5' href='#'>Ajouter un titre...</a>\n"
        );
        lHtml += sprintf("</h1>\n");
        lHtml += sprintf(
    ...
    toSummary1() {
        ...
        lHtml += sprintf(
            "<a class='Summary3' href='#'>Modifier le titre principal...</a>\n"
        );
        lHtml += sprintf("</div>\n");
        lHtml += sprintf("</div>\n");
        return lHtml;
    ...
    toSummary2() {
        ...
        lHtml += sprintf(
            "<a class='Summary6' href='#'>Modifier le titre principal...</a>\n"
        );
        lHtml += sprintf("</div>\n");
        lHtml += sprintf("</div>\n");
        return lHtml;
    ...
    toTitle1(_id, _href, _text) {
        ...
        if (_id == "") {
            lHtml += sprintf(
                "<a class='Title2' href='#%s'>%s</a>\n",
                _href,
                _text
            );
        } else {
            lHtml += sprintf(
                "<a class='Title2' id='%s' href='#%s'>%s</a>\n",
                _id,
                _href,
                _text
            );
    ...
    toTitle2(_id, _href, _text) {
        ...
        if (_id == "") {
            lHtml += sprintf(
                "<a class='Title4' href='#%s'>%s</a>\n",
                _href,
                _text
            );
        } else {
            lHtml += sprintf(
                "<a class='Title4' id='%s' href='#%s'>%s</a>\n",
                _id,
                _href,
                _text
            );
    ...
    //===============================================
    toCode1() {
        var oCodeStore = GCodeStore.Instance();

        var lHtml = "";
        lHtml += sprintf("<pre class='GCode1 Code1 AceCode'");
        lHtml += sprintf(" data-mode='%s'", oCodeStore.getMode());
    ...
    toAccess2() {
        var lHtml = "";
        lHtml += sprintf(
            "<a class='GAccess2 Access2' href='/home'>Accueil</a>\n"
        );
        return lHtml;
    }
    //===============================================
    ...
    toPdfFile(_path) {
        var lPath = sprintf(
            "https://github.com/gkesse/ReadyDev/raw/2.0%s",
            _path
        );
        lPath = sprintf(
    ...
    toPdf1() {
        ...
        lHtml += sprintf(
            "<iframe class='Pdf2' src='%s' frameborder='0'>\n",
            lFile
        );
    ...
    toFormula1() {
        var lHtml = "";
        lHtml += sprintf(
            "<div class='GFormula1 Formula1'>Ajouter une formule...</div>\n"
        );
        return lHtml;
    }
    //===============================================
    ...
    toUpdateSummary1() {
        ...
        for (var i = 0; i < lSectionNs.length; i++) {
            ...
            var lSectionTN =
                lSectionN.firstElementChild.firstElementChild.firstElementChild
                    .firstElementChild;
    ...
    toUpdateTitle2() {
        ...
        for (var i = 0; i < lTitle2Ns.length; i++) {
            ...
            var lTitle2AI = sprintf(
                "%s_%s",
                lTitle1AI,
                lTitle2AT.getNormalize()
            );
    ...
    run(_method, _obj, _data) {
        ...
        } else if (_method == "delete_video_1") {
            //===============================================
            // videos
            //===============================================
            this.onDeleteVideo1(_obj, _data);
    ...
    onAddTextColor1(_obj, _data) {
        ...
        if (this.hasParent("GText2")) {
            this.m_logs.addError(
                "Vous êtes dans un effet texte couleur premier plan."
            );
            return false;
        }
        if (!this.isData()) {
    ...
    onUpdateTextColor1(_obj, _data) {
        ...
        if (!this.hasParent("GText2")) {
            this.m_logs.addError(
                "Vous n'êtes pas dans un effet texte couleur premier plan."
            );
            return false;
        }
    ...
    onAddText3(_obj, _data) {
        ...
        if (this.hasParent("GText3")) {
            this.m_logs.addError(
                "Vous êtes dans un effet texte icône bas horizontale."
            );
            return false;
        }
        if (this.isLine()) {
    ...
    onInsertText3Left(_obj, _data) {
        ...
        if (!this.hasParent("GText4")) {
            this.m_logs.addError(
                "Vous n'êtes pas dans un effet texte icône bas horizontale."
            );
            return false;
        }
    ...
    onDeleteText3Simple(_obj, _data) {
        ...
        if (!this.hasParent("GText3")) {
            this.m_logs.addError(
                "Vous n'êtes pas dans un effet texte icône bas horizontale groupe."
            );
            return false;
        }
        if (!this.hasParent("GText4")) {
            this.m_logs.addError(
                "Vous n'êtes pas dans un effet texte icône bas horizontale simple."
            );
            return false;
        }
    ...
    onUpdateTextImageLeft(_obj, _data) {
        ...
        if (!this.hasParent("GParallax1")) {
            this.m_logs.addError(
                "Vous n'êtes pas dans un effet texte image gauche."
            );
            return false;
        }
        ...
        var lBodyId = lNode.firstElementChild.nextElementSibling;
        var lTitleId =
            lNode.firstElementChild.firstElementChild.firstElementChild;
    ...
    // videos
    //===============================================
    onDeleteVideo1(_obj, _data) {
        if (!this.isEditor()) {
            this.m_logs.addError("La sélection est hors du cadre.");
            return false;
        }
        if (!this.hasParent("GVideo1")) {
            this.m_logs.addError("Vous n'êtes pas dans un effet video.");
            return false;
        }
        this.removeNode();
    }
    ...
    //===============================================
    onPasteVideoCB(_videoBlob) {
        var lNode = this.createNode(this.toPasteVideo());
        var lVideo = lNode.firstElementChild.firstElementChild;

        var lFileReader = new FileReader();

        lFileReader.onload = function(e) {
            lVideo.src = e.target.result;
            document.execCommand("insertHTML", false, lNode.outerHTML);
        };
    ...
    onAddAcess1(_obj, _data) {
        ...
        if (this.hasParent("GAccess1")) {
            this.m_logs.addError(
                "Vous êtes dans un effet barre d'accès rapide."
            );
            return false;
        }
        if (this.isLine()) {
    ...
    onInsertAcess1Left(_obj, _data) {
        ...
        if (!this.hasParent("GAccess2")) {
            this.m_logs.addError(
                "Vous n'êtes pas dans un effet barre d'accès rapide."
            );
            return false;
        }
    ...
    onPasteAccess1(_obj, _data) {
        ...
        if (!this.isNode("GAccess1")) {
            this.m_logs.addError(
                "Le noeud copié n'est pas un effet barre d'accès rapide."
            );
            return false;
        }
    ...
    onPasteSkill(_obj, _data) {
        ...
        if (!this.isNode("GSkill1")) {
            this.m_logs.addError(
                "Le noeud copié n'est pas un effet compétence."
            );
            return false;
        }
    ...
    onPasteGraduation(_obj, _data) {
        ...
        if (!this.isNode("GGraduation1")) {
            this.m_logs.addError(
                "Le noeud copié n'est pas un effet formation."
            );
            return false;
        }
    ...
    onAddLink3(_obj, _data) {
        ...
        if (this.hasParent("GLink3")) {
            this.m_logs.addError(
                "Vous êtes dans un effet lien simple externe."
            );
            return false;
        }
    ...
    onUpdateLink3(_obj, _data) {
        ...
        if (!this.hasParent("GLink3")) {
            this.m_logs.addError(
                "Vous n'êtes pas dans un effet lien simple externe."
            );
            return false;
        }
    ...
    onUpdateSummary1(_obj, _data) {
        ...
        if (!this.hasParent("GSummary1")) {
            this.m_logs.addError(
                "Vous n'êtes pas dans un effet sommaire principal."
            );
            return false;
        }
    ...
    onAddSummary2(_obj, _data) {
        ...
        if (this.hasParent("GSummary2")) {
            this.m_logs.addError(
                "Vous êtes dans un effet sommaire secondaire."
            );
            return false;
        }
        if (!this.hasParent("GSection1")) {
    ...
    onUpdateSummary2(_obj, _data) {
        ...
        if (!this.hasParent("GSummary2")) {
            this.m_logs.addError(
                "Vous n'êtes pas dans un effet sommaire secondaire."
            );
            return false;
        }
    ...
    onUpdateSummary3(_obj, _data) {
        ...
        if (!this.hasParent("GSummary3")) {
            this.m_logs.addError(
                "Vous n'êtes pas dans un effet sommaire tertiaire."
            );
            return false;
        }
    ...
    onUpdateTitle1(_obj, _data) {
        ...
        if (!this.hasParent("GTitle1")) {
            this.m_logs.addError(
                "Vous n'êtes pas dans un effet titre primaire."
            );
            return false;
        }
    ...
    onAddTitle2(_obj, _data) {
        ...
        if (this.isLine()) {
            ...
            document.execCommand(
                "insertHTML",
                false,
                this.toTitle2(lId, lHref, lTitle)
            );
        } else {
            document.execCommand(
                "insertHTML",
    ...
    onUpdateTitle2(_obj, _data) {
        ...
        if (!this.hasParent("GTitle2")) {
            this.m_logs.addError(
                "Vous n'êtes pas dans un effet titre secondaire."
            );
            return false;
        }
