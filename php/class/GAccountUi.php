<?php   
//===============================================
class GAccountUi extends GObjectUi {
    //===============================================
    ...
    public function run() {
        ...
        $lTitle         = $this->m_app->getItemC("user", "account", "title");
        $lIntro         = $this->m_app->getItemC("user", "account", "intro");
        $lModalId       = $this->m_app->getItemC("user", "account", "modal_id");
        $lBodyId        = $this->m_app->getItemC("user", "account", "body_id");
        $lFormId        = $this->m_app->getItemC("user", "account", "form_id");
        $lMsgId         = $this->m_app->getItemC("user", "account", "msg_id");
        $lModule        = $this->m_app->getItemC("user", "account", "module");
        $lKeypressCB    = $this->m_app->getItemC("user", "account", "keypress_cb");
        $lCloseCB       = $this->m_app->getItemC("user", "account", "close_cb");
        //
        ...
        for($i = 0; $i < $lCount; $i++) {
            $lCategory  = $this->m_app->getItem3("user", "category", $i);
            $lLabel     = $this->m_app->getItem3("user", "label", $i);
            $lId        = $this->m_app->getItem3("user", "id", $i);
            $lType      = $this->m_app->getItem3("user", "type", $i);
            $lName      = $this->m_app->getItem3("user", "name", $i);
        ...
        for($i = 0; $i < $lCount; $i++) {
            ...
            $lType      = $this->m_app->getItem3("user", "type", $i);
            $lId        = $this->m_app->getItem3("user", "id", $i);
            $lModule    = $this->m_app->getItem3("user", "module", $i);
            $lCallback  = $this->m_app->getItem3("user", "callback", $i);
            $lPicto     = $this->m_app->getItem3("user", "picto", $i);
            $lText      = $this->m_app->getItem3("user", "text", $i, true);
