...
class GHeaderUi extends GObjectUi {
    ...
    public function __construct() {
        ...
        $this->m_lang           = $this->m_app->getData("header", "lang");
        $this->m_title          = $this->m_app->getData("header", "title");
        $this->m_logo           = $this->m_app->getData("header", "logo");        
    }
    //===============================================
    public function run() {
    ...
    public function onFonts() {
        ...
        for($i = 0; $i < $lCount; $i++) {
            $lFont = $this->m_app->getData2("fonts", $i);
    ...
    public function onSite() {
        ...
        for($i = 0; $i < $lCount; $i++) {
            $lCategory  = $this->m_app->getData3("header", "category", $i);
            $lLink      = $this->m_app->getData3("header", "link", $i);
            $lClass     = $this->m_app->getData3("header", "class", $i);
            $lTitle     = $this->m_app->getData3("header", "title", $i);
            $lPicto     = $this->m_app->getData3("header", "picto", $i);
    ...
    public function getHappyYear() {
        $lHappy = $this->m_app->getData("happyyear", "msg");
        $lYear = date("Y");
