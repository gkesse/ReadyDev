<?php
//===============================================
class GConnectUi extends GObject {
    //===============================================
    public function __construct($_codeName = "connection") {
    ...
    public function run() {
        ...
        $lTitle         = $this->m_dom->getItemC("user", "connection", "title");
        $lIntro         = $this->m_dom->getItemC("user", "connection", "intro");
        $lModalId       = $this->m_dom->getItemC("user", "connection", "modal_id");
        $lBodyId        = $this->m_dom->getItemC("user", "connection", "body_id");
        $lFormId        = $this->m_dom->getItemC("user", "connection", "form_id");
        $lMsgId         = $this->m_dom->getItemC("user", "connection", "msg_id");
        $lModule        = $this->m_dom->getItemC("user", "connection", "module");
        $lKeypressCB    = $this->m_dom->getItemC("user", "connection", "keypress_cb");
        $lCloseCB       = $this->m_dom->getItemC("user", "connection", "close_cb");
        //
