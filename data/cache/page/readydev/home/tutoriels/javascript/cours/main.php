...
<div class="Section6"><br>L'opérateur (class) permet de créer une classe.<br><br>Création d'une classe.<br><br><pre class="GCode1 Code1 AceCode" data-mode="javascript" data-theme="gruvbox" data-bg-color="transparent" style="background-color: transparent;">//===============================================
class GObject {

}
//===============================================</pre><br>Une classe peut posséder un constructeur.<br><br>La méthode (constructor) permet de créer le constructeur d'une classe.<br><br><pre class="GCode1 Code1 AceCode" data-mode="javascript" data-theme="gruvbox" data-bg-color="transparent" style="background-color: transparent;">//===============================================
class GObject {
    //===============================================
    constructor() {
...
<i class="Bullet2 fa fa-check-square-o"></i>
<div class="Bullet3">La méthode (constructor) est appelée à chaque nouvelle création.</div>
</div>
<div class="GBullet1 Bullet1">
<i class="Bullet2 fa fa-check-square-o"></i>
<div class="Bullet3">JavaScript ne prend pas en charge la surcharge de constructeurs.</div>
</div>
<div class="GBullet1 Bullet1">
<i class="Bullet2 fa fa-check-square-o"></i>
<div class="Bullet3">Une classe JavaScript ne peut posséder qu'un seul constructeur.</div>
</div><br>Une classe peut posséder des attributs.<br><br>L'opérateur (this) permet créer des attributs dans le constructeur.<br><br><pre class="GCode1 Code1 AceCode" data-mode="javascript" data-theme="gruvbox" data-bg-color="transparent" style="background-color: transparent;">//===============================================
class GObject {
    //===============================================
    constructor() {
...
//===============================================</pre><br>Ce qu'il faut savoir:<br><br><div class="GBullet1 Bullet1">
<i class="Bullet2 fa fa-check-square-o"></i>
<div class="Bullet3">L'opérateur (this) permet d'accéder à un attribut au sein d'une méthode.</div>
</div><br>Une classe peut posséder des méthodes.&nbsp;<br><br><pre class="GCode1 Code1 AceCode" data-mode="javascript" data-theme="gruvbox" data-bg-color="transparent" style="background-color: transparent;">//===============================================
class GObject {
    //===============================================
    toWidth() {
...
//===============================================</pre><br>Ce qu'il faut savoir:<br><br><div class="GBullet1 Bullet1">
<i class="Bullet2 fa fa-check-square-o"></i>
<div class="Bullet3">L'opérateur (this) permet d'accéder à une méthode au sein d'une autre méthode.</div>
</div><br></div>
</div>
</div></div><br><div class="GSection1 Section1">
<div class="Section2">
...
<div class="Section6"><br>Définition de la classe mère.<br><br><pre class="GCode1 Code1 AceCode" data-mode="javascript" data-theme="gruvbox" data-bg-color="transparent" style="background-color: transparent;">//===============================================
class GObject {
    //===============================================
    constructor() {
        this.m_logs = new GLog();
...
//===============================================</pre><br>L'opérateur (extends) permet de créer un héritage de classe.<br>&nbsp;<br>La méthode (super) permet de bénéficier des attributs et des méthodes de la classe mère.<br><br>Création d'un héritage de classe.<br>&nbsp;<br><pre class="GCode1 Code1 AceCode" data-mode="javascript" data-theme="gruvbox" data-bg-color="transparent" style="background-color: transparent;">//===============================================
...
//===============================================</pre><br>Accès à un attribut de la classe mère.<br><br><pre class="GCode1 Code1 AceCode" data-mode="javascript" data-theme="gruvbox" data-bg-color="transparent" style="background-color: transparent;">//===============================================
class GTest extends GObject {
    //===============================================
...
//===============================================</pre><br>Définition de la classe fille.<br><br><pre class="GCode1 Code1 AceCode" data-mode="javascript" data-theme="gruvbox" data-bg-color="transparent" style="background-color: transparent;">//===============================================
...
//===============================================</pre><br>Utilisation du polymorphisme.<br><br>L'opérateur (this) permet d'identifier l'objet lui-même.<br><br><pre class="GCode1 Code1 AceCode" data-mode="javascript" data-theme="gruvbox" data-bg-color="transparent" style="background-color: transparent;">//===============================================
class GPage extends GObject {
    //===============================================
...
//===============================================</pre><br>Appels des méthodes polymorphes.<br><br><pre class="GCode1 Code1 AceCode" data-mode="javascript" data-theme="gruvbox" data-bg-color="transparent" style="background-color: transparent;">//===============================================
...
//===============================================</pre><br>Ce qu'il faut savoir:<br><br><div class="GBullet1 Bullet1">
<i class="Bullet2 fa fa-check-square-o"></i>
<div class="Bullet3">JavaScript possède un typage dynamique.</div>
</div><div class="GBullet1 Bullet1">
<i class="Bullet2 fa fa-check-square-o"></i>
<div class="Bullet3">Toutes les méthodes en JavaScript sont polymorphes.</div>
</div><br></div>
</div></div></div><br><div class="GSection1 Section1">
<div class="Section2">
<div class="Section3">
