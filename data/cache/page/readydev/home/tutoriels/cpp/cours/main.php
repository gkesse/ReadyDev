...
<i class="Summary2 fa fa-book"></i>
<a class="Summary3" href="#commandes-linux">Commandes Linux</a>
</div>
<div class="GSummary11 Summary1">
<i class="Summary2 fa fa-book"></i>
...
<div class="Section3">
<h1 class="Section4">
<a class="Section5" href="#" id="commandes-linux">Commandes Linux</a>
</h1>
<div class="Section6"><br>Linux est aujourd'hui considéré comme l'un des systèmes d'exploitation le plus performant et sécurisé. Cela s'avère d'autant plus vrai pour les développeurs. Open source et donc gratuit, Linux est un choix idéal pour développer, que ce soit en tant qu'amateur, étudiant ou professionnel.<br><br><div class="GSummary2"><div class="GSummary21 Summary4">
<i class="Summary5 fa fa-book"></i>
<a class="Summary6" href="#commandes-linux_mettre-a-jour-le-systeme">Mettre à jour le système</a>
</div>
<div class="GSummary21 Summary4">
<i class="Summary5 fa fa-book"></i>
<a class="Summary6" href="#commandes-linux_redemarrer-le-systeme">Redémarrer le système</a>
</div>
<div class="GSummary21 Summary4">
<i class="Summary5 fa fa-book"></i>
<a class="Summary6" href="#commandes-linux_arreter-le-systeme">Arrêter le système</a>
</div>
<div class="GSummary21 Summary4">
<i class="Summary5 fa fa-book"></i>
<a class="Summary6" href="#commandes-linux_installer-un-serveur-ssh">Installer un serveur SSH</a>
</div>
</div><br><h2 class="GTitle1 Title1">
<a class="Title2" id="commandes-linux_mettre-a-jour-le-systeme" href="#commandes-linux">Mettre à jour le système</a>
</h2><br>Dans le but d'augmenter les performances de notre système, nous devons le mettre à jour régulièrement.<br><br><pre class="GCode1 Code1 AceCode" data-mode="sh" data-theme="gruvbox" data-bg-color="transparent" style="background-color: transparent;">sudo apt update
sudo apt upgrade -y</pre><br><h2 class="GTitle1 Title1">
<a class="Title2" id="commandes-linux_redemarrer-le-systeme" href="#commandes-linux">Redémarrer le système</a>
</h2><br>Dans le but de prendre en compte certaines mises à jour sur notre système, nous devons dans certaines situations le redémarrer très rapidement.<br><br><pre class="GCode1 Code1 AceCode" data-mode="sh" data-theme="gruvbox" data-bg-color="transparent" style="background-color: transparent;">sudo shutdown -r now</pre><br><h2 class="GTitle1 Title1">
<a class="Title2" id="commandes-linux_arreter-le-systeme" href="#commandes-linux">Arrêter le système</a>
</h2><br>Dans le but de passer en mode inactivité et éviter la consommation en énergie, nous pouvons mettre notre système hors service.<br><br><pre class="GCode1 Code1 AceCode" data-mode="sh" data-theme="gruvbox" data-bg-color="transparent" style="background-color: transparent;">sudo shutdown -h now</pre><br><h2 class="GTitle1 Title1">
<a class="Title2" id="commandes-linux_installer-un-serveur-ssh" href="#commandes-linux">Installer un serveur SSH</a>
</h2><br>Dans le but de pouvoir accéder à notre système Linux depuis une autre machine (Windows) via un Terminal, nous devons installer un serveur SSH sur notre système Linux et un client SSH sur l'autre machine (Windows).<br><br><pre class="GCode1 Code1 AceCode" data-mode="sh" data-theme="gruvbox" data-bg-color="transparent" style="background-color: transparent;">sudo apt install openssh-server -y</pre><br></div>
</div>
</div>
</div><br><div class="GSection1 Section1">
<div class="Section2">
