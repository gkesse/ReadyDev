...
[ReadyDev](https://readydev.freeddns.org/Accueil/ "Accédez à mon site web (ReadyDev)") 
est une Plateforme de Développement Continu.  
Le but de ce document est de vous présenter le contenu du site 
[ReadyDev](https://readydev.freeddns.org/Accueil/ "Accédez à mon site web (ReadyDev)").  
Produit par [Gérard KESSE](https://readydev.freeddns.org/Accueil/ "Accédez à mon site web (ReadyDev)").
