...
"&gt;&lt;/div&gt;</xmp></pre></div><br><h3 class="Title8 GTitle3">Pied de page (Contenu)</h3><div class="GCode1"><pre class="Code2"><xmp class="AceCode" data-mode="html">&lt;div style="
    ...
    z-index: 1;
    border: 5px solid transparent;
"&gt;FOOTER&lt;/div&gt;</xmp></pre></div><br><h2 class="Title7 GTitle2" id="Interface Web-Résultat"><a class="Link9" href="#Interface Web">Résultat</a></h2><br><h3 class="Title8 GTitle3">Résultat</h3><div class="Img3 GImage"><img src="img/Interface_Web.png" alt="img/Interface_Web.png"></div></div></div></div></div><br>