...
//===============================================</xmp></pre></div><br><h2 class="Title7 GTitle2" id="Créer une machine à états finis en C#-Programme de chargement des données"><a class="Link9" href="#Créer une machine à états finis en C#">Programme de chargement des données</a></h2><br><h3 class="Title8 GTitle3">GProcessUi.cs</h3><br><div class="GCode1"><pre class="Code2"><xmp class="AceCode" data-mode="csharp">//===============================================
public void run_LOAD(string[] args) {
    GConfig.Instance().loadData("G_CSHARP_ID");
    G_STATE = "S_METHOD";
}
//===============================================
</xmp></pre></div><br><h2 class="Title7 GTitle2" id="Créer une machine à états finis en C#-Programme des méthodes"><a class="Link9" href="#Créer une machine à états finis en C#">Programme des méthodes</a></h2><br><h3 class="Title8 GTitle3">GProcessUi.cs</h3><br><div class="GCode1"><pre class="Code2"><xmp class="AceCode" data-mode="csharp">//===============================================
