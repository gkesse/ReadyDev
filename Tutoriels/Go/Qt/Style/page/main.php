...
//===============================================</xmp></pre></div><br><h3 class="Title8 GTitle3">GManager.go</h3><br><div class="GCode1"><pre class="Code2"><xmp class="AceCode" data-mode="golang">obj.mgr.app.style_path = "data/css/style.css"</xmp></pre></div><br><h2 class="Title7 GTitle2" id="Ajouter un style Qt en Go-Ajouter un style"><a class="Link9" href="#Ajouter un style Qt en Go">Ajouter un style</a></h2><br><h3 class="Title8 GTitle3">GManager.go</h3><br><div class="GCode1"><pre class="Code2"><xmp class="AceCode" data-mode="golang">//===============================================
...
//===============================================</xmp></pre></div><br><h2 class="Title7 GTitle2" id="Ajouter un style Qt en Go-Style commun"><a class="Link9" href="#Ajouter un style Qt en Go">Style commun</a></h2><br><h3 class="Title8 GTitle3">style.css</h3><br><div class="GCode1"><pre class="Code2"><xmp class="AceCode" data-mode="css">/*===============================================*/
/* QWidget */
QWidget, QWidget * {
...
/*===============================================*/</xmp></pre></div><br><h2 class="Title7 GTitle2" id="Ajouter un style Qt en Go-Style personnalisé"><a class="Link9" href="#Ajouter un style Qt en Go">Style personnalisé</a></h2><br><h3 class="Title8 GTitle3">style.css</h3><br><div class="GCode1"><pre class="Code2"><xmp class="AceCode" data-mode="css">/*===============================================*/
/* GTitleBar */
QFrame#GTitleBar * {
