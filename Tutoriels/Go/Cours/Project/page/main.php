...
//===============================================</xmp></pre></div><br><h2 class="Title7 GTitle2" id="Créer un projet Go-Fichier Makefile"><a class="Link9" href="#Créer un projet Go">Fichier Makefile</a></h2><br><h3 class="Title8 GTitle3">Makefile (MinGW - Windows)<br></h3><br><div class="GCode1"><pre class="Code2"><xmp class="AceCode" data-mode="makefile">GSRC = ..\code\GProject\src
GBIN = bin
...
clean: 
	@if not exist $(GBIN) ( @mkdir $(GBIN) )
	del /q $(GBIN)\*</xmp></pre></div><br><h2 class="Title7 GTitle2" id="Créer un projet Go-Variables d'environnement"><a class="Link9" href="#Créer un projet Go">Variables d'environnement</a></h2><br><h3 class="Title8 GTitle3">env.bat (Windows)<br></h3><br><div class="GCode1"><pre class="Code2"><xmp class="AceCode" data-mode="batchfile">@echo off
::=====================================
set "PATH=C:\TDM-GCC-64\bin;%PATH%"
::=====================================
set "GOPATH=C:\Users\Admin\Downloads\Programs\ReadyGo\code\GProject;%GOPATH%"
::=====================================</xmp></pre></div><br><h3 class="Title8 GTitle3">make.bat (MinGW - Windows)<br></h3><br><div class="GCode1"><pre class="Code2"><xmp class="AceCode" data-mode="batchfile">@echo off
::=====================================
mingw32-make %*
::=====================================</xmp></pre></div><br><h2 class="Title7 GTitle2" id="Créer un projet Go-Compilation automatique"><a class="Link9" href="#Créer un projet Go">Compilation automatique</a></h2><br><h3 class="Title8 GTitle3">Terminal<br></h3><br><div class="GCode1"><pre class="Code2"><xmp class="AceCode" data-mode="batchfile">make</xmp></pre></div><br><h2 class="Title7 GTitle2" id="Créer un projet Go-Compilation manuelle"><a class="Link9" href="#Créer un projet Go">Compilation manuelle</a></h2><br><h3 class="Title8 GTitle3">Terminal (Windows)<br></h3><br><div class="GCode1"><pre class="Code2"><xmp class="AceCode" data-mode="batchfile">del /q bin\*
