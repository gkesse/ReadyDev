...
::=====================================</xmp></pre></div><br><h2 class="Title7 GTitle2" id="Créer un projet Go-Compilation automatique"><a class="Link9" href="#Créer un projet Go">Compilation automatique</a></h2><br><h3 class="Title8 GTitle3">make.bat (Windows)<br></h3><br><div class="GCode1"><pre class="Code2"><xmp class="AceCode" data-mode="batchfile">@echo off
::=====================================
mingw32-make %*
...
make</xmp></pre></div><br><h2 class="Title7 GTitle2" id="Créer un projet Go-Compilation manuelle"><a class="Link9" href="#Créer un projet Go">Compilation manuelle</a></h2><br><h3 class="Title8 GTitle3">Terminal (Windows)<br></h3><br><div class="GCode1"><pre class="Code2"><xmp class="AceCode" data-mode="batchfile">del /q bin\*
