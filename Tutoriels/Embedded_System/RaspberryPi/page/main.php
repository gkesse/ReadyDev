...
CONF_VERSION = "1"</xmp></pre></div><br><h3 class="Title8 GTitle3">Configurer les couches</h3><br><span class="GColor1" style="color:lime;">poky/onf/bblayers.conf</span><br><br><div class="GCode1"><pre class="Code2"><xmp class="AceCode" data-mode="sh">POKY_BBLAYERS_CONF_VERSION = "2"
