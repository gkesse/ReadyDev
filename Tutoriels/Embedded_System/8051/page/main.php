...
0   | 1   | Mode 1 : Timer/Compteur 16 bits.
1   | 0   | Mode 2 : Timer/compteur 8 bits auto-rechargeable.
1   | 1   | Mode 3 : Timer/compteur 8 bits.</pre></div></div><br><h2 class="Title7 GTitle2" id="Boucle-infinie-Calculer-les-valeurs-de-prechargement-des-Timers"><a class="Link9" href="#Boucle-infinie">Calculer les valeurs de préchargement des Timers</a></h2><br><h3 class="Title8 GTitle3">Calculer les valeurs de préchargement</h3><br><div class="Img3 GImage"><img src="/Tutoriels/Embedded_System/8051/img/i_delay_hardware.png" alt="/Tutoriels/Embedded_System/8051/img/i_delay_hardware.png"></div><br><div class="Formula GFormula1"><div class="Formula2">\begin{eqnarray}
...
\end{eqnarray}</div></div><br><h2 class="Title7 GTitle2" id="Boucle-infinie-Creer-une-architecture-boucle-infinie-base-sur-un-delai-logiciel"><a class="Link9" href="#Boucle-infinie">Créer une architecture boucle infinie basé sur un délai logiciel</a></h2><br>Un délai est un temps accordé pour faire une chose, ou à l’expiration duquel on sera tenu de faire une certaine chose. Le <b>délai logiciel</b> est plus simple à mettre en œuvre, mais il est moins précis. Il est basé sur l'utilisation d'une boucle for.<br><br><h3 class="Title8 GTitle3">main.c</h3><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-state="off" data-mode="c_cpp">//===============================================
#include &lt;reg52.h&gt;
//===============================================
