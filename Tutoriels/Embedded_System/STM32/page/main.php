...
Apply and Close</xmp></pre></div><br><h2 class="Title7 GTitle2" id="Tests-1.1.5 - Compiler le projet"><a class="Link9" href="#Tests">1.1.5 - Compiler le projet</a></h2><br><div class="GCode1"><pre class="Code2"><xmp class="AceCode" data-mode="txt">STM32CubeIDE
Project -&gt; Build</xmp></pre></div><br><h2 class="Title7 GTitle2" id="Tests-1.1.6 - Simulation du projet"><a class="Link9" href="#Tests">1.1.6 - Simulation du projet</a></h2><br><h2 class="Title7 GTitle2" id="Tests-1.1.6.1 - Simulation sous Proteus"><a class="Link9" href="#Tests">1.1.6.1 - Simulation sous Proteus</a></h2><br><div class="Img3 GImage"><img src="/Tutoriels/Embedded_System/STM32/img/i_stm32_test.gif" alt="/Tutoriels/Embedded_System/STM32/img/i_stm32_test.gif"></div><br></div></div></div></div><br>