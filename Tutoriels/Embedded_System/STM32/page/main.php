...
Yes</xmp></pre></div><br><h2 class="Title7 GTitle2" id="Tests-1.1.3 - Éditer le programme C"><a class="Link9" href="#Tests">1.1.3 - Éditer le programme C</a></h2><br><br><br><br>ReadyApp -&gt; Clic droit -&gt; Properties<br>C/C++ Build -&gt; Settings -&gt; Tool Settings -&gt; MCU Post Build Outputs<br>Cocher -&gt; Convert to Intel HEX File (-O ihex)<br>Apply and Close<br><br><br></div></div></div></div><br>