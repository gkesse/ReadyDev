...
//===============================================</xmp></pre></div><br><h2 class="Title7 GTitle2" id="Créer un fichier MANIFEST.MF-Programme de Test"><a class="Link9" href="#Créer un fichier MANIFEST.MF">Programme de Test</a></h2><br><h3 class="Title8 GTitle3">Programme de Test (GMain.java)</h3><div class="GCode1"><pre class="Code2"><xmp class="AceCode" data-mode="java">//===============================================
import manager.GMath;
//===============================================
public class GMain {
    public static void main(String[] args){
...
//===============================================</xmp></pre></div><br><h2 class="Title7 GTitle2" id="Créer un fichier MANIFEST.MF-Compiler le projet"><a class="Link9" href="#Créer un fichier MANIFEST.MF">Compiler le projet</a></h2><br><h3 class="Title8 GTitle3">Compiler le projet</h3><div class="GCode1"><pre class="Code2"><xmp class="AceCode" data-mode="batchfile">@echo off
...
javac %GSRC%\GMain.java ^
-d %GBUILD% ^
-sourcepath %GSRCPATH%</xmp></pre></div><br><h2 class="Title7 GTitle2" id="Créer un fichier MANIFEST.MF-Fichier MANIFEST.MF"><a class="Link9" href="#Créer un fichier MANIFEST.MF">Fichier MANIFEST.MF</a></h2><br><h3 class="Title8 GTitle3">Fichier MANIFEST.MF</h3><div class="GCode1"><pre class="Code2"><xmp class="AceCode" data-mode="batchfile">Manifest-Version: 1.0
Created-By: Gerard KESSE
Main-Class: GMain</xmp></pre></div><br><h2 class="Title7 GTitle2" id="Créer un fichier MANIFEST.MF-Créer le fichier exécutable"><a class="Link9" href="#Créer un fichier MANIFEST.MF">Créer le fichier exécutable</a></h2><br><h3 class="Title8 GTitle3">Créer le fichier exécutable</h3><div class="GCode1"><pre class="Code2"><xmp class="AceCode" data-mode="batchfile">@echo off
...
-C %GBUILD% .
echo.</xmp></pre></div><br><div class="Img3 GImage"><img src="img/Fichier_Manifest.png" alt="img/Fichier_Manifest.png"></div><br><h2 class="Title7 GTitle2" id="Créer un fichier MANIFEST.MF-Exécuter le projet"><a class="Link9" href="#Créer un fichier MANIFEST.MF">Exécuter le projet</a></h2><br><h3 class="Title8 GTitle3">Exécuter le projet</h3><div class="GCode1"><pre class="Code2"><xmp class="AceCode" data-mode="batchfile">@echo off
