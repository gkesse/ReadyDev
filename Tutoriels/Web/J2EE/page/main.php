...
&lt;Server port="8005" shutdown="SHUTDOWN"&gt;
    ...
    &lt;/Service&gt;
    &lt;!-- ============================================ --&gt;
&lt;/Server&gt;</pre></div></div><br><h2 class="Title7 GTitle2" id="Tests-1-1-3---Editer-le-programme-HTML"><a class="Link9" href="#Tests">1.1.3 - Éditer le programme HTML</a></h2><br><h3 class="Title8 GTitle3">index.html</h3><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-mode="html">&lt;!-- ============================================ --&gt;
&lt;!DOCTYPE html&gt;
&lt;html lang="fr"&gt;
    &lt;!-- ============================================ --&gt;
    &lt;head&gt;
    ...
    &lt;!-- ============================================ --&gt;
&lt;/html&gt;
&lt;!-- ============================================ --&gt;</pre></div></div><br><h2 class="Title7 GTitle2" id="Tests-1-1-4---Demarrer-le-serveur"><a class="Link9" href="#Tests">1.1.4 - Démarrer le serveur</a></h2><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-mode="html">set "PATH=C:\Program Files\Apache Software Foundation\Tomcat 7.0\bin;%PATH%"</pre></div></div><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-mode="txt">tomcat7w</pre></div></div><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-mode="txt">Start</pre></div></div><br><h2 class="Title7 GTitle2" id="Tests-1-1-5---Afficher-la-page-web"><a class="Link9" href="#Tests">1.1.5 - Afficher la page web</a></h2><br><a class="Link7 GLink1" style="color:lime;" target="_blank" href="http://localhost:8585/">http://localhost:8585/</a><br><br><div class="Img3 GImage"><img alt="/Tutoriels/Web/J2EE/img/i_j2ee_test.png" class="lazy" data-src="/Tutoriels/Web/J2EE/img/i_j2ee_test.png"></div><br></div></div></div></div><br><div class="Content2 GTitle1"><div class="MainBlock2"><div class="Content"><h1 class="Title2 Center" id="Servlet"><a class="Link3" href="#">Servlet</a></h1><div class="Body3"><br>Créer un servlet en J2EE.<br><br><div class="Content0 GSummary2"><div class="Body0" id="Loader_1619190946627"><div class="Row26">Summary 2</div></div><script>loadSummary2("Loader_1619190946627");</script></div><br><h2 class="Title7 GTitle2" id="Servlet-Introduction"><a class="Link9" href="#Servlet">Introduction</a></h2><br>Un servlet est une classe Java qui permet de créer dynamiquement des données au sein d'un serveur HTTP. Ces données sont le plus généralement présentées au format HTML.<br><br><h2 class="Title7 GTitle2" id="Servlet-Structure-du-projet"><a class="Link9" href="#Servlet">Structure du projet</a></h2><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-mode="txt">REPERTOIRE_PROJET -&gt; \code\
...
FICHIER_SERVLET   -&gt; \code\webapp\src\WEB-INF\sources\GMain.java</pre></div></div><br><h2 class="Title7 GTitle2" id="Servlet-Editer-le-programme-HTML"><a class="Link9" href="#Servlet">Éditer le programme HTML</a></h2><br><h3 class="Title8 GTitle3">index.html</h3><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-mode="html">&lt;!-- ============================================ --&gt;
&lt;html&gt;
    &lt;!-- ============================================ --&gt;
    &lt;head&gt;
    ...
    &lt;!-- ============================================ --&gt;
&lt;/html&gt;
&lt;!-- ============================================ --&gt;</pre></div></div><br><h2 class="Title7 GTitle2" id="Servlet-Configurer-le-servlet"><a class="Link9" href="#Servlet">Configurer le servlet</a></h2><br><h3 class="Title8 GTitle3">web.xml</h3><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-mode="xml">&lt;?xml version="1.0" encoding="UTF-8"?&gt;
&lt;!-- ============================================ --&gt;
&lt;web-app 
    ...
    &lt;!-- ============================================ --&gt;
&lt;/web-app&gt;
&lt;!-- ============================================ --&gt;</pre></div></div><br><h2 class="Title7 GTitle2" id="Servlet-Editer-le-servlet"><a class="Link9" href="#Servlet">Éditer le servlet</a></h2><br><h3 class="Title8 GTitle3">GMain.java</h3><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-mode="java">//===============================================
...
//===============================================</pre></div></div><br><h2 class="Title7 GTitle2" id="Servlet-Compiler-le-srvlet"><a class="Link9" href="#Servlet">Compiler le srvlet</a></h2><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-mode="batchfile">set "PATH=C:\Program Files\Java\jdk-15.0.1\bin;%PATH%"
...
</pre></div></div><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-mode="batchfile">javac sources\com\pkg\readyapp\GMain.java ^
-d classes ^
-sourcepath sources</pre></div></div><br><h2 class="Title7 GTitle2" id="Servlet-Contenu-du-repertoire-web"><a class="Link9" href="#Servlet">Contenu du répertoire web</a></h2><br><h3 class="Title8 GTitle3">WEB-INF</h3><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-mode="txt">│   web.xml
│
├───classes
│   └───com
│       └───pkg
...
└───sources
    └───com
        └───pkg
            └───readyapp
                    GMain.java</pre></div></div><br><h2 class="Title7 GTitle2" id="Servlet-Afficher-la-page-web"><a class="Link9" href="#Servlet">Afficher la page web</a></h2><br><a class="Link7 GLink1" style="color:lime;" target="_blank" href="http://localhost:8585/">http://localhost:8585/</a><br><a class="Link7 GLink1" style="color:lime;" target="_blank" href="http://localhost:8585/home/">http://localhost:8585/home/</a><br><br><div class="Img3 GImage"><img alt="/Tutoriels/Web/J2EE/img/i_j2ee_servlet.png" class="lazy" data-src="/Tutoriels/Web/J2EE/img/i_j2ee_servlet.png"></div><br></div></div></div></div><br>