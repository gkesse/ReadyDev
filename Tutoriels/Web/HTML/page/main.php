...
&lt;html lang="fr"&gt;
    ...
    &lt;body&gt;
        ...
        &lt;!-- ============================================ --&gt;
    &lt;/body&gt;
&lt;/html&gt;</pre></div></div><br><h3 class="Title8 GTitle3">Résultat</h3><br><div class="Img3 GImage"><img alt="/Tutoriels/Web/HTML/img/i_html_minimal.png" class="lazy" data-src="/Tutoriels/Web/HTML/img/i_html_minimal.png"></div><br><h2 class="Title7 GTitle2" id="Fondamentaux-Creer-un-element-xmp"><a class="Link9" href="#Fondamentaux">Créer un élément xmp</a></h2><br>L'élément HTML &lt;<b>xmp</b>&gt; (pour example) affiche le texte entre les balises d'ouverture et de fermeture sans interpréter le HTML qu'il contient et en utilisant une police à chasse fixe. La spécification HTML 2 recommande un affichage suffisamment large pour contenir 80 caractères par ligne.<br><br><h3 class="Title8 GTitle3">index.html</h3><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-mode="html">&lt;!DOCTYPE html&gt;
&lt;html lang="fr"&gt;
    &lt;head&gt;
        &lt;title&gt;ReadyApp&lt;/title&gt;
    &lt;/head&gt;
...
&lt;/html&gt;
        ...
        &lt;!-- ============================================ --&gt;
    &lt;/body&gt;
&lt;/html&gt;</pre></div></div><br><h3 class="Title8 GTitle3">Résultat</h3><br><div class="Img3 GImage"><img alt="/Tutoriels/Web/HTML/img/i_html_xmp.png" class="lazy" data-src="/Tutoriels/Web/HTML/img/i_html_xmp.png"></div><br><h2 class="Title7 GTitle2" id="Fondamentaux-Creer-un-element-pre"><a class="Link9" href="#Fondamentaux">Créer un élément pre</a></h2><br>L'élément HTML &lt;<b>pre</b>&gt; représente du texte préformaté, généralement écrit avec une police à chasse fixe. Le texte est affiché tel quel, les espaces utilisés dans le document HTML seront retranscrits. Il est nécessaire d'échapper les caractères '&lt;' en &amp;lt; afin de s'assurer que le code écrit entre les éléments ne soit pas interprété de façon involontaire.<br><br><h3 class="Title8 GTitle3">index.html</h3><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-mode="html">&lt;!DOCTYPE html&gt;
&lt;html lang="fr"&gt;
    &lt;head&gt;
        &lt;title&gt;ReadyApp&lt;/title&gt;
    &lt;/head&gt;
...
&lt;/html&gt;
        ...
        &lt;!-- ============================================ --&gt;
    &lt;/body&gt;
&lt;/html&gt;</pre></div></div><br><h3 class="Title8 GTitle3">Résultat</h3><br><div class="Img3 GImage"><img alt="/Tutoriels/Web/HTML/img/i_html_pre.png" class="lazy" data-src="/Tutoriels/Web/HTML/img/i_html_pre.png"></div><br><h2 class="Title7 GTitle2" id="Fondamentaux-Creer-un-element-code"><a class="Link9" href="#Fondamentaux">Créer un élément code</a></h2><br>L'élément HTML &lt;<b>code</b>&gt; représente un fragment de code machine. Par défaut, l'agent utilisateur utilise une police à chasse fixe (monospace) afin d'afficher le texte contenu dans cet élément.<br><br><h3 class="Title8 GTitle3">index.html</h3><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-mode="html">&lt;!DOCTYPE html&gt;
&lt;html lang="fr"&gt;
    &lt;head&gt;
        &lt;title&gt;ReadyApp&lt;/title&gt;
    &lt;/head&gt;
    &lt;body&gt;
        ...
        &lt;!-- ============================================ --&gt;
    &lt;/body&gt;
&lt;/html&gt;</pre></div></div><br><h3 class="Title8 GTitle3">Résultat</h3><br><div class="Img3 GImage"><img alt="/Tutoriels/Web/HTML/img/i_html_code.png" class="lazy" data-src="/Tutoriels/Web/HTML/img/i_html_code.png"></div><br><h2 class="Title7 GTitle2" id="Fondamentaux-Creer-un-element-samp"><a class="Link9" href="#Fondamentaux">Créer un élément samp</a></h2><br>L'élément HTML &lt;<b>samp</b>&gt; est un élément qui permet de représenter un résultat produit par un programme informatique. Il est généralement affiché avec la police à chasse fixe du navigateur (par exemple en Courier ou en Lucida Console).<br><br><h3 class="Title8 GTitle3">index.html</h3><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-mode="html">&lt;!DOCTYPE html&gt;
&lt;html lang="fr"&gt;
    &lt;head&gt;
        &lt;title&gt;ReadyApp&lt;/title&gt;
    &lt;/head&gt;
