...
if($lUploadFlag) {
    ...
    if($lUploadValid) {
        ...
        $lMoveFlag = move_uploaded_file($_FILES["upload_file"]["tmp_name"], $lUploadFile);
...
echo sprintf("&lt;/html&gt;\n");
//===============================================
?&gt;</pre></div></div><br><h3 class="Title8 GTitle3">Résultat</h3><br><br></div></div></div></div><br><div class="Content2 GTitle1"><div class="MainBlock2"><div class="Content"><h1 class="Title2 Center" id="LazyLoad"><a class="Link3" href="#">LazyLoad</a></h1><div class="Body3"><br><b>LazyLoad </b>est un script léger et flexible qui accélère votre site Web en reportant le chargement de vos images, arrière-plans, vidéos, iframes et scripts sous le pli au moment où ils entreront dans la fenêtre. Écrit en JavaScript «vanille», il exploite IntersectionObserver, prend en charge les images réactives et permet le chargement paresseux natif.<br><br><div class="Content0 GSummary2"><div class="Item4"><i class="Icon10 fa fa-book"></i><a class="Link4" href="#LazyLoad-Charger-une-image-par-LazyLoad">Charger une image par LazyLoad</a></div></div><br><h2 class="Title7 GTitle2" id="LazyLoad-Charger-une-image-par-LazyLoad"><a class="Link9" href="#LazyLoad">Charger une image par LazyLoad</a></h2><br><h3 class="Title8 GTitle3">index.php</h3><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-mode="php">&lt;?php
//===============================================
echo sprintf("&lt;!DOCTYPE html&gt;\n");
echo sprintf("&lt;html lang='fr'&gt;\n");
echo sprintf("&lt;head&gt;\n");
