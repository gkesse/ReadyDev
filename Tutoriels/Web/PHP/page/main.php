<div class="Parallax GParallax1"><div class="Img Binary"><div class="Caption"><a href="#"><div class="Text">Programmation web en PHP<br></div></a></div></div><div class="Body2 Orange"><br>Le but de ce tutoriel est de vous apprendre la programmation web en <b>PHP</b>.<br>Produit par <b>Gérard KESSE</b>.<br><br><div class="Content0 GSummary1"><div class="Item4"><span class="Icon10 fa fa-book"></span><a class="Link4" href="#Introduction">Introduction</a></div><div class="Item4"><span class="Icon10 fa fa-book"></span><a class="Link4" href="#Fondamentaux">Fondamentaux</a></div><div class="Item4"><span class="Icon10 fa fa-book"></span><a class="Link4" href="#Tableaux">Tableaux</a></div><div class="Item4"><span class="Icon10 fa fa-book"></span><a class="Link4" href="#Tableaux-associatifs">Tableaux associatifs</a></div><div class="Item4"><span class="Icon10 fa fa-book"></span><a class="Link4" href="#Programmation-orientee-objet">Programmation orientée objet</a></div><div class="Item4"><span class="Icon10 fa fa-book"></span><a class="Link4" href="#Patrons-de-conception">Patrons de conception</a></div><div class="Item4"><span class="Icon10 fa fa-book"></span><a class="Link4" href="#Methodes-magiques">Méthodes magiques</a></div><div class="Item4"><span class="Icon10 fa fa-book"></span><a class="Link4" href="#Systeme-d-hebergement-de-fichiers">Système d'hébergement de fichiers</a></div><div class="Item4"><span class="Icon10 fa fa-book"></span><a class="Link4" href="#LazyLoad">LazyLoad</a></div><div class="Item4"><span class="Icon10 fa fa-book"></span><a class="Link4" href="#GTmetrix">GTmetrix</a></div></div><br></div></div><br><div class="Content2 GTitle1"><div class="MainBlock2"><div class="Content"><h1 class="Title2 Center" id="Introduction"><a class="Link3" href="#">Introduction</a></h1><div class="Body3"><br><b>PHP </b>est un langage de programmation libre, principalement utilisé pour produire des pages Web dynamiques via un serveur HTTP, mais pouvant également fonctionner comme n'importe quel langage interprété de façon locale. PHP est un langage impératif orienté objet. PHP a permis de créer un grand nombre de sites web célèbres, comme Facebook et Wikipédia. Il est considéré comme une des bases de la création de sites web dits dynamiques mais également des applications web. <br><br><div class="Img3 GImage"><img alt="/Tutoriels/Web/PHP/img/b_php.png" class="lazy entered loaded" data-src="/Tutoriels/Web/PHP/img/b_php.png" data-ll-status="loaded" src="/Tutoriels/Web/PHP/img/b_php.png"></div><br></div></div></div></div><br><div class="Content2 GTitle1"><div class="MainBlock2"><div class="Content"><h1 class="Title2 Center" id="Fondamentaux"><a class="Link3" href="#">Fondamentaux</a></h1><div class="Body3"><br>Les fondamentaux de PHP.<br><br><div class="Content0 GSummary2"><div class="Item4"><i class="Icon10 fa fa-book"></i><a class="Link4" href="#Fondamentaux-Installer-l-environnement-PHP-avec-WampServer-sous-Windows">Installer l'environnement PHP avec WampServer sous Windows</a></div><div class="Item4"><i class="Icon10 fa fa-book"></i><a class="Link4" href="#Fondamentaux-Installer-l-environnement-PHP-avec-MAMP-sous-Mac">Installer l'environnement PHP avec MAMP sous Mac</a></div><div class="Item4"><i class="Icon10 fa fa-book"></i><a class="Link4" href="#Fondamentaux-Installer-l-environnement-PHP-avec-LAMP-sous-Ubuntu">Installer l'environnement PHP avec LAMP sous Ubuntu</a></div><div class="Item4"><i class="Icon10 fa fa-book"></i><a class="Link4" href="#Fondamentaux-Tester-un-projet-PHP-avec-WampServer-sous-Windows">Tester un projet PHP avec WampServer sous Windows</a></div><div class="Item4"><i class="Icon10 fa fa-book"></i><a class="Link4" href="#Fondamentaux-Creer-un-passage-par-reference">Créer un passage par référence</a></div><div class="Item4"><i class="Icon10 fa fa-book"></i><a class="Link4" href="#Fondamentaux-Appeler-une-fonction-de-rappel">Appeler une fonction de rappel</a></div><div class="Item4"><i class="Icon10 fa fa-book"></i><a class="Link4" href="#Fondamentaux-Creer-une-reecriture-d-URL">Créer une réécriture d'URL</a></div><div class="Item4"><i class="Icon10 fa fa-book"></i><a class="Link4" href="#Fondamentaux-Creer-une-normalisation-unicode">Créer une normalisation unicode</a></div><div class="Item4"><i class="Icon10 fa fa-book"></i><a class="Link4" href="#Fondamentaux-Ouvrir-le-debogueur-web-sous-Firefox">Ouvrir le débogueur web sous Firefox</a></div><div class="Item4"><i class="Icon10 fa fa-book"></i><a class="Link4" href="#Fondamentaux-Valider-le-balisage-d-une-page-web-avec-validator">Valider le balisage d'une page web avec validator</a></div></div><br><h2 class="Title7 GTitle2" id="Fondamentaux-Installer-l-environnement-PHP-avec-WampServer-sous-Windows"><a class="Link9" href="#Fondamentaux">Installer l'environnement PHP avec WampServer sous Windows</a></h2><br><b>WampServer </b>(anciennement WAMP5) est une plateforme de développement Web de type WAMP, permettant de faire fonctionner localement (sans avoir à se connecter à un serveur externe) des scripts PHP. WampServer n'est pas en soi un logiciel, mais un environnement comprenant trois serveurs (Apache, MySQL et MariaDB), un interpréteur de script (PHP), ainsi que phpMyAdmin pour l'administration Web des bases MySQL. Il dispose d'une interface d'administration permettant de gérer et d'administrer ses serveurs au travers d'un tray icon (icône près de l'horloge de Windows). La grande nouveauté de WampServer 3 réside dans la possibilité d'y installer et d'utiliser n'importe quelle version de PHP, Apache, MySQL ou MariaDB en un clic. Ainsi, chaque développeur peut reproduire fidèlement son serveur de production sur sa machine locale. <br><br><h3 class="Title8 GTitle3">Télécharger WampServer</h3><br><a class="Link7 GLink1" style="color:lime;" target="_blank" href="https://www.wampserver.com/">https://www.wampserver.com/</a><br><br><a class="Link7 GLink1" style="color:lime;" target="_blank" href="https://sourceforge.net/projects/wampserver/files/">https://sourceforge.net/projects/wampserver/files/</a><br><br><b>wampserver3.2.3_x64.exe</b><br><br><h3 class="Title8 GTitle3">Installer WampServer</h3><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-mode="txt" data-state="off">wampserver3.2.3_x64.exe
...
sudo apt install -y php-zip</pre></div></div><br><h3 class="Title8 GTitle3">Déterminer l'adresse ip</h3><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-mode="c_cpp">ip a s</pre></div></div><br><h3 class="Title8 GTitle3">Vérifier l'installation</h3><br><a class="Link7 GLink1" style="color:lime;" target="_blank" href="http://192.168.1.45/">http://192.168.1.45/</a><br><br><div class="Img3 GImage"><img alt="/Tutoriels/Web/PHP/img/i_php_test_ubuntu.png" class="lazy entered loaded" data-src="/Tutoriels/Web/PHP/img/i_php_test_ubuntu.png" data-ll-status="loaded" src="/Tutoriels/Web/PHP/img/i_php_test_ubuntu.png"></div><br><h3 class="Title8 GTitle3">Configurer les ports du serveur<br></h3><br>/etc/apache2/ports.conf<br><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-mode="c_cpp">Listen 80
...
display_errors = On</pre></div></div><br><h3 class="Title8 GTitle3">Redémarrer Apache</h3><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-mode="c_cpp">sudo service apache2 reload</pre></div></div><br><h3 class="Title8 GTitle3">Vérifier l'installation</h3><br><a class="Link7 GLink1" style="color:lime;" target="_blank" href="http://192.168.1.45:8080/">http://192.168.1.45:8080/</a><br><br><div class="Img3 GImage"><img alt="/Tutoriels/Web/PHP/img/i_php_test_ubuntu_server.png" class="lazy entered loaded" data-src="/Tutoriels/Web/PHP/img/i_php_test_ubuntu_server.png" data-ll-status="loaded" src="/Tutoriels/Web/PHP/img/i_php_test_ubuntu_server.png"></div><br><h2 class="Title7 GTitle2" id="Fondamentaux-Tester-un-projet-PHP-avec-WampServer-sous-Windows"><a class="Link9" href="#Fondamentaux">Tester un projet PHP avec WampServer sous Windows</a></h2><br><h3 class="Title8 GTitle3">Éditer le programme (index.php)</h3><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-mode="php">&lt;?php
//===============================================
echo "Bonjour tout le monde";
//===============================================
?&gt;</pre></div></div><br><h3 class="Title8 GTitle3">Vérifier la page web</h3><br><a class="Link7 GLink1" style="color:lime;" target="_blank" href="http://localhost:8800/">http://localhost:8800/</a><br><br><div class="Img3 GImage"><img alt="/Tutoriels/Web/PHP/img/i_php_test.png" class="lazy" data-src="/Tutoriels/Web/PHP/img/i_php_test.png"></div><br><h2 class="Title7 GTitle2" id="Fondamentaux-Creer-un-passage-par-reference"><a class="Link9" href="#Fondamentaux">Créer un passage par référence</a></h2><br>En programmation, une <b>référence </b>est une valeur qui est un moyen d'accéder en lecture et/ou écriture à une donnée située soit en mémoire principale soit ailleurs. Une référence n'est pas la donnée elle-même mais seulement une information sur sa localisation. Beaucoup de langages de programmation permettent l'utilisation de références, que ce soit de façon explicite ou implicite.<br><br><h3 class="Title8 GTitle3">index.php</h3><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-mode="php">&lt;?php
//===============================================
...
//===============================================
?&gt;</pre></div></div><br><h3 class="Title8 GTitle3">Résultat</h3><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-mode="php" data-state="off">on appelle le constructeur
...
on appelle le destructeur</pre></div></div><br></div></div></div></div><br><div class="Content2 GTitle1"><div class="MainBlock2"><div class="Content"><h1 class="Title2 Center" id="Fichier"><a class="Link3" href="#">Fichier</a></h1><div class="Body3"><br>Un <b>fichier </b>peut être utilisé pour conserver des données ou des informations sur un système.<br><br><div class="Content0 GSummary2"><div class="Row26">Summary 2</div></div><br><h2 class="Title7 GTitle2" id="Fichier-Ajouter-un-texte-a-la-fin-d-un-fichier"><a class="Link9" href="#Fichier">Ajouter un texte à la fin d'un fichier</a></h2><br>Cette technique peut être utiliser pour enregistrer les traces de l'évolution d'un système dans un fichier log.<br><br><h3 class="Title8 GTitle3">Méthode 1 (index.php)</h3><br>Cette méthode suppose que le fichier est existant sinon elle génère une erreur.<br><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-state="off" data-mode="php">&lt;?php
//===============================================
$lFile = "debug.txt";
...
//===============================================
?&gt;</pre></div></div><br><h3 class="Title8 GTitle3">Méthode 2 (index.php)</h3><br>Cette méthode suppose que le fichier est existant sinon elle génère une erreur.<br><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-state="off" data-mode="php">&lt;?php
//===============================================
$lFile = "debug.txt";
$lContent = "Bonjour tout le monde\n";
file_put_contents($lFile, $lContent, FILE_APPEND | LOCK_EX);
//===============================================
?&gt;</pre></div></div><br><h3 class="Title8 GTitle3">Méthode 3 (index.php)</h3><br>Cette méthode utilise le fichier s'il est existant ou le crée s'il n'existe pas.<br><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-state="off" data-mode="php">&lt;?php
//===============================================
$lFilename = "debug.txt";
$lFile = fopen($lFilename, "a+");
$lText = "Bonjour tout le monde\n";
fwrite($lFile, $lText);
fclose($lFile);
//===============================================
...
Bonjour tout le monde
Bonjour tout le monde</pre></div></div><br></div></div></div></div><br><div class="Content2 GTitle1"><div class="MainBlock2"><div class="Content"><h1 class="Title2 Center" id="Systeme-d-hebergement-de-fichiers"><a class="Link3" href="#">Système d'hébergement de fichiers</a></h1><div class="Body3"><br>Le système d'<b>hébergement de fichiers</b> que nous proposons ici est un système qui permet de charger des fichiers à partir d'une machine cliente vers un serveur web.<br><br><div class="Content0 GSummary2"><div class="Row26">Summary 2</div></div><br><h2 class="Title7 GTitle2" id="Systeme-d-hebergement-de-fichiers-Autoriser-le-chargement-de-fichiers"><a class="Link9" href="#Systeme-d-hebergement-de-fichiers">Autoriser le chargement de fichiers</a></h2><br><h3 class="Title8 GTitle3">Ouvrir le fichier de configuration sous Windows (php.ini)</h3><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-state="off" data-mode="c_cpp">C:\wamp64\bin\php\php7.3.21\php.ini</pre></div></div><br><h3 class="Title8 GTitle3">Autoriser le chargement de fichiers</h3><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-state="off" data-mode="c_cpp">file_uploads = On
upload_tmp_dir ="c:/wamp64/tmp"
upload_max_filesize = 2M
max_file_uploads = 20</pre></div></div><br><h2 class="Title7 GTitle2" id="Systeme-d-hebergement-de-fichiers-Charger-un-fichier"><a class="Link9" href="#Systeme-d-hebergement-de-fichiers">Charger un fichier</a></h2><br><h3 class="Title8 GTitle3">index.php</h3><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-state="off" data-mode="php">&lt;?php
//===============================================
require "autoload.php";
//===============================================
...
echo sprintf("&lt;/html&gt;\n");
//===============================================
?&gt;</pre></div></div><br><h3 class="Title8 GTitle3">Résultat</h3><br><div class="Img3 GImage"><img src="/Tutoriels/Web/PHP/img/i_file_hosting_one.gif" alt="/Tutoriels/Web/PHP/img/i_file_hosting_one.gif"></div><br></div></div></div></div><br><div class="Content2 GTitle1"><div class="MainBlock2"><div class="Content"><h1 class="Title2 Center" id="LazyLoad"><a class="Link3" href="#">LazyLoad</a></h1><div class="Body3"><br><b>LazyLoad </b>est un script léger et flexible qui accélère votre site Web en reportant le chargement de vos images, arrière-plans, vidéos, iframes et scripts sous le pli au moment où ils entreront dans la fenêtre. Écrit en JavaScript «vanille», il exploite IntersectionObserver, prend en charge les images réactives et permet le chargement paresseux natif.<br><br><div class="Content0 GSummary2"><div class="Item4"><i class="Icon10 fa fa-book"></i><a class="Link4" href="#LazyLoad-Charger-une-image-par-LazyLoad">Charger une image par LazyLoad</a></div></div><br><h2 class="Title7 GTitle2" id="LazyLoad-Charger-une-image-par-LazyLoad"><a class="Link9" href="#LazyLoad">Charger une image par LazyLoad</a></h2><br><h3 class="Title8 GTitle3">index.php</h3><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-mode="php" data-state="off">&lt;?php
//===============================================
echo sprintf("&lt;!DOCTYPE html&gt;\n");
echo sprintf("&lt;html lang='fr'&gt;\n");
echo sprintf("&lt;head&gt;\n");
...
echo sprintf("&lt;/html&gt;\n");
//===============================================
?&gt;</pre></div></div><br><h3 class="Title8 GTitle3">script.js</h3><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-mode="php" data-state="off">//===============================================
var lazyLoadInstance = new LazyLoad({
    // presonnalisation
});
//===============================================</pre></div></div><br><h3 class="Title8 GTitle3">Résultat</h3><br><div class="Img3 GImage"><img alt="/Tutoriels/Web/PHP/img/i_lazyload_simple.gif" class="lazy entered loaded" data-src="/Tutoriels/Web/PHP/img/i_lazyload_simple.gif" data-ll-status="loaded" src="/Tutoriels/Web/PHP/img/i_lazyload_simple.gif"></div><br></div></div></div></div><br><div class="Content2 GTitle1"><div class="MainBlock2"><div class="Content"><h1 class="Title2 Center" id="GTmetrix"><a class="Link3" href="#">GTmetrix</a></h1><div class="Body3"><br><b>GTmetrix </b>est un outil d'analyse des performances web d'un site internet. Il permet de decouvrir à quelle vitesse se charge-t-il ? Pourquoi est-il lent ? et Comment l'optimiser ? Les performances Web font référence à la vitesse à laquelle les pages Web sont téléchargées et affichées sur le navigateur Web de l'utilisateur . L'optimisation des performances Web (WPO) , ou optimisation de sites Web, est le domaine de la connaissance de l'augmentation des performances Web. Il a été démontré que des vitesses de téléchargement de sites Web plus rapides augmentaient la rétention et la fidélité des visiteurs et la satisfaction des utilisateurs, en particulier pour les utilisateurs avec des connexions Internet lentes et ceux sur des appareils mobiles . [3] Les performances Web entraînent également moins de données circulant sur le Web, ce qui réduit à son tour la consommation d'énergie et l'impact environnemental d'un site Web. Certains aspects qui peuvent affecter la vitesse de chargement des pages incluent le cache du navigateur / serveur, l'optimisation de l'image et le cryptage (par exemple SSL), qui peuvent affecter le temps nécessaire au rendu des pages. Les performances de la page Web peuvent être améliorées grâce à des techniques telles que le cache multicouche, la conception légère des composants de la couche de présentation et la communication asynchrone avec les composants côté serveur.<br><br><div class="Content0 GSummary2"><div class="Item4"><i class="Icon10 fa fa-book"></i><a class="Link4" href="#GTmetrix-Mesurer-les-perfommances-d-une-page-web">Mésurer les perfommances d'une page web</a></div></div><br><h2 class="Title7 GTitle2" id="GTmetrix-Mesurer-les-perfommances-d-une-page-web"><a class="Link9" href="#GTmetrix">Mésurer les perfommances d'une page web</a></h2><br><h3 class="Title8 GTitle3">Accéder à l'interface GTmetrix</h3><br><a class="Link7 GLink1" style="color:lime;" target="_blank" href="https://gtmetrix.com/">https://gtmetrix.com/</a><br><br><h3 class="Title8 GTitle3">Mésurer les perfommances web<br></h3><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-mode="php" data-state="off">GTmetrix
Enter URL to analyze -&gt; 
https://readydev.ovh/Tutoriels/Software_Development/Cpp/
Test your site</pre></div></div><br><h3 class="Title8 GTitle3">Résultat</h3><br><div class="Img3 GImage"><img alt="/Tutoriels/Web/PHP/img/i_gtmetrix_simple.png" class="lazy entered loaded" data-src="/Tutoriels/Web/PHP/img/i_gtmetrix_simple.png" data-ll-status="loaded" src="/Tutoriels/Web/PHP/img/i_gtmetrix_simple.png"></div><br></div></div></div></div><br><div class="Content2 GTitle1"><div class="MainBlock2"><div class="Content"><h1 class="Title2 Center" id="FreeBox"><a class="Link3" href="#">FreeBox</a></h1><div class="Body3"><br>La <b>FreeBox </b>peut être utilisé pour rendre un serveur web local disponible sur Internet .<br><br><div class="Content0 GSummary2"><div class="Row26">Summary 2</div></div><br><h2 class="Title7 GTitle2" id="FreeBox-Creer-une-redirection-de-port-sous-FreeBox"><a class="Link9" href="#FreeBox">Créer une redirection de port sous FreeBox</a></h2><br>Cette technique permet d'associer une machine du réseau local à une adresse IP publique à travers un port.<br><br><h3 class="Title8 GTitle3">Déterminer son adresse IP publique</h3><br><a class="Link7 GLink1" style="color:lime;" target="_blank" href="https://whatismyipaddress.com/">https://whatismyipaddress.com/</a><br><br><h3 class="Title8 GTitle3">Créer une redirection de port</h3><br><a class="Link7 GLink1" style="color:lime;" target="_blank" href="http://mafreebox.freebox.fr/">http://mafreebox.freebox.fr/</a><br><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-state="off" data-mode="php">Free
Paramètres
Paramètres de la FreeBox
Gestion des ports
Ajouter une redirection
IP Destination -&gt; rpi4-desktop
Redirection active -&gt; Cocher
IP source -&gt; Toutes
Port de début -&gt; 8855
Port de fin -&gt; 8855
Port de destination -&gt; 8855
Commentaire -&gt; ReadyApp
Sauvegarder
Ok
Fermer</pre></div></div><br></div></div></div></div><br><div class="Content2 GTitle1"><div class="MainBlock2"><div class="Content"><h1 class="Title2 Center" id="Dynu"><a class="Link3" href="#">Dynu</a></h1><div class="Body3"><br><b>Dynu </b>permet de créer gratuitement un nom de domaine (DNS).<br><br><div class="Content0 GSummary2"><div class="Row26">Summary 2</div></div><br><h2 class="Title7 GTitle2" id="Dynu-Creer-un-nom-de-domaine"><a class="Link9" href="#Dynu">Créer un nom de domaine</a></h2><br>Cette technique permet d'associer un nom à une adresse IP publique.<br><br><h3 class="Title8 GTitle3">Créer un nom de domaine</h3><br><a class="Link7 GLink1" style="color:lime;" target="_blank" href="https://www.dynu.com/en-US/">https://www.dynu.com/en-US/</a><br><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-state="off" data-mode="php">Dynu
DDNS Services
Add
Host -&gt; readyapp
...
//===============================================
?&gt;</pre></div></div><br></div></div></div></div><br><div class="Content2 GTitle1"><div class="MainBlock2"><div class="Content"><h1 class="Title2 Center" id="Eclipse"><a class="Link3" href="#">Eclipse</a></h1><div class="Body3"><br><b>Eclipse </b>permet de créer des projets PHP.<br><br><div class="Content0 GSummary2"><div class="Row26">Summary 2</div></div><br><h2 class="Title7 GTitle2" id="Eclipse-Fondamentaux"><a class="Link9" href="#Eclipse">Fondamentaux</a></h2><br><div class="Content0 GSummary3"><div class="Row26">Summary 3</div></div><br><h3 class="GTitle3" id="Eclipse-Fondamentaux-Importation-d-un-projet-PHP"><a class="Title8" href="#Eclipse-Fondamentaux">Importation d'un projet PHP</a></h3><br><div class="Img3 GImage"><img src="/Tutoriels/Web/PHP/img/i_eclipse_php_import_project.gif" alt="/Tutoriels/Web/PHP/img/i_eclipse_php_import_project.gif"></div><br></div></div></div></div><br><div class="Content2 GTitle1"><div class="MainBlock2"><div class="Content"><h1 class="Title2 Center" id="Ressources"><a class="Link3" href="#">Ressources</a></h1><div class="Body3"><br>Les ressources en PHP :<br><br><div class="Content0 GSummary2"><div class="Row26">Summary 2</div></div><br><h2 class="Title7 GTitle2" id="Ressources-DBeaver"><a class="Link9" href="#Ressources">DBeaver</a></h2><br>DBeaver permet de visualiser et de manipuler une base de données.<br><br><div class="Content0 GSummary3"><div class="Row26">Summary 3</div></div><br><h3 class="GTitle3" id="Ressources-DBeaver-Installer-DBeaver-sous-Ubuntu"><a class="Title8" href="#Ressources-DBeaver">Installer DBeaver sous Ubuntu</a></h3><br><a class="Link7 GLink1" style="color:lime;" target="_blank" href="https://doc.ubuntu-fr.org/dbeaver">https://doc.ubuntu-fr.org/dbeaver</a><br><br><h3 class="GTitle3" id="Ressources-DBeaver-Activer-les-snaps-sur-Raspberry-Pi-et-installer-dbeaver-ce"><a class="Title8" href="#Ressources-DBeaver">Activer les snaps sur Raspberry Pi et installer dbeaver-ce</a></h3><br><a class="Link7 GLink1" style="color:lime;" target="_blank" href="https://snapcraft.io/install/dbeaver-ce/raspbian">https://snapcraft.io/install/dbeaver-ce/raspbian</a><br><br><br><br></div></div></div></div><br>