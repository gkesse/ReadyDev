...
&lt;manifest 
    ...
    &lt;!--=============================================--&gt;
&lt;/manifest&gt;
&lt;!--=============================================--&gt;</xmp></pre></div><br><h2 class="Title7 GTitle2" id="Basculer entre des activités sous Android-Résultat"><a class="Link9" href="#Basculer entre des activités sous Android">Résultat</a></h2><br><h3 class="Title8 GTitle3">Au démarrage</h3><br><div class="Img3 GImage"><img src="/Tutoriels/Android/img/i_cours_switch_activity.png" alt="/Tutoriels/Android/img/i_cours_switch_activity.png"></div><br><h3 class="Title8 GTitle3">Après un clic sur le bouton (Activité secondaire)</h3><br><div class="Img3 GImage"><img src="/Tutoriels/Android/img/i_cours_switch_activity_02.png" alt="/Tutoriels/Android/img/i_cours_switch_activity_02.png"></div><br><h3 class="Title8 GTitle3">Après un clic sur le bouton (Terminer)</h3><br><div class="Img3 GImage"><img src="/Tutoriels/Android/img/i_cours_switch_activity.png" alt="/Tutoriels/Android/img/i_cours_switch_activity.png"></div><br></div></div></div></div><br><div class="Content2 GTitle1"><div class="MainBlock2"><div class="Content"><h1 class="Title2 Center" id="Voir Aussi"><a class="Link3" href="#">Voir Aussi</a></h1><div class="Body3">Dans cette même catégorie, vous pouvez consulter aussi :<br><br><span class="GColor1" style="color:lime;">Programmation de base</span><br><br><div class="Content0 GList1"><div class="Body0" id="Loader_1600429735365"><div class="Row26">List 1 &gt; Android &gt; basics</div></div><script>loadList1("Loader_1600429735365","Android","basics");</script></div><br></div></div></div></div><br>