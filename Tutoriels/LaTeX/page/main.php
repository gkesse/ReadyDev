...
\documentclass{article}
%================================================</xmp></pre></div><br><h2 class="Title7 GTitle2" id="Définir le type de document-Définir un livre"><a class="Link9" href="#Définir le type de document">Définir un livre</a></h2><br><h3 class="Title8 GTitle3">Définir un livre (main.tex)</h3><div class="GCode1"><pre class="Code2"><xmp class="AceCode" data-mode="tex" data-theme="monokai">%================================================
\documentclass{book}
%================================================</xmp></pre></div><br><h2 class="Title7 GTitle2" id="Définir le type de document-Définir une lettre"><a class="Link9" href="#Définir le type de document">Définir une lettre</a></h2><br><h3 class="Title8 GTitle3">Définir une lettre (main.tex)</h3><div class="GCode1"><pre class="Code2"><xmp class="AceCode" data-mode="tex" data-theme="monokai">%================================================
\documentclass{letter}
%================================================</xmp></pre></div><br><h2 class="Title7 GTitle2" id="Définir le type de document-Définir un rapport"><a class="Link9" href="#Définir le type de document">Définir un rapport</a></h2><br><h3 class="Title8 GTitle3">Définir un rapport (main.tex)</h3><div class="GCode1"><pre class="Code2"><xmp class="AceCode" data-mode="tex" data-theme="monokai">%================================================
