...
GUNIX=$GPROJECT/unix
cd $GUNIX
./bin/GProject.exe</xmp></pre></div><br><h2 class="Title7 GTitle2" id="Apporter des modifications à un projet-Résultat"><a class="Link9" href="#Apporter des modifications à un projet">Résultat</a></h2><br><div class="Img3 GImage"><img src="img/Programme.png" alt="img/Programme.png"></div><br><h2 class="Title7 GTitle2" id="Apporter des modifications à un projet-Indexer tous les fichiers"><a class="Link9" href="#Apporter des modifications à un projet">Indexer tous les fichiers</a></h2><br><div class="GCode1"><pre class="Code2"><xmp class="AceCode" data-mode="sh">GPROJECT=/home/centos/Programs/ReadyGit/kesse/projet
cd $GPROJECT
git add --all</xmp></pre></div><br><h2 class="Title7 GTitle2" id="Apporter des modifications à un projet-Valider les modifications"><a class="Link9" href="#Apporter des modifications à un projet">Valider les modifications</a></h2><br><div class="GCode1"><pre class="Code2"><xmp class="AceCode" data-mode="sh">GPROJECT=/home/centos/Programs/ReadyGit/kesse/projet
cd $GPROJECT
git commit -m "developpement du syteme de structure"</xmp></pre></div><br><h2 class="Title7 GTitle2" id="Apporter des modifications à un projet-Pousser les modifications"><a class="Link9" href="#Apporter des modifications à un projet">Pousser les modifications</a></h2><br><div class="GCode1"><pre class="Code2"><xmp class="AceCode" data-mode="sh">GPROJECT=/home/centos/Programs/ReadyGit/kesse/projet
cd $GPROJECT
git push origin struct</xmp></pre></div><br></div></div></div></div><br><div class="Content2 GTitle1"><div class="MainBlock2"><div class="Content"><h1 class="Title2 Center" id="Modifier l'URL d'un dépôt"><a class="Link3" href="#">Modifier l'URL d'un dépôt</a></h1><div class="Body3">Le but de cette section est de vous apprendre à Cloner un dépôt avec Git.<br><br><div class="Content0 GSummary2"><div class="Body0" id="Loader_1576651250411"><div class="Row26">Summary 2</div></div><script>loadSummary2("Loader_1576651250411");</script></div><br><h2 class="Title7 GTitle2" id="Modifier l'URL d'un dépôt-Supprimer l'URL du dépôt"><a class="Link9" href="#Modifier l'URL d'un dépôt">Supprimer l'URL du dépôt</a></h2><br><div class="GCode1"><pre class="Code2"><xmp class="AceCode" data-mode="sh">GPROJECT=/home/centos/Programs/ReadyGit/gerard/projet
cd $GPROJECT
