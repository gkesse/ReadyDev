...
Android Studio</xmp></pre></div><br></div></div></div></div><br><div class="Content2 GTitle1"><div class="MainBlock2"><div class="Content"><h1 class="Title2 Center" id="Tests"><a class="Link3" href="#">Tests</a></h1><div class="Body3"><br>Créer un projet Android.<br><br><div class="Content0 GSummary2"><div class="Body0" id="Loader_1617658055429"><div class="Row26">Summary 2</div></div><script>loadSummary2("Loader_1617658055429");</script></div><br><h2 class="Title7 GTitle2" id="Tests-1 - Test sous Windows"><a class="Link9" href="#Tests">1 - Test sous Windows</a></h2><br><h2 class="Title7 GTitle2" id="Tests-1.1 - Test sous Android Studio"><a class="Link9" href="#Tests">1.1 - Test sous Android Studio</a></h2><br><h2 class="Title7 GTitle2" id="Tests-1.1.1 - Créer le projet sous Android Studio"><a class="Link9" href="#Tests">1.1.1 - Créer le projet sous Android Studio</a></h2><br><div class="GCode1"><pre class="Code2"><xmp class="AceCode" data-mode="txt">Android Studio
