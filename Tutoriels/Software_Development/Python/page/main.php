...
#================================================</pre></div></div><br><h2 class="Title7 GTitle2" id="Systeme-d-administration-Programme-d-initialisation"><a class="Link9" href="#Systeme-d-administration">Programme d'initialisation</a></h2><br><h3 class="Title8 GTitle3">GProcessUi.py</h3><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-mode="python">#================================================
def run_INIT(self):
    sys.stdout.write("\n")
    ...
    sys.stdout.write("\n")
    self.G_STATE = "S_LOAD"
#================================================</pre></div></div><br><h2 class="Title7 GTitle2" id="Systeme-d-administration-Programme-de-chargement-des-donnees"><a class="Link9" href="#Systeme-d-administration">Programme de chargement des données</a></h2><br><h3 class="Title8 GTitle3">GProcessUi.py</h3><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-mode="python">#================================================
def run_LOAD(self):
    GConfig.Instance().loadData("G_ADMIN_ID")
    self.G_STATE = "S_METHOD"
#================================================</pre></div></div><br><h2 class="Title7 GTitle2" id="Systeme-d-administration-Programme-des-methodes"><a class="Link9" href="#Systeme-d-administration">Programme des méthodes</a></h2><br><h3 class="Title8 GTitle3">GProcessUi.py</h3><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-mode="python">#================================================
def run_METHOD(self):
    sys.stdout.write("PYTHON_ADMIN :\n")
    sys.stdout.write("\t%-2s : %s\n" % ("1", "S_YOUTUBE"))
    sys.stdout.write("\t%-2s : %s\n" % ("2", "S_SQLITE"))
...
#================================================</pre></div></div><br><h2 class="Title7 GTitle2" id="Systeme-d-administration-Programme-du-choix-d-une-methode"><a class="Link9" href="#Systeme-d-administration">Programme du choix d'une méthode</a></h2><br><h3 class="Title8 GTitle3">GProcessUi.py</h3><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-mode="python">#================================================
def run_CHOICE(self):
...
#================================================</pre></div></div><br><h2 class="Title7 GTitle2" id="Systeme-d-administration-Programme-du-module-YouTube"><a class="Link9" href="#Systeme-d-administration">Programme du module YouTube</a></h2><br><h3 class="Title8 GTitle3">GProcessUi.py</h3><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-mode="python">#================================================
def run_YOUTUBE(self):
    GYouTubeUi.Instance().run()
    self.G_STATE = "S_SAVE"
#================================================</pre></div></div><br><h2 class="Title7 GTitle2" id="Systeme-d-administration-Programme-du-module-SQLite"><a class="Link9" href="#Systeme-d-administration">Programme du module SQLite</a></h2><br><h3 class="Title8 GTitle3">GProcessUi.py</h3><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-mode="python">#================================================
def run_SQLITE(self):
    GSQLiteUi.Instance().run()
    self.G_STATE = "S_SAVE"
#================================================</pre></div></div><br><h2 class="Title7 GTitle2" id="Systeme-d-administration-Programme-de-sauvegarde-des-donnees"><a class="Link9" href="#Systeme-d-administration">Programme de sauvegarde des données</a></h2><br><h3 class="Title8 GTitle3">GProcessUi.py</h3><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-mode="python">#================================================
def run_SAVE(self):
    GConfig.Instance().saveData("G_ADMIN_ID")
    self.G_STATE = "S_END"
#================================================</pre></div></div><br><h2 class="Title7 GTitle2" id="Systeme-d-administration-Resultat"><a class="Link9" href="#Systeme-d-administration">Résultat</a></h2><br><h3 class="Title8 GTitle3">Menu principal</h3><br><div class="Img3 GImage"><img alt="/Tutoriels/Software_Development/Python/img/i_python_admin_system.png" class="lazy" data-src="/Tutoriels/Software_Development/Python/img/i_python_admin_system.png"></div><br><h3 class="Title8 GTitle3">Menu du module YouTube</h3><br><div class="Img3 GImage"><img alt="/Tutoriels/Software_Development/Python/img/i_python_admin_system_02.png" class="lazy" data-src="/Tutoriels/Software_Development/Python/img/i_python_admin_system_02.png"></div><br><h3 class="Title8 GTitle3">Menu du module SQLite</h3><br><div class="Img3 GImage"><img alt="/Tutoriels/Software_Development/Python/img/i_python_admin_system_03.png" class="lazy" data-src="/Tutoriels/Software_Development/Python/img/i_python_admin_system_03.png"></div><br></div></div></div></div><br><div class="Content2 GTitle1"><div class="MainBlock2"><div class="Content"><h1 class="Title2 Center" id="Interface-Homme-Machine-avec-Qt"><a class="Link3" href="#">Interface Homme-Machine avec Qt</a></h1><div class="Body3"><br><b>Qt </b>est une bibliothèque de composants d'interfaces graphiques (widgets), d'accès aux données, de connexions réseaux, de gestion des fils d'exécution, d'analyse XML, etc, et doté d'un mécanisme de notifications par des signaux et slots.<br><br><div class="Content0 GSummary2"><div class="Body0" id="Loader_1618875825281"><div class="Row26">Summary 2</div></div><script>loadSummary2("Loader_1618875825281");</script></div><br><div class="Img3 GImage"><img alt="/Tutoriels/Software_Development/Python/img/b_qt.png" class="lazy" data-src="/Tutoriels/Software_Development/Python/img/b_qt.png"></div><br><h2 class="Title7 GTitle2" id="Interface-Homme-Machine-avec-Qt-1---Installation"><a class="Link9" href="#Interface-Homme-Machine-avec-Qt">1 - Installation</a></h2><br><h2 class="Title7 GTitle2" id="Interface-Homme-Machine-avec-Qt-1-1---Installation-sous-Windows"><a class="Link9" href="#Interface-Homme-Machine-avec-Qt">1.1 - Installation sous Windows</a></h2><br><h2 class="Title7 GTitle2" id="Interface-Homme-Machine-avec-Qt-1-1-1---Installer-PyQt5"><a class="Link9" href="#Interface-Homme-Machine-avec-Qt">1.1.1 - Installer PyQt5</a></h2><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-mode="sh">python -m pip install pyqt5</pre></div></div><br><h2 class="Title7 GTitle2" id="Interface-Homme-Machine-avec-Qt-2---Tests"><a class="Link9" href="#Interface-Homme-Machine-avec-Qt">2 - Tests</a></h2><br><h2 class="Title7 GTitle2" id="Interface-Homme-Machine-avec-Qt-2-1---Test-sous-Windows"><a class="Link9" href="#Interface-Homme-Machine-avec-Qt">2.1 - Test sous Windows</a></h2><br><h2 class="Title7 GTitle2" id="Interface-Homme-Machine-avec-Qt-2-1-1---Editer-le-programme"><a class="Link9" href="#Interface-Homme-Machine-avec-Qt">2.1.1 - Editer le programme</a></h2><br><h3 class="Title8 GTitle3">main.py</h3><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-mode="python">#================================================
import sys
...
if __name__ == '__main__':
    window()
#================================================</pre></div></div><br><h2 class="Title7 GTitle2" id="Interface-Homme-Machine-avec-Qt-2-1-2---Executer-le-projet"><a class="Link9" href="#Interface-Homme-Machine-avec-Qt">2.1.2 - Exécuter le projet</a></h2><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-mode="batchfile">python main.py</pre></div></div><br><div class="Img3 GImage"><img alt="/Tutoriels/Software_Development/Python/img/i_qt_test.png" class="lazy" data-src="/Tutoriels/Software_Development/Python/img/i_qt_test.png"></div><br></div></div></div></div><br><div class="Content2 GTitle1"><div class="MainBlock2"><div class="Content"><h1 class="Title2 Center" id="Base-de-donnees-avec-SQLite"><a class="Link3" href="#">Base de données avec SQLite</a></h1><div class="Body3"><br><b>SQLite </b>est un système de gestion de base de données relationnelle accessible par le langage SQL et dont l'intégralité de la base de données (déclarations, tables, index et données) est stockée dans un fichier indépendant de la plateforme.<br><br><div class="Content0 GSummary2"><div class="Body0" id="Loader_1618877938611"><div class="Row26">Summary 2</div></div><script>loadSummary2("Loader_1618877938611");</script></div><br><div class="Img3 GImage"><img alt="/Tutoriels/Software_Development/Python/img/b_sqlite.png" class="lazy" data-src="/Tutoriels/Software_Development/Python/img/b_sqlite.png"></div><br><h2 class="Title7 GTitle2" id="Base-de-donnees-avec-SQLite-1---Installation"><a class="Link9" href="#Base-de-donnees-avec-SQLite">1 - Installation</a></h2><br><h2 class="Title7 GTitle2" id="Base-de-donnees-avec-SQLite-1-1---Installation-sous-Windows"><a class="Link9" href="#Base-de-donnees-avec-SQLite">1.1 - Installation sous Windows</a></h2><br>Aucune installation n'est nécessaire.<br><br><h2 class="Title7 GTitle2" id="Base-de-donnees-avec-SQLite-2---Tests"><a class="Link9" href="#Base-de-donnees-avec-SQLite">2 - Tests</a></h2><br><h2 class="Title7 GTitle2" id="Base-de-donnees-avec-SQLite-2-1---Test-sous-Windows"><a class="Link9" href="#Base-de-donnees-avec-SQLite">2.1 - Test sous Windows</a></h2><br><h2 class="Title7 GTitle2" id="Base-de-donnees-avec-SQLite-2-1-1---Editer-le-programme"><a class="Link9" href="#Base-de-donnees-avec-SQLite">2.1.1 - Éditer le programme</a></h2><br><h3 class="Title8 GTitle3">main.py</h3><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-mode="python">#================================================
import sqlite3
#================================================
...
#================================================</pre></div></div><br><h2 class="Title7 GTitle2" id="Base-de-donnees-avec-SQLite-2-1-2---Executer-le-projet"><a class="Link9" href="#Base-de-donnees-avec-SQLite">2.1.2 - Exécuter le projet</a></h2><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-mode="batchfile">python main.py</pre></div></div><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-mode="txt">('Bonjour tout le monde',)</pre></div></div><br></div></div></div></div><br><div class="Content2 GTitle1"><div class="MainBlock2"><div class="Content"><h1 class="Title2 Center" id="Pip"><a class="Link3" href="#">Pip</a></h1><div class="Body3"><br><b>Pip </b>est un gestionnaire de packages Python.<br><br><div class="Content0 GSummary2"><div class="Body0" id="Loader_1617632484641"><div class="Row26">Summary 2</div></div><script>loadSummary2("Loader_1617632484641");</script></div><br><h2 class="Title7 GTitle2" id="Pip-1---Installation"><a class="Link9" href="#Pip">1 - Installation</a></h2><br>Aucune installation n'est nécessaire.<br><br><h2 class="Title7 GTitle2" id="Pip-2---Mise-a-jour"><a class="Link9" href="#Pip">2 - Mise à jour</a></h2><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-mode="sh">python -m pip install --upgrade pip</pre></div></div><br><h2 class="Title7 GTitle2" id="Pip-3---Commandes"><a class="Link9" href="#Pip">3 - Commandes</a></h2><br><h2 class="Title7 GTitle2" id="Pip-3-1---Lister-les-packages"><a class="Link9" href="#Pip">3.1 - Lister les packages</a></h2><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-mode="sh">python -m pip list</pre></div></div><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-mode="txt">Package Version
------- -------
...
PyQt5     5.15.4
PyQt5-Qt5 5.15.2
PyQt5-sip 12.8.1</pre></div></div><br><h2 class="Title7 GTitle2" id="Pip-3-3---Mettre-a-jour-un-package"><a class="Link9" href="#Pip">3.3 - Mettre à jour un package</a></h2><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-mode="sh">python -m pip install --upgrade pyqt5</pre></div></div><br></div></div></div></div><br>