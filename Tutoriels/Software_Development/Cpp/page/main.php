...
//===============================================</pre></div></div><br><div class="Img3 GImage"><img alt="/Tutoriels/Software_Development/Cpp/img/i_design_creation_prototype.png" class="lazy" data-src="/Tutoriels/Software_Development/Cpp/img/i_design_creation_prototype.png"></div><br><h3 class="GTitle3" id="Patrons-de-conception-Patrons-de-creation-Patron-fabrique"><a class="Title8" href="#Patrons-de-conception-Patrons-de-creation">Patron fabrique</a></h3><br>Le patron fabrique permet de <b>créer des objets de types différents</b> à partir d'un paramètre.<br><br>Programme principal<br><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-state="off" data-mode="c_cpp">//===============================================
void GCppUi::run(int _argc, char** _argv) {
    GClass* lObj = 0;
...
//===============================================</pre></div></div><br><div class="Img3 GImage"><img alt="/Tutoriels/Software_Development/Cpp/img/i_design_creation_fabrique.png" class="lazy" data-src="/Tutoriels/Software_Development/Cpp/img/i_design_creation_fabrique.png"></div><br><h3 class="GTitle3" id="Patrons-de-conception-Patrons-de-creation-Patron-monteur"><a class="Title8" href="#Patrons-de-conception-Patrons-de-creation">Patron monteur</a></h3><br>Le patron monteur permet de <b>construire une variété d'objets complexes</b> à partir d'un objet de référence.<br><br>Programme principal<br><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-state="off" data-mode="c_cpp">//===============================================
void GCppUi::run(int _argc, char** _argv) {
...
//===============================================</pre></div></div><br><div class="Img3 GImage"><img alt="/Tutoriels/Software_Development/Cpp/img/i_design_behavior_strategy.png" class="lazy" data-src="/Tutoriels/Software_Development/Cpp/img/i_design_behavior_strategy.png"></div><br><h3 class="GTitle3" id="Patrons-de-conception-Patrons-de-comportement-Patron-observateur"><a class="Title8" href="#Patrons-de-conception-Patrons-de-comportement">Patron observateur</a></h3><br>Le patron observateur permet d'<b>envoyer un signal à des modules</b> qui jouent le rôle d'observateur. En cas de notification, les observateurs effectuent alors l'action adéquate en fonction des informations qui parviennent depuis les modules qu'ils observent (les observables).<br><br>Programme principal<br><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-state="off" data-mode="c_cpp">//===============================================
void GCppUi::run(int _argc, char** _argv) {
...
//===============================================</pre></div></div><br><div class="Img3 GImage"><img alt="/Tutoriels/Software_Development/Cpp/img/i_sqlite_learn_version.png" class="lazy" data-src="/Tutoriels/Software_Development/Cpp/img/i_sqlite_learn_version.png"></div><br><h3 class="GTitle3" id="Base-de-donnees-avec-SQLite-Apprendre-SQLite-Execution-d-une-requete-preparee"><a class="Title8" href="#Base-de-donnees-avec-SQLite-Apprendre-SQLite">Exécution d'une requête préparée</a></h3><br>Programme principal<br><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-state="off" data-mode="c_cpp">//===============================================
void GSQLiteUi::run(int argc, char** argv) {
    sGApp* lApp = GResource::Instance()-&gt;data()-&gt;app;
...
//===============================================</pre></div></div><br><div class="Img3 GImage"><img alt="/Tutoriels/Software_Development/Cpp/img/i_sqlite_learn_data_row.png" class="lazy" data-src="/Tutoriels/Software_Development/Cpp/img/i_sqlite_learn_data_row.png"></div><br><h3 class="GTitle3" id="Base-de-donnees-avec-SQLite-Apprendre-SQLite-Lecture-d-une-colonne-de-donnees"><a class="Title8" href="#Base-de-donnees-avec-SQLite-Apprendre-SQLite">Lecture d'une colonne de données</a></h3><br>Programme principal<br><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-state="off" data-mode="c_cpp">//===============================================
void GSQLiteUi::run(int argc, char** argv) {
    std::vector&lt;std::string&gt; lNames;
...
//===============================================</pre></div></div><br><div class="Img3 GImage"><img alt="/Tutoriels/Software_Development/Cpp/img/i_sqlite_learn_data_col.png" class="lazy" data-src="/Tutoriels/Software_Development/Cpp/img/i_sqlite_learn_data_col.png"></div><br><h3 class="GTitle3" id="Base-de-donnees-avec-SQLite-Apprendre-SQLite-Lecture-d-une-matrice-de-donnees"><a class="Title8" href="#Base-de-donnees-avec-SQLite-Apprendre-SQLite">Lecture d'une matrice de données</a></h3><br>Programme principal<br><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-state="off" data-mode="c_cpp">//===============================================
void GSQLiteUi::run(int argc, char** argv) {
    std::vector&lt;std::string&gt; lNames;
...
//===============================================</pre></div></div><br>Document XML<br><br><div class="Img3 GImage"><img alt="/Tutoriels/Software_Development/Cpp/img/i_qt_xml_doc_text.png" class="lazy" data-src="/Tutoriels/Software_Development/Cpp/img/i_qt_xml_doc_text.png"></div><br><div class="Img3 GImage"><img alt="/Tutoriels/Software_Development/Cpp/img/i_qt_xml_doc_show.png" class="lazy" data-src="/Tutoriels/Software_Development/Cpp/img/i_qt_xml_doc_show.png"></div><br><h3 class="GTitle3" id="Interface-Homme-Machine-avec-Qt-Apprendre-le-XML-Recuperation-du-noeud-racine"><a class="Title8" href="#Interface-Homme-Machine-avec-Qt-Apprendre-le-XML">Récupération du noeud racine</a></h3><br>Programme principal<br><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-state="off" data-mode="c_cpp">//===============================================
void GQXmlUi::run(int _argc, char** _argv) {
    sGApp* lApp = GManager::Instance()-&gt;data()-&gt;app;
...
//===============================================</pre></div></div><br><div class="Img3 GImage"><img alt="/Tutoriels/Software_Development/Cpp/img/i_qt_xml_root_show.png" class="lazy" data-src="/Tutoriels/Software_Development/Cpp/img/i_qt_xml_root_show.png"></div><br><h3 class="GTitle3" id="Interface-Homme-Machine-avec-Qt-Apprendre-le-XML-Recuperation-du-premier-noeud-enfant"><a class="Title8" href="#Interface-Homme-Machine-avec-Qt-Apprendre-le-XML">Récupération du premier noeud enfant</a></h3><br>Programme principal<br><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-state="off" data-mode="c_cpp">//===============================================
void GQXmlUi::run(int _argc, char** _argv) {
    sGApp* lApp = GManager::Instance()-&gt;data()-&gt;app;
...
//===============================================</pre></div></div><br><div class="Img3 GImage"><img alt="/Tutoriels/Software_Development/Cpp/img/i_qt_xml_firstelement_show.png" class="lazy" data-src="/Tutoriels/Software_Development/Cpp/img/i_qt_xml_firstelement_show.png"></div><br><h3 class="GTitle3" id="Interface-Homme-Machine-avec-Qt-Apprendre-le-XML-Recuperation-du-noeud-suivant-direct"><a class="Title8" href="#Interface-Homme-Machine-avec-Qt-Apprendre-le-XML">Récupération du noeud suivant direct</a></h3><br>Programme principal<br><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-state="off" data-mode="c_cpp">//===============================================
void GQXmlUi::run(int _argc, char** _argv) {
    sGApp* lApp = GManager::Instance()-&gt;data()-&gt;app;
...
//===============================================</pre></div></div><br><div class="Img3 GImage"><img alt="/Tutoriels/Software_Development/Cpp/img/i_qt_xml_nextsibling_show.png" class="lazy" data-src="/Tutoriels/Software_Development/Cpp/img/i_qt_xml_nextsibling_show.png"></div><br><h3 class="GTitle3" id="Interface-Homme-Machine-avec-Qt-Apprendre-le-XML-Recuperation-d-une-liste-de-noeuds"><a class="Title8" href="#Interface-Homme-Machine-avec-Qt-Apprendre-le-XML">Récupération d'une liste de noeuds</a></h3><br>Programme principal<br><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-state="off" data-mode="c_cpp">//===============================================
void GQXmlUi::run(int _argc, char** _argv) {
    sGApp* lApp = GManager::Instance()-&gt;data()-&gt;app;
...
//===============================================</pre></div></div><br><div class="Img3 GImage"><img alt="/Tutoriels/Software_Development/Cpp/img/i_qt_xml_nextsibling_show.png" class="lazy" data-src="/Tutoriels/Software_Development/Cpp/img/i_qt_xml_nextsibling_show.png"></div><br><h3 class="GTitle3" id="Interface-Homme-Machine-avec-Qt-Apprendre-le-XML-Recuperation-du-noeud-precedent-direct"><a class="Title8" href="#Interface-Homme-Machine-avec-Qt-Apprendre-le-XML">Récupération du noeud précédent direct</a></h3><br>Programme principal<br><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-state="off" data-mode="c_cpp">//===============================================
void GQXmlUi::run(int _argc, char** _argv) {
    sGApp* lApp = GManager::Instance()-&gt;data()-&gt;app;
...
//===============================================</pre></div></div><br><div class="Img3 GImage"><img alt="/Tutoriels/Software_Development/Cpp/img/i_qt_xml_firstelement_show.png" class="lazy" data-src="/Tutoriels/Software_Development/Cpp/img/i_qt_xml_firstelement_show.png"></div><br><h3 class="GTitle3" id="Interface-Homme-Machine-avec-Qt-Apprendre-le-XML-Recuperation-d-un-attribut"><a class="Title8" href="#Interface-Homme-Machine-avec-Qt-Apprendre-le-XML">Récupération d'un attribut</a></h3><br>Programme principal<br><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-state="off" data-mode="c_cpp">//===============================================
void GQXmlUi::run(int _argc, char** _argv) {
    sGApp* lApp = GManager::Instance()-&gt;data()-&gt;app;
...
//===============================================</pre></div></div><br><div class="Img3 GImage"><img alt="/Tutoriels/Software_Development/Cpp/img/i_qt_xml_attribute_get.png" class="lazy" data-src="/Tutoriels/Software_Development/Cpp/img/i_qt_xml_attribute_get.png"></div><br><h3 class="GTitle3" id="Interface-Homme-Machine-avec-Qt-Apprendre-le-XML-Modification-d-un-attribut"><a class="Title8" href="#Interface-Homme-Machine-avec-Qt-Apprendre-le-XML">Modification d'un attribut</a></h3><br>Programme principal<br><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-state="off" data-mode="c_cpp">//===============================================
void GQXmlUi::run(int _argc, char** _argv) {
    sGApp* lApp = GManager::Instance()-&gt;data()-&gt;app;
...
//===============================================</pre></div></div><br><div class="Img3 GImage"><img alt="/Tutoriels/Software_Development/Cpp/img/i_qt_xml_attribute_set.png" class="lazy" data-src="/Tutoriels/Software_Development/Cpp/img/i_qt_xml_attribute_set.png"></div><br><h3 class="GTitle3" id="Interface-Homme-Machine-avec-Qt-Apprendre-le-XML-Creation-d-un-nouveau-noeud"><a class="Title8" href="#Interface-Homme-Machine-avec-Qt-Apprendre-le-XML">Création d'un nouveau noeud</a></h3><br>Programme principal<br><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-state="off" data-mode="c_cpp">//===============================================
void GQXmlUi::run(int _argc, char** _argv) {
    sGApp* lApp = GManager::Instance()-&gt;data()-&gt;app;
...
//===============================================</pre></div></div><br>Création du tableur<br><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-state="off" data-mode="c_cpp">//===============================================
...
//===============================================</pre></div></div><br>Création d'une cellule<br><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-state="off" data-mode="c_cpp">//===============================================
GQtCell::GQtCell() {
...
//===============================================</pre></div></div><br><div class="Img3 GImage"><img src="/Tutoriels/Software_Development/Cpp/img/i_qt_spreadsheet_grid.png" alt="/Tutoriels/Software_Development/Cpp/img/i_qt_spreadsheet_grid.png"></div><br><h3 class="GTitle3" id="Interface-Homme-Machine-avec-Qt-Conception-d-un-tableur-Enregistrement-des-parametres"><a class="Title8" href="#Interface-Homme-Machine-avec-Qt-Conception-d-un-tableur">Enregistrement des paramètres</a></h3><br>Programme principal<br><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-state="off" data-mode="c_cpp">//===============================================
...
//===============================================</pre></div></div><br>Enregistrement des paramètres<br><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-state="off" data-mode="c_cpp">//===============================================
...
//===============================================</pre></div></div><br><div class="Img3 GImage"><img src="/Tutoriels/Software_Development/Cpp/img/i_qt_spreadsheet_setting_write.png" alt="/Tutoriels/Software_Development/Cpp/img/i_qt_spreadsheet_setting_write.png"></div><br><h3 class="GTitle3" id="Interface-Homme-Machine-avec-Qt-Conception-d-un-tableur-Chargement-des-parametres"><a class="Title8" href="#Interface-Homme-Machine-avec-Qt-Conception-d-un-tableur">Chargement des paramètres</a></h3><br>Programme principal<br><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-state="off" data-mode="c_cpp">//===============================================
GQtSpreadWindow::GQtSpreadWindow(QWidget* _parent) :
GQtMainWindow(_parent) {
...
//===============================================</pre></div></div><br>Chargement des paramètres<br><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-state="off" data-mode="c_cpp">//===============================================
...
//===============================================</pre></div></div><br><div class="Img3 GImage"><img alt="/Tutoriels/Software_Development/Cpp/img/i_opengl_shader_particles.png" class="lazy" data-src="/Tutoriels/Software_Development/Cpp/img/i_opengl_shader_particles.png"></div><br><h2 class="Title7 GTitle2" id="Programmation-3D-avec-OpenGL-Tracage-de-fonctions-2D"><a class="Link9" href="#Programmation-3D-avec-OpenGL">Traçage de fonctions 2D</a></h2><br>Cette opération permet de proposer une application de <b>traçage de fonctions 2D</b> avec OpenGL.<br><br><div class="Content0 GSummary3"><div class="Item4"><i class="Icon10 fa fa-book"></i><a class="Link4" href="#Programmation-3D-avec-OpenGL-Tracage-de-fonctions-2D-Tracage-d-un-point">Traçage d'un point</a></div></div><br><h3 class="GTitle3" id="Programmation-3D-avec-OpenGL-Tracage-de-fonctions-2D-Tracage-d-un-point"><a class="Title8" href="#Programmation-3D-avec-OpenGL-Tracage-de-fonctions-2D">Traçage d'un point</a></h3><br>Cette opération permet d'<b>afficher un point</b> dans un repère orthonormé. On commence par tracer la grille et les axes du repère avant de tracer le point.<br><br><div class="Img3 GImage"><img alt="/Tutoriels/Software_Development/Cpp/img/i_opengl_graph_point.png" class="lazy" data-src="/Tutoriels/Software_Development/Cpp/img/i_opengl_graph_point.png"></div><br>Programme principal<br><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-state="off" data-mode="c_cpp">//===============================================
...
//===============================================</pre></div></div><br><div class="Img3 GImage"><img alt="/Tutoriels/Software_Development/Cpp/img/i_socket_learn_multithreading_server.png" class="lazy" data-src="/Tutoriels/Software_Development/Cpp/img/i_socket_learn_multithreading_server.png"></div><br>Programme principal (Client)<br><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-state="off" data-mode="c_cpp">//===============================================
void GSocketClient::run(int _argc, char** _argv) {
    GSocket lServer;
    sGSocket lParams;
    std::string lData;
...
//===============================================</pre></div></div><br><div class="Img3 GImage"><img alt="/Tutoriels/Software_Development/Cpp/img/i_socket_learn_multithreading_client.png" class="lazy" data-src="/Tutoriels/Software_Development/Cpp/img/i_socket_learn_multithreading_client.png"></div><br>Démarrage du serveur<br><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-state="off" data-mode="c_cpp">//===============================================
...
//===============================================</pre></div></div><br><div class="Img3 GImage"><img alt="/Tutoriels/Software_Development/Cpp/img/i_xml_learn_node_prev_sibling.png" class="lazy" data-src="/Tutoriels/Software_Development/Cpp/img/i_xml_learn_node_prev_sibling.png"></div><br><h3 class="GTitle3" id="Analyse-de-donnees-XML-avec-Libxml2-Apprendre-libxml2-Ajout-d-un-noeud-a-la-fin"><a class="Title8" href="#Analyse-de-donnees-XML-avec-Libxml2-Apprendre-libxml2">Ajout d'un noeud à la fin</a></h3><br>Programme principal<br><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-state="off" data-mode="c_cpp">//===============================================
void GXmlUi::run(int argc, char** argv) {
    sGApp* lApp = GManager::Instance()-&gt;data()-&gt;app;
...
//===============================================</pre></div></div><br><div class="Img3 GImage"><img alt="/Tutoriels/Software_Development/Cpp/img/i_xml_learn_node_append.png" class="lazy" data-src="/Tutoriels/Software_Development/Cpp/img/i_xml_learn_node_append.png"></div><br><h3 class="GTitle3" id="Analyse-de-donnees-XML-avec-Libxml2-Apprendre-libxml2-Recuperation-du-contenu-d-un-noeud"><a class="Title8" href="#Analyse-de-donnees-XML-avec-Libxml2-Apprendre-libxml2">Récupération du contenu d'un noeud</a></h3><br>Programme principal<br><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-state="off" data-mode="c_cpp">//===============================================
void GXmlUi::run(int argc, char** argv) {
    sGApp* lApp = GManager::Instance()-&gt;data()-&gt;app;
...
//===============================================</pre></div></div><br><div class="Img3 GImage"><img alt="/Tutoriels/Software_Development/Cpp/img/i_xml_learn_node_content.png" class="lazy" data-src="/Tutoriels/Software_Development/Cpp/img/i_xml_learn_node_content.png"></div><br><h3 class="GTitle3" id="Analyse-de-donnees-XML-avec-Libxml2-Apprendre-libxml2-Creation-d-un-document-XML"><a class="Title8" href="#Analyse-de-donnees-XML-avec-Libxml2-Apprendre-libxml2">Création d'un document XML</a></h3><br>Programme principal<br><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-state="off" data-mode="c_cpp">//===============================================
void GXmlUi::run(int argc, char** argv) {
    GXml lXml, lProduct;
    lXml.blank();
    lXml.doc();
...
//===============================================</pre></div></div><br><div class="Img3 GImage"><img alt="/Tutoriels/Software_Development/Cpp/img/i_xml_learn_doc_create.png" class="lazy" data-src="/Tutoriels/Software_Development/Cpp/img/i_xml_learn_doc_create.png"></div><br><h3 class="GTitle3" id="Analyse-de-donnees-XML-avec-Libxml2-Apprendre-libxml2-Encodage-d-un-document-XML"><a class="Title8" href="#Analyse-de-donnees-XML-avec-Libxml2-Apprendre-libxml2">Encodage d'un document XML</a></h3><br>Programme principal<br><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-state="off" data-mode="c_cpp">//===============================================
void GXmlUi::run(int argc, char** argv) {
    sGApp* lApp = GManager::Instance()-&gt;data()-&gt;app;
...
//===============================================</pre></div></div><br><div class="Img3 GImage"><img alt="/Tutoriels/Software_Development/Cpp/img/i_xml_learn_doc_encoding.png" class="lazy" data-src="/Tutoriels/Software_Development/Cpp/img/i_xml_learn_doc_encoding.png"></div><br><h3 class="GTitle3" id="Analyse-de-donnees-XML-avec-Libxml2-Apprendre-libxml2-Enregistrement-d-un-document-XML"><a class="Title8" href="#Analyse-de-donnees-XML-avec-Libxml2-Apprendre-libxml2">Enregistrement d'un document XML</a></h3><br>Programme principal<br><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-state="off" data-mode="c_cpp">//===============================================
void GXmlUi::run(int argc, char** argv) {
    sGApp* lApp = GManager::Instance()-&gt;data()-&gt;app;
...
//===============================================</pre></div></div><br><div class="Img3 GImage"><img alt="/Tutoriels/Software_Development/Cpp/img/i_xml_learn_doc_save.png" class="lazy" data-src="/Tutoriels/Software_Development/Cpp/img/i_xml_learn_doc_save.png"></div><br><h3 class="GTitle3" id="Analyse-de-donnees-XML-avec-Libxml2-Apprendre-libxml2-Conversion-d-une-chaine-en-document-XML"><a class="Title8" href="#Analyse-de-donnees-XML-avec-Libxml2-Apprendre-libxml2">Conversion d'une chaine en document XML</a></h3><br>Programme principal<br><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-state="off" data-mode="c_cpp">//===============================================
void GXmlUi::run(int argc, char** argv) {
    sGApp* lApp = GManager::Instance()-&gt;data()-&gt;app;
...
//===============================================</pre></div></div><br><div class="Img3 GImage"><img alt="/Tutoriels/Software_Development/Cpp/img/i_pugixml_learn_doc_load.png" class="lazy" data-src="/Tutoriels/Software_Development/Cpp/img/i_pugixml_learn_doc_load.png"></div><br><h3 class="GTitle3" id="Analyse-de-donnees-XML-avec-PugiXml-Apprendre-PugiXml-Ajout-d-un-nouveau-noeud"><a class="Title8" href="#Analyse-de-donnees-XML-avec-PugiXml-Apprendre-PugiXml">Ajout d'un nouveau noeud</a></h3><br>Programme principal<br><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-state="off" data-mode="c_cpp">//===============================================
void GXmlUi::run(int argc, char** argv) {
    sGApp* lApp = GManager::Instance()-&gt;data()-&gt;app;
    GXml lXml;
...
//===============================================</pre></div></div><br><div class="Img3 GImage"><img alt="/Tutoriels/Software_Development/Cpp/img/i_pugixml_learn_node_append.png" class="lazy" data-src="/Tutoriels/Software_Development/Cpp/img/i_pugixml_learn_node_append.png"></div><br><h3 class="GTitle3" id="Analyse-de-donnees-XML-avec-PugiXml-Apprendre-PugiXml-Creation-d-un-document-XML"><a class="Title8" href="#Analyse-de-donnees-XML-avec-PugiXml-Apprendre-PugiXml">Création d'un document XML</a></h3><br>Programme principal<br><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-state="off" data-mode="c_cpp">//===============================================
void GXmlUi::append(GXml&amp; _xml, const std::string&amp; _reference, const std::string&amp; _name, const std::string&amp; _price) {
    GXml lProduct, lName, lPrice;
    _xml.appendChild(lProduct, "product");
    lProduct.appendAttribute("reference", _reference);
...
//===============================================</pre></div></div><br><div class="Img3 GImage"><img alt="/Tutoriels/Software_Development/Cpp/img/i_pugixml_learn_doc_create.png" class="lazy" data-src="/Tutoriels/Software_Development/Cpp/img/i_pugixml_learn_doc_create.png"></div><br><h3 class="GTitle3" id="Analyse-de-donnees-XML-avec-PugiXml-Apprendre-PugiXml-Enregistrement-d-un-document-XML"><a class="Title8" href="#Analyse-de-donnees-XML-avec-PugiXml-Apprendre-PugiXml">Enregistrement d'un document XML</a></h3><br>Programme principal<br><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-state="off" data-mode="c_cpp">//===============================================
void GXmlUi::run(int argc, char** argv) {
    sGApp* lApp = GManager::Instance()-&gt;data()-&gt;app;
    GXml lXml;
    lXml.createDoc();
...
//===============================================</pre></div></div><br><div class="Img3 GImage"><img alt="/Tutoriels/Software_Development/Cpp/img/i_pugixml_learn_doc_save.png" class="lazy" data-src="/Tutoriels/Software_Development/Cpp/img/i_pugixml_learn_doc_save.png"></div><br><h3 class="GTitle3" id="Analyse-de-donnees-XML-avec-PugiXml-Apprendre-PugiXml-Conversion-d-un-document-en-chaine"><a class="Title8" href="#Analyse-de-donnees-XML-avec-PugiXml-Apprendre-PugiXml">Conversion d'un document en chaine</a></h3><br>Programme principal<br><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-state="off" data-mode="c_cpp">//===============================================
void GXmlUi::run(int argc, char** argv) {
    sGApp* lApp = GManager::Instance()-&gt;data()-&gt;app;
    GXml lXml;
    std::string lData;
...
//===============================================</pre></div></div><br><div class="Img3 GImage"><img alt="/Tutoriels/Software_Development/Cpp/img/i_pugixml_learn_doc_string.png" class="lazy" data-src="/Tutoriels/Software_Development/Cpp/img/i_pugixml_learn_doc_string.png"></div><br><h3 class="GTitle3" id="Analyse-de-donnees-XML-avec-PugiXml-Apprendre-PugiXml-Conversion-d-un-noeud-en-chaine"><a class="Title8" href="#Analyse-de-donnees-XML-avec-PugiXml-Apprendre-PugiXml">Conversion d'un noeud en chaine</a></h3><br>Programme principal<br><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-state="off" data-mode="c_cpp">//===============================================
void GXmlUi::run(int argc, char** argv) {
    sGApp* lApp = GManager::Instance()-&gt;data()-&gt;app;
    GXml lXml, lProduct;
    std::string lData;
...
//===============================================</pre></div></div><br><div class="Img3 GImage"><img alt="/Tutoriels/Software_Development/Cpp/img/i_pugixml_learn_node_string.png" class="lazy" data-src="/Tutoriels/Software_Development/Cpp/img/i_pugixml_learn_node_string.png"></div><br><h3 class="GTitle3" id="Analyse-de-donnees-XML-avec-PugiXml-Apprendre-PugiXml-Conversion-d-une-chaine-en-document"><a class="Title8" href="#Analyse-de-donnees-XML-avec-PugiXml-Apprendre-PugiXml">Conversion d'une chaine en document</a></h3><br>Programme principal<br><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-state="off" data-mode="c_cpp">//===============================================
void GXmlUi::run(int argc, char** argv) {
    GXml lXml, lDoc;
    std::string lData;
    lXml.createDoc();
...
//===============================================</pre></div></div><br><div class="Img3 GImage"><img alt="/Tutoriels/Software_Development/Cpp/img/i_pugixml_learn_doc_doc.png" class="lazy" data-src="/Tutoriels/Software_Development/Cpp/img/i_pugixml_learn_doc_doc.png"></div><br></div></div></div></div><br>