...
-1-2µuv &amp; µ(1-u^2)\\
\end{pmatrix}
$$</div></div><br><h2 class="Title7 GTitle2" id="Calcul scientifique avec GSL-3.1.1.1 - Initialiser le système d'équations différentielles ordinaires"><a class="Link9" href="#Calcul scientifique avec GSL">3.1.1.1 - Initialiser le système d'équations différentielles ordinaires</a></h2><br><div class="GCode1"><pre class="Code2"><xmp class="AceCode" data-mode="c_cpp">gsl_odeiv2_system sys = {functionMat, jacobianMat, 2, &mu};</xmp></pre></div><br></div></div></div></div><br>