...
//===============================================</pre></div></div><br><div class="Img3 GImage"><img src="/Tutoriels/Software_Development/Cpp/img/i_poo_learn_inheritance.png" alt="/Tutoriels/Software_Development/Cpp/img/i_poo_learn_inheritance.png"></div><br>Programme principal (avec accolades)<br><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-state="off" data-mode="c_cpp">//===============================================
void GCppUi::run(int _argc, char** _argv) {
...
//===============================================</pre></div></div><br><div class="Img3 GImage"><img src="/Tutoriels/Software_Development/Cpp/img/i_poo_learn_operator_assign.png" alt="/Tutoriels/Software_Development/Cpp/img/i_poo_learn_operator_assign.png"></div><br><h3 class="GTitle3" id="Programmation-orientee-objet-Surchage-d-operateurs-Surcharge-de-l-operateur-addition-affectation-----"><a class="Title8" href="#Programmation-orientee-objet-Surchage-d-operateurs">Surcharge de l'opérateur addition-affectation (+=)</a></h3><br>Programme principal<br><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-state="off" data-mode="c_cpp">//===============================================
void GCppUi::run(int _argc, char** _argv) {
    GClass lObjA(100);
    GClass lObjB(50);
    lObjB += lObjA;
...
//===============================================</pre></div></div><br>Déclaration de la surcharge de l'opérateur addition (.cpp)<br><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-state="off" data-mode="c_cpp">//===============================================
class GClass {
public:
GClass();
GClass(int _data);
...
//================================================</pre></div></div><br><h3 class="Title8 GTitle3" id="Calcul-scientifique-avec-GSL-Rechercher-une-interpolation-lineaire-Resultat"><a class="Title8" href="#Calcul-scientifique-avec-GSL-Rechercher-une-interpolation-lineaire">Résultat</a></h3><br><div class="Img3 GImage"><img alt="/Tutoriels/Software_Development/Cpp/img/i_gsl_interpolation_linear.gif" class="lazy entered loaded" data-src="/Tutoriels/Software_Development/Cpp/img/i_gsl_interpolation_linear.gif" data-ll-status="loaded" src="/Tutoriels/Software_Development/Cpp/img/i_gsl_interpolation_linear.gif"></div><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-state="off" data-mode="c_cpp">gsl_interp_name :  linear
...
//================================================</pre></div></div><br><h3 class="Title8 GTitle3" id="Calcul-scientifique-avec-GSL-Rechercher-une-interploation-polynomiale-Resultat"><a class="Title8" href="#Calcul-scientifique-avec-GSL-Rechercher-une-interploation-polynomiale">Résultat</a></h3><br><div class="Img3 GImage"><img alt="/Tutoriels/Software_Development/Cpp/img/i_gsl_interpolation_polynomial.gif" class="lazy entered loaded" data-src="/Tutoriels/Software_Development/Cpp/img/i_gsl_interpolation_polynomial.gif" data-ll-status="loaded" src="/Tutoriels/Software_Development/Cpp/img/i_gsl_interpolation_polynomial.gif"></div><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-state="off" data-mode="c_cpp">gsl_interp_name :  polynomial
...
//===============================================</pre></div></div><br><div class="Img3 GImage"><img src="/Tutoriels/Software_Development/Cpp/img/i_xmlrpc_learn_rpc_server.png" alt="/Tutoriels/Software_Development/Cpp/img/i_xmlrpc_learn_rpc_server.png"></div><br>Programme principal (Client)<br><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-state="off" data-mode="c_cpp">//===============================================
...
//===============================================</pre></div></div><br><div class="Img3 GImage"><img src="/Tutoriels/Software_Development/Cpp/img/i_xmlrpc_learn_rpc_client.png" alt="/Tutoriels/Software_Development/Cpp/img/i_xmlrpc_learn_rpc_client.png"></div><br>Ajout du methode dans le registre (côté serveur)<br><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-state="off" data-mode="c_cpp">//===============================================
