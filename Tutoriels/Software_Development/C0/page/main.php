...
MSYS2</pre></div></div><br><h3 class="Title8 GTitle3">Installer les packages</h3><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-mode="sh" data-state="off">pacman -Syu
pacman -S --needed --noconfirm make
pacman -S --needed --noconfirm gcc</pre><br></div></div></div></div></div></div><br><div class="Content2 GTitle1"><div class="MainBlock2"><div class="Content"><h1 class="Title2 Center" id="Tests"><a class="Link3" href="#">Tests</a></h1><div class="Body3"><br>Créer un projet C.<br><br><div class="Content0 GSummary2"><div class="Item4"><i class="Icon10 fa fa-book"></i><a class="Link4" href="#Tests-Tester-un-programme-C-sous-MSYS2">Tester un programme C sous MSYS2</a></div></div><br><h2 class="Title7 GTitle2" id="Tests-Tester-un-programme-C-sous-MSYS2"><a class="Link9" href="#Tests">Tester un programme C sous MSYS2</a></h2><br><h3 class="Title8 GTitle3">Éditer le programme</h3><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-mode="sh" data-state="off">//===============================================
#include &lt;stdio.h&gt;
//===============================================
...
//===============================================</pre></div></div><br><h3 class="Title8 GTitle3">Compiler le projet</h3><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-mode="sh">gcc -std=gnu11 -c ./main.c -o ./main.o </pre></div></div><br><h3 class="Title8 GTitle3">Éditer les liens du projet</h3><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-mode="sh">gcc -o ./rdc.exe ./main.o </pre></div></div><br><h3 class="Title8 GTitle3">Exécuter le projet</h3><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-mode="sh">./rdc.exe</pre></div></div><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-mode="sh" data-state="off">Bonjour tout le monde</pre></div></div><br></div></div></div></div><br><div class="Content2 GTitle1"><div class="MainBlock2"><div class="Content"><h1 class="Title2 Center" id="Fondamentaux"><a class="Link3" href="#">Fondamentaux</a></h1><div class="Body3"><br>Les fondamentaux de C.<br><br><div class="Content0 GSummary2"><div class="Item4"><i class="Icon10 fa fa-book"></i><a class="Link4" href="#Fondamentaux-Creer-un-commentaire">Créer un commentaire</a></div><div class="Item4"><i class="Icon10 fa fa-book"></i><a class="Link4" href="#Fondamentaux-Creer-un-commentaire-a-droite">Créer un commentaire à droite</a></div><div class="Item4"><i class="Icon10 fa fa-book"></i><a class="Link4" href="#Fondamentaux-Creer-un-commentaire-sur-plusieurs-lignes">Créer un commentaire sur plusieurs lignes</a></div><div class="Item4"><i class="Icon10 fa fa-book"></i><a class="Link4" href="#Fondamentaux-Afficher-un-message">Afficher un message</a></div><div class="Item4"><i class="Icon10 fa fa-book"></i><a class="Link4" href="#Fondamentaux-Formater-l-affichage-d-un-message">Formater l'affichage d'un message</a></div><div class="Item4"><i class="Icon10 fa fa-book"></i><a class="Link4" href="#Fondamentaux-Definir-la-largeur-de-formatage-de-l-affichage-d-un-message">Définir la largeur de formatage de l'affichage d'un message</a></div><div class="Item4"><i class="Icon10 fa fa-book"></i><a class="Link4" href="#Fondamentaux-Declarer-une-varibale">Déclarer une varibale</a></div><div class="Item4"><i class="Icon10 fa fa-book"></i><a class="Link4" href="#Fondamentaux-Initialiser-une-variable-au-moment-de-sa-declaration">Initialiser une variable au moment de sa déclaration</a></div><div class="Item4"><i class="Icon10 fa fa-book"></i><a class="Link4" href="#Fondamentaux-Affecter-une-valeur-a-une-variable">Affecter une valeur à une variable</a></div><div class="Item4"><i class="Icon10 fa fa-book"></i><a class="Link4" href="#Fondamentaux-Afficher-une-variable">Afficher une variable</a></div><div class="Item4"><i class="Icon10 fa fa-book"></i><a class="Link4" href="#Fondamentaux-Saisir-un-entier-au-clavier">Saisir un entier au clavier</a></div><div class="Item4"><i class="Icon10 fa fa-book"></i><a class="Link4" href="#Fondamentaux-Saisir-un-reel-au-clavier">Saisir un réel au clavier</a></div><div class="Item4"><i class="Icon10 fa fa-book"></i><a class="Link4" href="#Fondamentaux-Saisir-un-mot-au-clavier">Saisir un mot au clavier</a></div><div class="Item4"><i class="Icon10 fa fa-book"></i><a class="Link4" href="#Fondamentaux-Saisir-une-chaine-de-caractere-au-clavier">Saisir une chaîne de caractère au clavier</a></div><div class="Item4"><i class="Icon10 fa fa-book"></i><a class="Link4" href="#Fondamentaux-Creer-une-condition-if">Créer une condition if</a></div><div class="Item4"><i class="Icon10 fa fa-book"></i><a class="Link4" href="#Fondamentaux-Creer-une-condition-if-else">Créer une condition if else</a></div><div class="Item4"><i class="Icon10 fa fa-book"></i><a class="Link4" href="#Fondamentaux-Creer-une-condition-else-if">Créer une condition else if</a></div><div class="Item4"><i class="Icon10 fa fa-book"></i><a class="Link4" href="#Fondamentaux-Creer-une-condition-ternaire">Créer une condition ternaire</a></div><div class="Item4"><i class="Icon10 fa fa-book"></i><a class="Link4" href="#Fondamentaux-Creer-une-condition-switch-case">Créer une condition switch case</a></div><div class="Item4"><i class="Icon10 fa fa-book"></i><a class="Link4" href="#Fondamentaux-Creer-une-boucle-for">Créer une boucle for</a></div><div class="Item4"><i class="Icon10 fa fa-book"></i><a class="Link4" href="#Fondamentaux-Creer-une-boucle-while">Créer une boucle while</a></div><div class="Item4"><i class="Icon10 fa fa-book"></i><a class="Link4" href="#Fondamentaux-Creer-une-boucle-do-while">Créer une boucle do while</a></div><div class="Item4"><i class="Icon10 fa fa-book"></i><a class="Link4" href="#Fondamentaux-Creer-une-fonction">Créer une fonction</a></div><div class="Item4"><i class="Icon10 fa fa-book"></i><a class="Link4" href="#Fondamentaux-Creer-une-fonction-avec-un-parametre">Créer une fonction avec un paramètre</a></div><div class="Item4"><i class="Icon10 fa fa-book"></i><a class="Link4" href="#Fondamentaux-Creer-une-fonction-qui-retourne-une-valeur">Créer une fonction qui retourne une valeur</a></div><div class="Item4"><i class="Icon10 fa fa-book"></i><a class="Link4" href="#Fondamentaux-Creer-une-fonction-recursive">Créer une fonction récursive</a></div><div class="Item4"><i class="Icon10 fa fa-book"></i><a class="Link4" href="#Fondamentaux-Creer-une-structure">Créer une structure</a></div><div class="Item4"><i class="Icon10 fa fa-book"></i><a class="Link4" href="#Fondamentaux-Creer-un-pointeur-de-fonction">Créer un pointeur de fonction</a></div><div class="Item4"><i class="Icon10 fa fa-book"></i><a class="Link4" href="#Fondamentaux-Creer-un-type-pointeur-de-fonction">Créer un type pointeur de fonction</a></div><div class="Item4"><i class="Icon10 fa fa-book"></i><a class="Link4" href="#Fondamentaux-Creer-une-machine-a-etats-finis">Créer une machine à états finis</a></div></div><br><h2 class="Title7 GTitle2" id="Fondamentaux-Creer-un-commentaire"><a class="Link9" href="#Fondamentaux">Créer un commentaire</a></h2><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-mode="c_cpp" data-state="off">//===============================================
#include &lt;stdio.h&gt;
//===============================================
int main(int argc, char** argv) {
...
//===============================================</pre></div></div><br><h2 class="Title7 GTitle2" id="Fondamentaux-Saisir-un-reel-au-clavier"><a class="Link9" href="#Fondamentaux">Saisir un réel au clavier</a></h2><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-mode="c_cpp" data-state="off">//===============================================
#include &lt;stdio.h&gt;
#include &lt;stdlib.h&gt;
#include &lt;string.h&gt;
//===============================================
...
//===============================================</pre></div></div><br><h2 class="Title7 GTitle2" id="Fondamentaux-Creer-une-fonction-avec-un-parametre"><a class="Link9" href="#Fondamentaux">Créer une fonction avec un paramètre</a></h2><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-mode="c_cpp" data-state="off">//===============================================
#include &lt;stdio.h&gt;
//===============================================
...
on sauvegarde la base de donnee</pre></div></div><br><h2 class="Title7 GTitle2" id="Patrons-de-conception-Creer-un-patron-strategie"><a class="Link9" href="#Patrons-de-conception">Créer un patron stratégie</a></h2><br>Le patron <b>stratégie </b>est un patron de conception de type comportemental grâce auquel des algorithmes peuvent être sélectionnés à la volée au cours de l'exécution selon certaines conditions, comme les stratégies utilisées en temps de guerre. Le patron de conception stratégie est utile pour des situations où il est nécessaire de permuter dynamiquement les algorithmes utilisés dans une application. Le patron stratégie est prévu pour fournir des moyens de définir une famille d'algorithmes, encapsuler chacun comme objet, et les rendre interchangeables. Le patron stratégie laisse les algorithmes changer indépendamment des clients qui les emploient.<br><br><h3 class="Title8 GTitle3">main.c</h3><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-mode="c_cpp">//===============================================
#include "GAnimal.h"
#include "GCat.h"
#include "GDog.h"
//===============================================
...
Je suis un chien : mon poids est : 10 (kg)</pre></div></div><br><h2 class="Title7 GTitle2" id="Patrons-de-conception-Creer-un-patron-fabrique"><a class="Link9" href="#Patrons-de-conception">Créer un patron fabrique</a></h2><br>La <b>fabrique </b>(factory) est un patron de conception de création utilisé en programmation orientée objet. Comme les autres modèles de création, la fabrique a pour rôle l'instanciation d'objets divers dont le type n'est pas prédéfini : les objets sont créés dynamiquement en fonction des paramètres passés à la fabrique. Comme en général, les fabriques sont uniques dans un programme, on utilise souvent le patron de conception singleton pour gérer leur création.<br><br><h3 class="Title8 GTitle3">main.c</h3><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-mode="c_cpp">//===============================================
#include "GAnimal.h"
//===============================================
int main(int argc, char** argv) {
    GAnimalO* lAnimals[3];
...
//===============================================</pre></div></div><br><h3 class="Title8 GTitle3">GCat.h</h3><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-mode="c_cpp" data-state="off">//===============================================
#ifndef _GCat_
#define _GCat_
//===============================================
#include "GAnimal.h"
...
//===============================================</pre></div></div><br><h3 class="Title8 GTitle3">Résultat</h3><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-mode="c_cpp">Je suis un animal
Je suis un chat
Je suis un chien</pre></div></div><br><h2 class="Title7 GTitle2" id="Patrons-de-conception-Creer-un-patron-observateur"><a class="Link9" href="#Patrons-de-conception">Créer un patron observateur</a></h2><br>Le patron de conception <b>observateur</b>/observable est utilisé en programmation pour envoyer un signal à des modules qui jouent le rôle d'observateur. En cas de notification, les observateurs effectuent alors l'action adéquate en fonction des informations qui parviennent depuis les modules qu'ils observent (les "observables"). Dans ce patron de conception, l'objet observé maintient une liste d'observateurs et les notifient automatiquement de tout changement d'état, généralement en appelant une de leur méthode.<br><br><h3 class="Title8 GTitle3">main.c</h3><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-mode="c_cpp">//===============================================
#include "GWidget.h"
//===============================================
int main(int argc, char** argv) {
...
Je fais allumer la LED [ON]
Je clique sur le BOUTON
Je fais eteindre la LED [OFF]</pre></div></div><br></div></div></div></div><br><div class="Content2 GTitle1"><div class="MainBlock2"><div class="Content"><h1 class="Title2 Center" id="Systeme-d-administration"><a class="Link3" href="#">Système d'administration</a></h1><div class="Body3"><br>Le <b>système d'administration</b> que nous présentons ici est une interface en ligne de commande permettant d'accéder à toutes les fonctionnalités d'une application.<br><br><div class="Content0 GSummary2"><div class="Item4"><i class="Icon10 fa fa-book"></i><a class="Link4" href="#Systeme-d-administration-main-c">main.c</a></div><div class="Item4"><i class="Icon10 fa fa-book"></i><a class="Link4" href="#Systeme-d-administration-Resultat">Résultat</a></div></div><br><h2 class="Title7 GTitle2" id="Systeme-d-administration-main-c"><a class="Link9" href="#Systeme-d-administration">main.c</a></h2><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-mode="c_cpp">//===============================================
#include &lt;stdio.h&gt;
#include &lt;stdlib.h&gt;
#include &lt;string.h&gt;
//===============================================
...
//===============================================</pre></div></div><br><h3 class="Title8 GTitle3">Résultat</h3><br><div class="Img3 GImage"><img alt="/Tutoriels/Software_Development/C0/img/i_log_simple.png" class="lazy entered loaded" data-src="/Tutoriels/Software_Development/C0/img/i_log_simple.png" data-ll-status="loaded" src="/Tutoriels/Software_Development/C0/img/i_log_simple.png"></div><br><h2 class="Title7 GTitle2" id="Gestionnaire-de-fichier-log-Creer-un-gestionnaire-de-fichier-complexe"><a class="Link9" href="#Gestionnaire-de-fichier-log">Créer un gestionnaire de fichier complexe</a></h2><br><h3 class="Title8 GTitle3">main.c</h3><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-mode="c_cpp">//===============================================
#include &lt;stdio.h&gt;
#include &lt;stdlib.h&gt;
#include &lt;string.h&gt;
#include &lt;stdarg.h&gt;
...
[Thread_B] on incremente le compteur : 8
[Thread_A] on incremente le compteur : 9
[Thread_B] on incremente le compteur : 10</pre></div></div><br></div></div></div></div><br><div class="Content2 GTitle1"><div class="MainBlock2"><div class="Content"><h1 class="Title2 Center" id="Memoire-partagee"><a class="Link3" href="#">Mémoire partagée</a></h1><div class="Body3"><br>Dans un contexte de la programmation concurrente, le <b>partage de mémoire</b> est un moyen de partager des données entre différents processus : une même zone de la mémoire vive est accédée par plusieurs processus. C'est le comportement de la mémoire de threads issus d'un même processus. Pour cela, dans un système utilisant la pagination, la table de page de chaque processus contient les pages mémoires communes, mais chaque processus ne les voit pas nécessairement à la même adresse.<br><br><div class="Content0 GSummary2"><div class="Item4"><i class="Icon10 fa fa-book"></i><a class="Link4" href="#Memoire-partagee-Creer-une-memoire-partagee">Créer une mémoire partagée</a></div><div class="Item4"><i class="Icon10 fa fa-book"></i><a class="Link4" href="#Memoire-partagee-Lire-une-memoire-partagee-existante">Lire une mémoire partagée existante</a></div><div class="Item4"><i class="Icon10 fa fa-book"></i><a class="Link4" href="#Memoire-partagee-Modifier-une-memoire-partagee-existante">Modifier une mémoire partagée existante</a></div><div class="Item4"><i class="Icon10 fa fa-book"></i><a class="Link4" href="#Memoire-partagee-Supprimer-une-memoire-partagee-existante">Supprimer une mémoire partagée existante</a></div><div class="Item4"><i class="Icon10 fa fa-book"></i><a class="Link4" href="#Memoire-partagee-Operations-sur-les-memoires-partagees">Opérations sur les mémoires partagées</a></div><div class="Item4"><i class="Icon10 fa fa-book"></i><a class="Link4" href="#Memoire-partagee-Operations-sur-les-files-d-attente-de-message">Opérations sur les files d'attente de message</a></div><div class="Item4"><i class="Icon10 fa fa-book"></i><a class="Link4" href="#Memoire-partagee-Operations-sur-les-files-d-attente-de-semaphore">Opérations sur les files d'attente de sémaphore</a></div></div><br><div class="Img3 GImage"><img src="/Tutoriels/Software_Development/C0/img/b_shared_memory.png" alt="/Tutoriels/Software_Development/C0/img/b_shared_memory.png"></div><br><h2 class="Title7 GTitle2" id="Memoire-partagee-Creer-une-memoire-partagee"><a class="Link9" href="#Memoire-partagee">Créer une mémoire partagée</a></h2><br><h3 class="Title8 GTitle3">main.c</h3><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-state="off" data-mode="c_cpp">//===============================================
#include &lt;stdio.h&gt;
#include &lt;sys/ipc.h&gt;
#include &lt;sys/shm.h&gt;
#include &lt;sys/stat.h&gt;
...
### Print out the string from shared memory
The contents of the shared memory is:
Modified the segment at Thu Jun 10 16:05:15 2021</pre></div></div><br><h2 class="Title7 GTitle2" id="Memoire-partagee-Supprimer-une-memoire-partagee-existante"><a class="Link9" href="#Memoire-partagee">Supprimer une mémoire partagée existante</a></h2><br><h3 class="Title8 GTitle3">main.c</h3><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-state="off" data-mode="c_cpp">//===============================================
#include &lt;stdio.h&gt;
#include &lt;sys/ipc.h&gt;
#include &lt;sys/shm.h&gt;
#include &lt;sys/stat.h&gt;
...
int main(int argc, char** argv) {
    ...
    printf("### Deallocate the segment\n");
    shmctl (segment_id, IPC_RMID, 0);

    return 0;
}
//===============================================</pre></div></div><br><h3 class="Title8 GTitle3">Résultat</h3><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-state="off" data-mode="c_cpp">Enter the shared memory id: 8
### Deallocate the segment</pre></div></div><br><h2 class="Title7 GTitle2" id="Memoire-partagee-Operations-sur-les-memoires-partagees"><a class="Link9" href="#Memoire-partagee">Opérations sur les mémoires partagées</a></h2><br><h3 class="Title8 GTitle3">Lister les mémoires partagées</h3><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-state="off" data-mode="c_cpp">ipcs -m</pre></div></div><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-state="off" data-mode="c_cpp">------ Shared Memory Segments --------
key        shmid      owner      perms      bytes      nattch     status
0x00000000 8          rpi4       660        25600      0</pre></div></div><br><h3 class="Title8 GTitle3">Afficher les limites des mémoires partagées</h3><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-state="off" data-mode="c_cpp">ipcs -l</pre></div></div><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-state="off" data-mode="c_cpp">------ Messages Limits --------
...
semaphore max value = 32767</pre></div></div><br><h3 class="Title8 GTitle3">Afficher la taille maximale d'un segment de mémoire partagée</h3><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-state="off" data-mode="c_cpp">ls -l /proc/sys/kernel/shm*

-rw-r--r-- 1 root root 0 juin  11 02:01 /proc/sys/kernel/shmall
-rw-r--r-- 1 root root 0 juin  11 02:01 /proc/sys/kernel/shmmax
-rw-r--r-- 1 root root 0 juin  11 02:01 /proc/sys/kernel/shmmni
-rw-r--r-- 1 root root 0 juin  11 02:50 /proc/sys/kernel/shm_next_id
-rw-r--r-- 1 root root 0 juin  11 02:50 /proc/sys/kernel/shm_rmid_forced

cat /proc/sys/kernel/shmmax

18446744073692774399</pre></div></div><br><h3 class="Title8 GTitle3">Modifier la taille maximale d'un segment de mémoire partagée</h3><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-state="off" data-mode="c_cpp">sudo echo 18446744073692774399 &gt; /proc/sys/kernel/shmmax</pre></div></div><br><h2 class="Title7 GTitle2" id="Memoire-partagee-Operations-sur-les-files-d-attente-de-message"><a class="Link9" href="#Memoire-partagee">Opérations sur les files d'attente de message</a></h2><br>Une file d'attente de message  (<b>message queue</b>) ou simplement file de messages est une technique de programmation utilisée pour la communication interprocessus ou la communication de serveur-à-serveur. Les logiciels fournissant ce type de service font partie des « Message-Oriented Middleware » ou MOM. Les files d'attente de message permettent le fonctionnement des liaisons asynchrones normalisées entre deux serveurs, c'est-à-dire de canaux de communications tels que l'expéditeur et le récepteur du message ne sont pas contraints de s'attendre l'un l'autre, mais poursuivent chacun l'exécution de leurs tâches. La file d'attente stocke les messages émis par l'expéditeur, jusqu'à ce que le destinataire les recherche. L'expéditeur n'a pas à attendre que le récepteur commence à traiter son message, il poste son information et peut passer à autre chose. Le principe très général de la file d'attente est énormément utilisé pour les besoins internes des systèmes d'exploitation. Les files d'attente sont indispensables pour la synchronisation ou le travail multitâche des processus.<br><br><h3 class="Title8 GTitle3">Lister les files d'attente de message</h3><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-state="off" data-mode="c_cpp">ipcs -q</pre></div></div><br><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-state="off" data-mode="c_cpp">------ Message Queues --------
key        msqid      owner      perms      used-bytes   messages</pre></div></div><br><h2 class="Title7 GTitle2" id="Memoire-partagee-Operations-sur-les-files-d-attente-de-semaphore"><a class="Link9" href="#Memoire-partagee">Opérations sur les files d'attente de sémaphore</a></h2><br>Un <b>sémaphore </b>est une variable (ou un type de donnée abstrait) partagée par différents « acteurs », qui garantit que ceux-ci ne peuvent y accéder que de façon séquentielle à travers des opérations atomiques, et constitue la méthode utilisée couramment pour restreindre l'accès à des ressources partagées (par exemple un espace de stockage) et synchroniser les processus dans un environnement de programmation concurrente. Le sémaphore a été inventé par Edsger Dijkstra 1 et utilisé pour la première fois dans le système d'exploitation THE Operating system.<br><br><h3 class="Title8 GTitle3">Lister les files d'attente de sémaphore</h3><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-state="off" data-mode="c_cpp">ipcs -s</pre></div></div><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-state="off" data-mode="c_cpp">------ Semaphore Arrays --------
key        semid      owner      perms      nsems
0x00000000 6          www-data   600        1</pre></div></div><br></div></div></div></div><br><div class="Content2 GTitle1"><div class="MainBlock2"><div class="Content"><h1 class="Title2 Center" id="File-d-attente-de-messages-avec-ZeroMQ"><a class="Link3" href="#">File d'attente de messages avec ZeroMQ</a></h1><div class="Body3"><br><b>ZeroMQ </b>(également écrit ØMQ, 0MQ ou ZMQ) est une bibliothèque de messagerie asynchrone haute performance, destinée à être utilisée dans des applications distribuées ou concurrentes. Il fournit une file d'attente de messages, mais contrairement au Message-oriented middleware, un système ZeroMQ peut fonctionner sans message broker. L'API de la bibliothèque est conçue pour ressembler à celle des sockets BSD. ZeroMQ est développé par une importante communauté de contributeurs. Il a été fondé par iMatix qui détient le nom de domaine et la marque. Il existe des liaisons tierces pour de nombreux langages de programmation populaires. <br><br><div class="Content0 GSummary2"><div class="Item4"><i class="Icon10 fa fa-book"></i><a class="Link4" href="#File-d-attente-de-messages-avec-ZeroMQ-Installer-l-environnement-ZeroMQ-sous-Ubuntu">Installer l'environnement ZeroMQ sous Ubuntu</a></div><div class="Item4"><i class="Icon10 fa fa-book"></i><a class="Link4" href="#File-d-attente-de-messages-avec-ZeroMQ-Compiler-un-projet-ZeroMQ">Compiler un projet ZeroMQ</a></div><div class="Item4"><i class="Icon10 fa fa-book"></i><a class="Link4" href="#File-d-attente-de-messages-avec-ZeroMQ-Echanger-des-donnees-entre-un-client-et-un-serveur">Echanger des données entre un client et un serveur</a></div></div><br><div class="Img3 GImage"><img src="/Tutoriels/Software_Development/C0/img/b_zeromq.png" alt="/Tutoriels/Software_Development/C0/img/b_zeromq.png"></div><br><h2 class="Title7 GTitle2" id="File-d-attente-de-messages-avec-ZeroMQ-Installer-l-environnement-ZeroMQ-sous-Ubuntu"><a class="Link9" href="#File-d-attente-de-messages-avec-ZeroMQ">Installer l'environnement ZeroMQ sous Ubuntu</a></h2><br><h3 class="Title8 GTitle3">Installer ZeroMQ</h3><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-state="off" data-mode="c_cpp">sudo apt install -y libzmq3-dev</pre></div></div><br><h2 class="Title7 GTitle2" id="File-d-attente-de-messages-avec-ZeroMQ-Compiler-un-projet-ZeroMQ"><a class="Link9" href="#File-d-attente-de-messages-avec-ZeroMQ">Compiler un projet ZeroMQ</a></h2><br><h3 class="Title8 GTitle3">Compiler le projet</h3><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-state="off" data-mode="c_cpp">gcc -std=gnu11 -c main.c -o main.o
gcc -std=gnu11 -o rdc main.o -lzmq</pre></div></div><br><h2 class="Title7 GTitle2" id="File-d-attente-de-messages-avec-ZeroMQ-Echanger-des-donnees-entre-un-client-et-un-serveur"><a class="Link9" href="#File-d-attente-de-messages-avec-ZeroMQ">Echanger des données entre un client et un serveur</a></h2><br>Un socket de type <b>ZMQ_REQ </b>est utilisé par un client pour envoyer des requêtes et recevoir des réponses d'un service . Ce type de socket n'autorise qu'une séquence alternée d' appels zmq_send(request) et zmq_recv(reply) suivants . Chaque demande envoyée est soumise à un tour de rôle parmi tous les services et chaque réponse reçue est mise en correspondance avec la dernière demande émise. Lorsqu'une socket ZMQ_REQ entre dans un état exceptionnel en raison d'avoir atteint la limite supérieure pour tous les services , ou s'il n'y a aucun service , alors toutes les opérations zmq_send(3) sur la socket doivent se bloquer jusqu'à ce que l'état exceptionnel se termine ou au moins une le service devient disponible pour l'envoi ; les messages ne sont pas supprimés.<br><br><h3 class="Title8 GTitle3">Serveur (main.c)</h3><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-state="off" data-mode="c_cpp">//===============================================
#include &lt;zmq.h&gt;
#include &lt;stdio.h&gt;
#include &lt;unistd.h&gt;
#include &lt;string.h&gt;
...
//===============================================</pre></div></div><br><h3 class="Title8 GTitle3">Client (main.c)</h3><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-state="off" data-mode="c_cpp">//===============================================
#include &lt;zmq.h&gt;
#include &lt;string.h&gt;
#include &lt;stdio.h&gt;
#include &lt;unistd.h&gt;
...
//===============================================</pre></div></div><br><h3 class="Title8 GTitle3">Démarrer le serveur</h3><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-state="off" data-mode="c_cpp">./rdc
...
Received Hello
Received Hello
Received Hello</pre></div></div><br><h3 class="Title8 GTitle3">Démarrer le client</h3><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-state="off" data-mode="c_cpp">./rdc
...
Received World 8
Sending Hello 9...
Received World 9</pre></div></div><br></div></div></div></div><br><div class="Content2 GTitle1"><div class="MainBlock2"><div class="Content"><h1 class="Title2 Center" id="Interface-Homme-Machine-avec-Gtk"><a class="Link3" href="#">Interface Homme-Machine avec Gtk</a></h1><div class="Body3"><br><b>GTK </b>est une bibliothèque de création d'interfaces homme-machine dévoppé à l'origine pour les besoins du logiciel de traitement d'images GIMP. GTK+ est maintenant utilisé dans de nombreux projets, dont les environnements de bureau GNOME, Xfce, Lxde et ROX. GTK est un projet libre et multiplate-forme.<br><br><div class="Content0 GSummary2"><div class="Item4"><i class="Icon10 fa fa-book"></i><a class="Link4" href="#Interface-Homme-Machine-avec-Gtk-Installer-Gtk-sous-MSYS2">Installer Gtk sous MSYS2</a></div><div class="Item4"><i class="Icon10 fa fa-book"></i><a class="Link4" href="#Interface-Homme-Machine-avec-Gtk-Tester-un-programme-Gtk-sous-MSYS2">Tester un programme Gtk sous MSYS2</a></div><div class="Item4"><i class="Icon10 fa fa-book"></i><a class="Link4" href="#Interface-Homme-Machine-avec-Gtk-Ceer-un-bouton">Céer un bouton</a></div><div class="Item4"><i class="Icon10 fa fa-book"></i><a class="Link4" href="#Interface-Homme-Machine-avec-Gtk-Creer-un-bouton-sans-bordure">Créer un bouton sans bordure</a></div><div class="Item4"><i class="Icon10 fa fa-book"></i><a class="Link4" href="#Interface-Homme-Machine-avec-Gtk-Charger-une-image">Charger une image</a></div><div class="Item4"><i class="Icon10 fa fa-book"></i><a class="Link4" href="#Interface-Homme-Machine-avec-Gtk-Redimensionner-une--image">Redimensionner une&nbsp; image</a></div><div class="Item4"><i class="Icon10 fa fa-book"></i><a class="Link4" href="#Interface-Homme-Machine-avec-Gtk-Utiliser-une-police-personnalisee">Utiliser une police personnalisée</a></div><div class="Item4"><i class="Icon10 fa fa-book"></i><a class="Link4" href="#Interface-Homme-Machine-avec-Gtk-Creer-un-label-avec-un-lien">Créer un label avec un lien</a></div><div class="Item4"><i class="Icon10 fa fa-book"></i><a class="Link4" href="#Interface-Homme-Machine-avec-Gtk-Selectionner-le-texte-d-un-label">Sélectionner le texte d'un label</a></div><div class="Item4"><i class="Icon10 fa fa-book"></i><a class="Link4" href="#Interface-Homme-Machine-avec-Gtk-Ajouter-un-code-mnemonique-a-un-bouton">Ajouter un code mnémonique à un bouton</a></div><div class="Item4"><i class="Icon10 fa fa-book"></i><a class="Link4" href="#Interface-Homme-Machine-avec-Gtk-Ajouter-des-elements-au-debut-d-un-layout-vertical">Ajouter des éléments au début d'un layout vertical</a></div><div class="Item4"><i class="Icon10 fa fa-book"></i><a class="Link4" href="#Interface-Homme-Machine-avec-Gtk-Ajouter-des-elements-a-la-fin-d-un-layout-vertical">Ajouter des éléments à la fin d'un layout vertical</a></div><div class="Item4"><i class="Icon10 fa fa-book"></i><a class="Link4" href="#Interface-Homme-Machine-avec-Gtk-Associer-un-gestionnaire-d-evenement-a-un-widget">Associer un gestionnaire d'évènement à un widget</a></div></div><br><h2 class="Title7 GTitle2" id="Interface-Homme-Machine-avec-Gtk-Installer-Gtk-sous-MSYS2"><a class="Link9" href="#Interface-Homme-Machine-avec-Gtk">Installer Gtk sous MSYS2</a></h2><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-mode="sh">pacman -S --needed --noconfirm mingw-w64-i686-gtk3</pre></div></div><br><h2 class="Title7 GTitle2" id="Interface-Homme-Machine-avec-Gtk-Tester-un-programme-Gtk-sous-MSYS2"><a class="Link9" href="#Interface-Homme-Machine-avec-Gtk">Tester un programme Gtk sous MSYS2</a></h2><br><h3 class="Title8 GTitle3">main.c</h3><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-mode="c_cpp">//===============================================
#include &lt;gtk/gtk.h&gt;
//===============================================
...
-lopencv_core2413 -lopencv_highgui2413</pre></div></div><br><h3 class="Title8 GTitle3">Exécuter le projet</h3><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-mode="batchfile">rdc.exe</pre></div></div><br><div class="Img3 GImage"><img alt="/Tutoriels/Software_Development/C0/img/i_opencv_test.png" class="lazy" data-src="/Tutoriels/Software_Development/C0/img/i_opencv_test.png"></div><br></div></div></div></div><br><div class="Content2 GTitle1"><div class="MainBlock2"><div class="Content"><h1 class="Title2 Center" id="Base-de-donnees-avec-SQLite"><a class="Link3" href="#">Base de données avec SQLite</a></h1><div class="Body3"><br><b>SQLite </b>est un système de gestion de base de données relationnelle accessible par le langage SQL et dont l'intégralité de la base de données (déclarations, tables, index et données) est stockée dans un fichier indépendant de la plateforme.<br><br><div class="Content0 GSummary2"><div class="Item4"><i class="Icon10 fa fa-book"></i><a class="Link4" href="#Base-de-donnees-avec-SQLite-Installer-SQLite-sous-MSYS2">Installer SQLite sous MSYS2</a></div><div class="Item4"><i class="Icon10 fa fa-book"></i><a class="Link4" href="#Base-de-donnees-avec-SQLite-Tester-SQLite-sous-MSYS2">Tester SQLite sous MSYS2</a></div><div class="Item4"><i class="Icon10 fa fa-book"></i><a class="Link4" href="#Base-de-donnees-avec-SQLite-Afficher-la-version-de-SQLite">Afficher la version de SQLite</a></div><div class="Item4"><i class="Icon10 fa fa-book"></i><a class="Link4" href="#Base-de-donnees-avec-SQLite-Creer-une-table">Créer une table</a></div><div class="Item4"><i class="Icon10 fa fa-book"></i><a class="Link4" href="#Base-de-donnees-avec-SQLite-Inserer-des-donnees-dans-la-table">Insérer des données dans la table</a></div><div class="Item4"><i class="Icon10 fa fa-book"></i><a class="Link4" href="#Base-de-donnees-avec-SQLite-Afficher-la-liste-des-tables">Afficher la liste des tables</a></div><div class="Item4"><i class="Icon10 fa fa-book"></i><a class="Link4" href="#Base-de-donnees-avec-SQLite-Afficher-les-donnees-de-la-table">Afficher les données de la table</a></div><div class="Item4"><i class="Icon10 fa fa-book"></i><a class="Link4" href="#Base-de-donnees-avec-SQLite-Afficher-les-noms-des-colonnes">Afficher les noms des colonnes</a></div><div class="Item4"><i class="Icon10 fa fa-book"></i><a class="Link4" href="#Base-de-donnees-avec-SQLite-Ajouter-un--separateur-entre-les-noms-des-colonnes-et-les-donnees">Ajouter un&nbsp; séparateur entre les noms des colonnes et les données</a></div></div><br><div class="Img3 GImage"><img alt="/Tutoriels/Software_Development/C0/img/b_sqlite.png" class="lazy" data-src="/Tutoriels/Software_Development/C0/img/b_sqlite.png"></div><br><h2 class="Title7 GTitle2" id="Base-de-donnees-avec-SQLite-Installer-SQLite-sous-MSYS2"><a class="Link9" href="#Base-de-donnees-avec-SQLite">Installer SQLite sous MSYS2</a></h2><br><h3 class="Title8 GTitle3">Installer SQLite</h3><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-mode="c_cpp">pacman -S --needed --noconfirm mingw-w64-i686-sqlite3</pre></div></div><br><h2 class="Title7 GTitle2" id="Base-de-donnees-avec-SQLite-Tester-SQLite-sous-MSYS2"><a class="Link9" href="#Base-de-donnees-avec-SQLite">Tester SQLite sous MSYS2</a></h2><br><h3 class="Title8 GTitle3">Éditer le programme</h3><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-mode="c_cpp">//===============================================
#include &lt;sqlite3.h&gt;
#include &lt;stdio.h&gt;
//===============================================
int main(int argc, char** argv) {
