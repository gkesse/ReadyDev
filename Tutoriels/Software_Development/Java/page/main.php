...
//===============================================</xmp></pre></div><br><h2 class="Title7 GTitle2" id="Système d'administration-Résultat"><a class="Link9" href="#Système d'administration">Résultat</a></h2><br><br><br></div></div></div></div><br><div class="Content2 GTitle1"><div class="MainBlock2"><div class="Content"><h1 class="Title2 Center" id="Java Native Interface JNI"><a class="Link3" href="#">Java Native Interface JNI</a></h1><div class="Body3"><br><b>JNI </b>est une bibliothèque logicielle d'interfaçage, intégrée nativement au JDK de Java, qui permet au code Java s'exécutant à l'intérieur de la JVM d'appeler et d'être appelé par des applications natives basées sur des langages tels que le C, C++.<br><br><div class="Content0 GSummary2"><div class="Body0" id="Loader_1618859642247"><div class="Row26">Summary 2</div></div><script>loadSummary2("Loader_1618859642247");</script></div><br><div class="Img3 GImage"><img src="/Tutoriels/Software_Development/Java/img/b_jni.png" alt="/Tutoriels/Software_Development/Java/img/b_jni.png"></div><br><h2 class="Title7 GTitle2" id="Java Native Interface JNI-1 - Installation"><a class="Link9" href="#Java Native Interface JNI">1 - Installation</a></h2><br>Aucune installation n'est nécessaire.<br><br><h2 class="Title7 GTitle2" id="Java Native Interface JNI-2 - Tests"><a class="Link9" href="#Java Native Interface JNI">2 - Tests</a></h2><br><h2 class="Title7 GTitle2" id="Java Native Interface JNI-2.1 - Test sous Ubuntu"><a class="Link9" href="#Java Native Interface JNI">2.1 - Test sous Ubuntu</a></h2><br><h2 class="Title7 GTitle2" id="Java Native Interface JNI-2.1.1 - Test sous C"><a class="Link9" href="#Java Native Interface JNI">2.1.1 - Test sous C</a></h2><br><h2 class="Title7 GTitle2" id="Java Native Interface JNI-2.1.1.1 - Editer le programme Java"><a class="Link9" href="#Java Native Interface JNI">2.1.1.1 - Editer le programme Java</a></h2><br><h3 class="Title8 GTitle3">GMain.java</h3><br><div class="GCode1"><pre class="Code2"><xmp class="AceCode" data-mode="java">//===============================================
...
//===============================================</xmp></pre></div><br><h2 class="Title7 GTitle2" id="Java Native Interface JNI-2.1.1.2 - Générer le fichier header"><a class="Link9" href="#Java Native Interface JNI">2.1.1.2 - Générer le fichier header</a></h2><br><div class="GCode1"><pre class="Code2"><xmp class="AceCode" data-mode="batchfile">javac -h . com/pkg/readyc/GMain.java</xmp></pre></div><br><h3 class="Title8 GTitle3">com_pkg_readyc_GMain.h</h3><br><div class="GCode1"><pre class="Code2"><xmp class="AceCode" data-mode="c_cpp">/* DO NOT EDIT THIS FILE - it is machine generated */
#include &lt;jni.h&gt;
...
#endif
#endif</xmp></pre></div><br><div class="GCode1"><pre class="Code2"><xmp class="AceCode" data-mode="batchfile">cp -f com_pkg_readyc_GMain.h com_pkg_readyc_GMain.c</xmp></pre></div><br><h2 class="Title7 GTitle2" id="Java Native Interface JNI-2.1.1.3 - Editer le programme C"><a class="Link9" href="#Java Native Interface JNI">2.1.1.3 - Editer le programme C</a></h2><br><h3 class="Title8 GTitle3">com_pkg_readyc_GMain.c</h3><br><div class="GCode1"><pre class="Code2"><xmp class="AceCode" data-mode="c_cpp">//===============================================
...
//===============================================</xmp></pre></div><br><h2 class="Title7 GTitle2" id="Java Native Interface JNI-2.1.1.4 - Compiler le programme C"><a class="Link9" href="#Java Native Interface JNI">2.1.1.4 - Compiler le programme C</a></h2><br><div class="GCode1"><pre class="Code2"><xmp class="AceCode" data-mode="sh">gcc -std=gnu11 \
-c com_pkg_readyc_GMain.c \
-o com_pkg_readyc_GMain.o \
-I/usr/lib/jvm/java-15-openjdk-arm64/include \
-I/usr/lib/jvm/java-15-openjdk-arm64/include/linux</xmp></pre></div><br><h2 class="Title7 GTitle2" id="Java Native Interface JNI-2.1.1.5 - Créer la librairie dynamique C"><a class="Link9" href="#Java Native Interface JNI">2.1.1.5 - Créer la librairie dynamique C</a></h2><br><div class="GCode1"><pre class="Code2"><xmp class="AceCode" data-mode="sh">gcc -shared -fPIC -o librdc.so \
com_pkg_readyc_GMain.o</xmp></pre></div><br><h2 class="Title7 GTitle2" id="Java Native Interface JNI-2.1.1.6 - Exécuter le projet"><a class="Link9" href="#Java Native Interface JNI">2.1.1.6 - Exécuter le projet</a></h2><br><div class="GCode1"><pre class="Code2"><xmp class="AceCode" data-mode="sh">java com.pkg.readyc.GMain</xmp></pre></div><br><div class="GCode1"><pre class="Code2"><xmp class="AceCode" data-mode="sh">[C] Bonjour tout le monde</xmp></pre></div><br><h2 class="Title7 GTitle2" id="Java Native Interface JNI-2.1.2 - Test sous C++"><a class="Link9" href="#Java Native Interface JNI">2.1.2 - Test sous C++</a></h2><br><h2 class="Title7 GTitle2" id="Java Native Interface JNI-2.1.2.1 - Éditer le programme Java"><a class="Link9" href="#Java Native Interface JNI">2.1.2.1 - Éditer le programme Java</a></h2><br><h3 class="Title8 GTitle3">GMain.java</h3><br><div class="GCode1"><pre class="Code2"><xmp class="AceCode" data-mode="c_cpp">//===============================================
...
//===============================================</xmp></pre></div><br><h2 class="Title7 GTitle2" id="Java Native Interface JNI-2.1.2.2 - Générer le fichier header"><a class="Link9" href="#Java Native Interface JNI">2.1.2.2 - Générer le fichier header</a></h2><br><div class="GCode1"><pre class="Code2"><xmp class="AceCode" data-mode="c_cpp">javac -h . com/pkg/readycpp/GMain.java</xmp></pre></div><br><h3 class="Title8 GTitle3">com_pkg_readycpp_GMain.h</h3><br><div class="GCode1"><pre class="Code2"><xmp class="AceCode" data-mode="c_cpp">/* DO NOT EDIT THIS FILE - it is machine generated */
#include &lt;jni.h&gt;
...
#endif
#endif</xmp></pre></div><br><div class="GCode1"><pre class="Code2"><xmp class="AceCode" data-mode="c_cpp">cp -f com_pkg_readycpp_GMain.h com_pkg_readycpp_GMain.cpp</xmp></pre></div><br><h2 class="Title7 GTitle2" id="Java Native Interface JNI-2.1.2.3 - Editer le programme C++"><a class="Link9" href="#Java Native Interface JNI">2.1.2.3 - Editer le programme C++</a></h2><br><h3 class="Title8 GTitle3">com_pkg_readycpp_GMain.cpp</h3><br><div class="GCode1"><pre class="Code2"><xmp class="AceCode" data-mode="c_cpp">//===============================================
...
//===============================================</xmp></pre></div><br><h2 class="Title7 GTitle2" id="Java Native Interface JNI-2.1.2.4 - Compiler le programme C++"><a class="Link9" href="#Java Native Interface JNI">2.1.2.4 - Compiler le programme C++</a></h2><br><div class="GCode1"><pre class="Code2"><xmp class="AceCode" data-mode="batchfile">g++ -std=gnu++11 \
-c com_pkg_readycpp_GMain.cpp \
-o com_pkg_readycpp_GMain.o \
-I/usr/lib/jvm/java-15-openjdk-arm64/include \
-I/usr/lib/jvm/java-15-openjdk-arm64/include/linux</xmp></pre></div><br><h2 class="Title7 GTitle2" id="Java Native Interface JNI-2.1.2.5 - Créer la librairie dynamique C++"><a class="Link9" href="#Java Native Interface JNI">2.1.2.5 - Créer la librairie dynamique C++</a></h2><br><div class="GCode1"><pre class="Code2"><xmp class="AceCode" data-mode="batchfile">g++ -shared -fPIC -o librdcpp.so \
com_pkg_readycpp_GMain.o</xmp></pre></div><br><h2 class="Title7 GTitle2" id="Java Native Interface JNI-2.1.2.6 - Exécuter le projet"><a class="Link9" href="#Java Native Interface JNI">2.1.2.6 - Exécuter le projet</a></h2><br><div class="GCode1"><pre class="Code2"><xmp class="AceCode" data-mode="batchfile">java com.pkg.readycpp.GMain</xmp></pre></div><br><div class="GCode1"><pre class="Code2"><xmp class="AceCode" data-mode="txt">[C++] Bonjour tout le monde</xmp></pre></div><br></div></div></div></div><br>