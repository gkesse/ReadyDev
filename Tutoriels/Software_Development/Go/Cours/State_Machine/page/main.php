...
//===============================================</xmp></pre></div><br><h2 class="Title7 GTitle2" id="Créer une machine à états finis Go-Programme des méthodes"><a class="Link9" href="#Créer une machine à états finis Go">Programme des méthodes</a></h2><br><h3 class="Title8 GTitle3">GProcessUi.go</h3><br><div class="GCode1"><pre class="Code2"><xmp class="AceCode" data-mode="golang">//===============================================
...
//===============================================</xmp></pre></div><br><h2 class="Title7 GTitle2" id="Créer une machine à états finis Go-Programme SQLite"><a class="Link9" href="#Créer une machine à états finis Go">Programme SQLite</a></h2><br><h3 class="Title8 GTitle3">GProcessUi.go</h3><br><div class="GCode1"><pre class="Code2"><xmp class="AceCode" data-mode="golang">//===============================================
func (obj *GProcessUiO) run_SQLITE() {
    GSQLiteUi().Run();
    obj.G_STATE = "S_SAVE"
}
//===============================================</xmp></pre></div><br><h2 class="Title7 GTitle2" id="Créer une machine à états finis Go-Programme Qt"><a class="Link9" href="#Créer une machine à états finis Go">Programme Qt</a></h2><br><h3 class="Title8 GTitle3">GProcessUi.go</h3><br><div class="GCode1"><pre class="Code2"><xmp class="AceCode" data-mode="golang">//===============================================
func (obj *GProcessUiO) run_QT() {
    GQtUi().Run();
    obj.G_STATE = "S_SAVE"
}
//===============================================</xmp></pre></div><br><h2 class="Title7 GTitle2" id="Créer une machine à états finis Go-Programme de sauvegarde"><a class="Link9" href="#Créer une machine à états finis Go">Programme de sauvegarde</a></h2><br><h3 class="Title8 GTitle3">GProcessUi.go</h3><br><div class="GCode1"><pre class="Code2"><xmp class="AceCode" data-mode="golang">//===============================================
func (obj *GProcessUiO) run_SAVE() {
    obj.G_STATE = "S_END"
}
//===============================================</xmp></pre></div><br><h2 class="Title7 GTitle2" id="Créer une machine à états finis Go-Programme de chargement"><a class="Link9" href="#Créer une machine à états finis Go">Programme de chargement</a></h2><br><h3 class="Title8 GTitle3">GProcessUi.go</h3><br><div class="GCode1"><pre class="Code2"><xmp class="AceCode" data-mode="golang">//===============================================
