...
//===============================================
#endif
//===============================================</xmp></pre></div><br><h2 class="Title7 GTitle2" id="Créer une librairie statique C++-Définition de la librairie"><a class="Link9" href="#Créer une librairie statique C++">Définition de la librairie</a></h2><br><h3 class="Title8 GTitle3">hello.cpp</h3><br><div class="GCode1"><pre class="Code2"><xmp class="AceCode" data-mode="c_cpp">//===============================================
#include "hello.h"
//===============================================
#include &lt;iostream&gt;
//===============================================
...
//===============================================
void sayHello() {
    std::cout &lt;&lt; "[info] integration d'une librairie statique C++ en Go\n";
}
//===============================================
#ifdef __cplusplus
}
...
//===============================================</xmp></pre></div><br><h2 class="Title7 GTitle2" id="Utiliser une librairie statique C++ en Go-Fichier Makefile"><a class="Link9" href="#Utiliser une librairie statique C++ en Go">Fichier Makefile</a></h2><br><h3 class="Title8 GTitle3">Makefile (MinGW - Windows)</h3><br><div class="GCode1"><pre class="Code2"><xmp class="AceCode" data-mode="makefile">GSRC = ..\src
GBIN = bin
...
clean: 
	...
	del /q $(GBIN)\*
lib:
	@make -C $(GSRC)/lib</xmp></pre></div><br><h2 class="Title7 GTitle2" id="Utiliser une librairie statique C++ en Go-Résultat"><a class="Link9" href="#Utiliser une librairie statique C++ en Go">Résultat</a></h2><br><div class="Img3 GImage"><img src="/Tutoriels/Go/img/i_wrapper_Cpp_Static_library_02.png" alt="/Tutoriels/Go/img/i_wrapper_Cpp_Static_library_02.png"></div><br></div></div></div></div><br><div class="Content2 GTitle1"><div class="MainBlock2"><div class="Content"><h1 class="Title2 Center" id="Voir Aussi"><a class="Link3" href="#">Voir Aussi</a></h1><div class="Body3">Dans cette même catégorie, vous pouvez consulter aussi :<br><br><span class="GColor1" style="color:lime;">Développement de wrapper</span><br><br><div class="Content0 GList1"><div class="Body0" id="Loader_1604568346809"><div class="Row26">List 1 &gt; Go &gt; wrapper</div></div><script>loadList1("Loader_1604568346809","Go","wrapper");</script></div><br></div></div></div></div><br>