...
//===============================================</xmp></pre></div><br><h2 class="Title7 GTitle2" id="Créer une fenêtre personnalisée Qt en Go-Constructeur de la fenêtre personnalisée"><a class="Link9" href="#Créer une fenêtre personnalisée Qt en Go">Constructeur de la fenêtre personnalisée</a></h2><br><h3 class="Title8 GTitle3">GWindow.go</h3><br><div class="GCode1"><pre class="Code2"><xmp class="AceCode" data-mode="golang">//===============================================
