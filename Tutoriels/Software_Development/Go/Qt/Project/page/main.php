...
//===============================================</xmp></pre></div><br><h2 class="Title7 GTitle2" id="Créer un projet Qt en Go-Fichier Makefile"><a class="Link9" href="#Créer un projet Qt en Go">Fichier Makefile</a></h2><br><h3 class="Title8 GTitle3">Makefile</h3><br><div class="GCode1"><pre class="Code2"><xmp class="AceCode" data-mode="makefile">GSRC = ..\code\GProject\src
GBIN = bin
...
clean: 
	@if not exist $(GBIN) ( @mkdir $(GBIN) )
	del /q $(GBIN)\*
</xmp></pre></div><br><h2 class="Title7 GTitle2" id="Créer un projet Qt en Go-Variables d’environnement"><a class="Link9" href="#Créer un projet Qt en Go">Variables d’environnement</a></h2><br><h3 class="Title8 GTitle3">env.bat (MinGW - Windows)</h3><br><div class="GCode1"><pre class="Code2"><xmp class="AceCode" data-mode="batchfile">@echo off
::=====================================
...
::===============================================
mingw32-make args="%*"
::===============================================</xmp></pre></div><br><h2 class="Title7 GTitle2" id="Créer un projet Qt en Go-Compilation manuelle"><a class="Link9" href="#Créer un projet Qt en Go">Compilation manuelle</a></h2><br><h3 class="Title8 GTitle3">Terminal</h3><br><div class="GCode1"><pre class="Code2"><xmp class="AceCode" data-mode="batchfile">make</xmp></pre></div><br><h2 class="Title7 GTitle2" id="Créer un projet Qt en Go-Compilation automatique"><a class="Link9" href="#Créer un projet Qt en Go">Compilation automatique</a></h2><br><h3 class="Title8 GTitle3">Terminal</h3><br><div class="GCode1"><pre class="Code2"><xmp class="AceCode" data-mode="batchfile">del /q bin\*
go build -o bin\gp_go.exe ..\code\GProject\src</xmp></pre></div><br><h2 class="Title7 GTitle2" id="Créer un projet Qt en Go-Résultat"><a class="Link9" href="#Créer un projet Qt en Go">Résultat</a></h2><br><div class="Img3 GImage"><img src="/Tutoriels/Go/img/i_qt_project.png" alt="/Tutoriels/Go/img/i_qt_project.png"></div><br></div></div></div></div><br><div class="Content2 GTitle1"><div class="MainBlock2"><div class="Content"><h1 class="Title2 Center" id="Voir Aussi"><a class="Link3" href="#">Voir Aussi</a></h1><div class="Body3">Dans cette même catégorie, vous pouvez consulter aussi :<br><br><span class="GColor1" style="color:lime;">Interface Homme-Machine Qt</span><br><br><div class="Content0 GList1"><div class="Body0" id="Loader_1605458922954"><div class="Row26">List 1 &gt; Go &gt; qt</div></div><script>loadList1("Loader_1605458922954","Go","qt");</script></div><br></div></div></div></div><br>