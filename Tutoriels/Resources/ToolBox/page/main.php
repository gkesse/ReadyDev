...
Binding -&gt; Ctrl + B
When -&gt; In Windows
Apply and Close</pre></div></div><br><h2 class="Title7 GTitle2" id="Eclipse-Rechercher-un-texte"><a class="Link9" href="#Eclipse">Rechercher un texte</a></h2><br><h3 class="Title8 GTitle3">Rechercher un texte (par clic)<br></h3><br>La recherche par texte permet de déterminer tous les endroits où un texte est utilisé.<br><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-state="off" data-mode="c_cpp">Clic droit sur le texte à rechercher
Search Text -&gt; Workspace</pre></div></div><br><div class="Img3 GImage"><img src="/Tutoriels/Resources/ToolBox/img/i_eclipse_search_text_clic.png" alt="/Tutoriels/Resources/ToolBox/img/i_eclipse_search_text_clic.png"></div><br><h3 class="Title8 GTitle3">Rechercher un texte (par sélection)</h3><br>La recherche par texte permet de déterminer tous les endroits où un texte est utilisé.<br><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-state="off" data-mode="c_cpp">Sélectionner le texte à rechercher
Clic droit sur le texte à rechercher
Search Text -&gt; Workspace</pre></div></div><br><div class="Img3 GImage"><img src="/Tutoriels/Resources/ToolBox/img/i_eclipse_search_text_edition.png" alt="/Tutoriels/Resources/ToolBox/img/i_eclipse_search_text_edition.png"></div><br><h3 class="Title8 GTitle3">Rechercher un texte (par édition)</h3><br>La recherche par texte permet de déterminer tous les endroits où un texte est utilisé.<br><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-state="off" data-mode="c_cpp">ECLIPSE -&gt; Search -&gt; Search (Ctrl + H)
Containing text -&gt; MY_SEARCH_TEXT
File name pattern -&gt; *
Scope -&gt; Workspace
Search</pre></div></div><br><div class="Img3 GImage"><img src="/Tutoriels/Resources/ToolBox/img/i_eclipse_search_text_edition.png" alt="/Tutoriels/Resources/ToolBox/img/i_eclipse_search_text_edition.png"></div><br><h2 class="Title7 GTitle2" id="Eclipse-Rechercher-des-references"><a class="Link9" href="#Eclipse">Rechercher des références</a></h2><br><h3 class="Title8 GTitle3">Rechercher les références d'une variable</h3><br>La recherche par référence d'une variable permet de déterminer tous les endroits où la variable est appelée.<br><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-state="off" data-mode="c_cpp">Clic droit sur la variable à rechercher
...
References -&gt; Workspace</pre></div></div><br><div class="Img3 GImage"><img src="/Tutoriels/Resources/ToolBox/img/i_eclipse_references_function.png" alt="/Tutoriels/Resources/ToolBox/img/i_eclipse_references_function.png"></div><br><h2 class="Title7 GTitle2" id="Eclipse-Rechercher-des-implementations"><a class="Link9" href="#Eclipse">Rechercher des implémentations</a></h2><br><h3 class="Title8 GTitle3">Rechercher les implémentations d'une fonction virtuelle (depuis un parent)<br></h3><br>La recherche par hiérachie d'une fonction permet de déterminer tous les implémentations d'une fonction.<br><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-state="off" data-mode="c_cpp">Clic droit sur la fonction virtuelle à rechercher
Quick Type Hierarchy</pre></div></div><br><div class="Img3 GImage"><img src="/Tutoriels/Resources/ToolBox/img/i_eclipse_hierarchy_parent.png" alt="/Tutoriels/Resources/ToolBox/img/i_eclipse_hierarchy_parent.png"></div><br><h3 class="Title8 GTitle3">Rechercher les implémentations d'une fonction virtuelle (depuis un enfant)</h3><br>La recherche par hiérachie d'une fonction permet de déterminer tous les implémentations d'une fonction.<br><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-state="off" data-mode="c_cpp">Clic droit sur la fonction virtuelle à rechercher
Quick Type Hierarchy</pre></div></div><br><div class="Img3 GImage"><img src="/Tutoriels/Resources/ToolBox/img/i_eclipse_hierarchy_child.png" alt="/Tutoriels/Resources/ToolBox/img/i_eclipse_hierarchy_child.png"></div><br><h2 class="Title7 GTitle2" id="Eclipse-Rechercher-des-heritiers"><a class="Link9" href="#Eclipse">Rechercher des héritiers</a></h2><br><h3 class="Title8 GTitle3">Rechercher les enfants d'une classe (depuis un parent)</h3><br>La recherche par hiérachie d'une classe permet de déterminer tous les parents ou tous les enfants associés à la classe.<br><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-state="off" data-mode="c_cpp">Clic droit sur la classe à rechercher
Quick Type Hierarchy</pre></div></div><br><div class="Img3 GImage"><img src="/Tutoriels/Resources/ToolBox/img/i_eclipse_class_child.png" alt="/Tutoriels/Resources/ToolBox/img/i_eclipse_class_child.png"></div><br><h3 class="Title8 GTitle3">Rechercher les parents d'une classe (depuis un enfant)</h3><br>La recherche par hiérachie d'une classe permet de déterminer tous les parents ou tous les enfants associés à la classe.<br><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-state="off" data-mode="c_cpp">Clic droit sur la classe à rechercher
Quick Type Hierarchy</pre></div></div><br><div class="Img3 GImage"><img src="/Tutoriels/Resources/ToolBox/img/i_eclipse_class_parent.png" alt="/Tutoriels/Resources/ToolBox/img/i_eclipse_class_parent.png"></div><br><h2 class="Title7 GTitle2" id="Eclipse-Rechercher-la-hierachie-des-appels"><a class="Link9" href="#Eclipse">Rechercher la hiérachie des appels</a></h2><br><h3 class="Title8 GTitle3">Rechercher la hiérachie des appels d'une fonction</h3><br>La recherche par hiérachie des appels d'une fonction permet de déterminer toute la pile des appels d'une fonctions.<br><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-state="off" data-mode="c_cpp">Clic droit sur la fonction à rechercher
Open Call Hierarchy</pre></div></div><br><div class="Img3 GImage"><img src="/Tutoriels/Resources/ToolBox/img/i_eclipse_hierarchy_function.png" alt="/Tutoriels/Resources/ToolBox/img/i_eclipse_hierarchy_function.png"></div><br><h2 class="Title7 GTitle2" id="Eclipse-Papyrus"><a class="Link9" href="#Eclipse">Papyrus</a></h2><br><h3 class="Title8 GTitle3">Documentation sur Papyrus</h3><br><a class="Link7 GLink1" style="color:lime;" target="_blank" href="https://www.eclipse.org/papyrus/documentation.html">https://www.eclipse.org/papyrus/documentation.html</a><br><br><h3 class="Title8 GTitle3">Installer Papyrus</h3><br><div class="GCode1"><div class="Code2"><pre class="AceCode" data-state="off" data-mode="c_cpp">Help -&gt; Install New Software -&gt; Add
Name -&gt; Papyrus
