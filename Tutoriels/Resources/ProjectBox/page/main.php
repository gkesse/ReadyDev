...
//===============================================</pre></div></div><br><h3 class="Title8 GTitle3">Résultat</h3><br><div class="Img3 GImage"><img alt="/Tutoriels/Resources/ProjectBox/img/i_login_connect.gif" class="lazy" data-src="/Tutoriels/Resources/ProjectBox/img/i_login_connect.gif"></div><br></div></div></div></div><br>