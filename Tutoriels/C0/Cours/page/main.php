...
//===============================================</xmp></pre></div><br><h2 class="Title7 GTitle2" id="Gérer les conditions-Résultat"><a class="Link9" href="#Gérer les conditions">Résultat</a></h2><br><div class="Img3 GImage"><img src="img/if_else.png" alt="img/if_else.png"></div><br></div></div></div></div><br>