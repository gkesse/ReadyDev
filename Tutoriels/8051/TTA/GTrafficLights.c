...
void GTrafficLights_Light_L1() {
    switch(gLight_L1_State) {
        case RED: {
            ...
            LIGHT_AMBER_L1 = LIGHT_OFF;
            LIGHT_GREEN_L1 = LIGHT_OFF;
            if(++gLight_L1_Time >= LIGHT_RED_DURATION) {
        ...
        case RED_AMBER: {
            ...
            LIGHT_AMBER_L1 = LIGHT_OFF;
            LIGHT_GREEN_L1 = LIGHT_OFF;
            if(++gLight_L1_Time >= LIGHT_RED_AMBER_DURATION) {
        ...
        case RED_RED_1: {
            ...
            LIGHT_AMBER_L1 = LIGHT_OFF;
            LIGHT_GREEN_L1 = LIGHT_OFF;
            if(++gLight_L1_Time >= LIGHT_RED_RED_1_DURATION) {
        ...
        case GREEN: {
            ...
            if(++gLight_L1_Time >= LIGHT_GREEN_DURATION) {
        ...
        case AMBER: {
            ...
            LIGHT_GREEN_L1 = LIGHT_OFF;
            if(++gLight_L1_Time >= LIGHT_AMBER_DURATION) {
        ...
        case RED_RED_2: {
            ...
            LIGHT_AMBER_L1 = LIGHT_OFF;
            LIGHT_GREEN_L1 = LIGHT_OFF;
            if(++gLight_L1_Time >= LIGHT_RED_RED_2_DURATION) {
                gLight_L1_State = RED;
                gLight_L1_Time = 0;    
            } 
            break;
...
void GTrafficLights_Light_L2() {
    switch(gLight_L2_State) {
        case RED: {
            ...
            LIGHT_AMBER_L2 = LIGHT_OFF;
            LIGHT_GREEN_L2 = LIGHT_OFF;
            if(++gLight_L2_Time >= LIGHT_RED_DURATION) {
        ...
        case RED_AMBER: {
            ...
            LIGHT_AMBER_L2 = LIGHT_OFF;
            LIGHT_GREEN_L2 = LIGHT_OFF;
            if(++gLight_L2_Time >= LIGHT_RED_AMBER_DURATION) {
        ...
        case RED_RED_1: {
            ...
            LIGHT_AMBER_L2 = LIGHT_OFF;
            LIGHT_GREEN_L2 = LIGHT_OFF;
            if(++gLight_L2_Time >= LIGHT_RED_RED_1_DURATION) {
        ...
        case GREEN: {
            ...
            if(++gLight_L2_Time >= LIGHT_GREEN_DURATION) {
        ...
        case AMBER: {
            ...
            LIGHT_GREEN_L2 = LIGHT_OFF;
            if(++gLight_L2_Time >= LIGHT_AMBER_DURATION) {
        ...
        case RED_RED_2: {
            ...
            LIGHT_AMBER_L2 = LIGHT_OFF;
            LIGHT_GREEN_L2 = LIGHT_OFF;
            if(++gLight_L2_Time >= LIGHT_RED_RED_2_DURATION) {
                gLight_L2_State = RED;
                gLight_L2_Time = 0;    
            } 
            break;
