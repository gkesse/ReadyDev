...
//===============================================</xmp></pre></div><br><h2 class="Title7 GTitle2" id="Définir un système d'exploitation embarqué simple Timer T2-Système d'exploitation embarqué simple"><a class="Link9" href="#Définir un système d'exploitation embarqué simple Timer T2">Système d'exploitation embarqué simple</a></h2><br><h3 class="Title8 GTitle3">Initialisation du sEOS</h3><div class="GCode1"><pre class="Code2"><xmp class="AceCode" data-mode="c_cpp">//===============================================
...
//===============================================</xmp></pre></div><br><h3 class="Title8 GTitle3">Démarrage du mode Idle</h3><div class="GCode1"><pre class="Code2"><xmp class="AceCode" data-mode="c_cpp">//===============================================
...
//===============================================
</xmp></pre></div><br><h2 class="Title7 GTitle2" id="Définir un système d'exploitation embarqué simple Timer T2-Clignotement de la diode LED"><a class="Link9" href="#Définir un système d'exploitation embarqué simple Timer T2">Clignotement de la diode LED</a></h2><br><h3 class="Title8 GTitle3">Mise à jour des proches</h3><div class="GCode1"><pre class="Code2"><xmp class="AceCode" data-mode="c_cpp">//===============================================
void GLedFlash_Update() {
    if(++gLedFlash_Time >= 1000) {
        gLedFlash_Time = 0;
        if(gLedFlash_State == FALSE) {
...
//===============================================</xmp></pre></div><br><h2 class="Title7 GTitle2" id="Définir un système d'exploitation embarqué simple Timer T2-Simulation électrique"><a class="Link9" href="#Définir un système d'exploitation embarqué simple Timer T2">Simulation électrique</a></h2><br><h3 class="Title8 GTitle3">Simulation électrique</h3><br><span class="GColor1" style="color:lime;">Diode LED éteinte pendant 1s</span><div class="Img3 GImage"><img src="img/SEOS_Timer_T2.png" alt="img/SEOS_Timer_T2.png"></div><br><span class="GColor1" style="color:lime;">Diode LED allumée pendant 1s</span><div class="Img3 GImage"><img src="img/SEOS_Timer_T2_02.png" alt="img/SEOS_Timer_T2_02.png"></div><br><span class="GColor1" style="color:lime;">Forme d'onde (Les délais sont très précis)</span><div class="Img3 GImage"><img src="img/SEOS_Timer_T2_03.png" alt="img/SEOS_Timer_T2_03.png"></div><br><span class="GColor1" style="color:lime;">Analyse de performance (Processeur en mode Idle à 91.9 % du temps)</span><div class="Img3 GImage"><img src="img/SEOS_Timer_T2_04.png" alt="img/SEOS_Timer_T2_04.png"></div></div></div></div></div><br><div class="Content2 GTitle1"><div class="MainBlock2"><div class="Content"><h1 class="Title2 Center" id="Définir un système d'exploitation embarqué simple Timer T0"><a class="Link3" href="#">Définir un système d'exploitation embarqué simple Timer T0</a></h1><div class="Body3">Le but de cette section est de vous apprendre à <span class="GColor1" style="color:lime;">définir un système d'exploitation embarqué simple</span> à base du Timer T0 avec le C 8051.<br>Produit par <b>Gérard KESSE</b>.<br><br>Le <b>sEOS</b> (Simple Embedded Operating System) permet gérer des applications embarquées multitâches temps réel.<br><br><div class="Content0 GSummary2"><div class="Body0" id="Loader_1534568563893"><div class="Row26">Summary 2</div></div><script>loadSummary2("Loader_1534568563893");</script></div><br><h2 class="Title7 GTitle2" id="Définir un système d'exploitation embarqué simple Timer T0-Programme principal"><a class="Link9" href="#Définir un système d'exploitation embarqué simple Timer T0">Programme principal</a></h2><br><h3 class="Title8 GTitle3">Programme principal</h3><div class="GCode1"><pre class="Code2"><xmp class="AceCode" data-mode="c_cpp">//===============================================
void main() {
	GSeos_Init(1);
	GLedFlash_Init();
	GSeos_Start();
...
//===============================================</xmp></pre></div><br><h2 class="Title7 GTitle2" id="Définir un système d'exploitation embarqué simple Timer T0-Système d'exploitation embarqué simple"><a class="Link9" href="#Définir un système d'exploitation embarqué simple Timer T0">Système d'exploitation embarqué simple</a></h2><br><h3 class="Title8 GTitle3">Initialisation du sEOS</h3><div class="GCode1"><pre class="Code2"><xmp class="AceCode" data-mode="c_cpp">//===============================================
void GSeos_Init(uchar ms) {
    uint lPreload = (65536 - ((OSC_FREQ * ms) / (OSC_PER_INST * 1000)));
...
//===============================================</xmp></pre></div><br><h2 class="Title7 GTitle2" id="Définir un système d'exploitation embarqué simple Timer T0-Clignotement de la diode LED"><a class="Link9" href="#Définir un système d'exploitation embarqué simple Timer T0">Clignotement de la diode LED</a></h2><br><h3 class="Title8 GTitle3">Mise à jour des broches</h3><div class="GCode1"><pre class="Code2"><xmp class="AceCode" data-mode="c_cpp">//===============================================
void GLedFlash_Update() {
    if(++gLedFlash_Time >= 1000) {
        gLedFlash_Time = 0;
        if(gLedFlash_State == FALSE) {
