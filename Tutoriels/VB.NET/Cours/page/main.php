...
mingw32-make</xmp></pre></div><br><h3 class="Title8 GTitle3">Résultat</h3><div class="Img3"><img src="img/Vbc_Utilisation.png" alt="img/Vbc_Utilisation.png"></div></div></div></div></div><br><br>