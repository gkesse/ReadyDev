<div class="Parallax GParallax1"><div class="Img Binary"><div class="Caption"><a href="#"><div class="Text">Apprendre la gestion d'une base de données SQLite en C++</div></a></div></div><div class="Body2 Orange"><b>SQLite</b> est un système de gestion de base données relationnelle.<br>Le but de ce tutoriel est de vous apprendre la gestion d'une base de données <b>SQLite </b>en <b>C++</b>.<br>Produit par <b>Gérard KESSE</b>.<br>&nbsp;<br><div class="Content0 GSummary1"><div class="Body0" id="Loader_1529412976174"><div class="Row26">Summary 1</div></div><script>loadSummary1("Loader_1529412976174");</script></div></div></div><br><div class="Content2 GTitle1"><div class="MainBlock2"><div class="Content"><h1 class="Title2 Center" id="Introduction"><a class="Link3" href="#">Introduction</a></h1><div class="Body3">SQLite est un système de gestion de base données relationnelle.<br><br><div class="Img3 GImage"><img src="/data/img/defaults/banner_sqlite.png" alt="/data/img/defaults/banner_sqlite.png"></div><br>Dans ce tutoriel, nous utiliserons:<br>- SQLite, comme système de gestion de base de données.<br><br><h3 class="Title8 GTitle3">Documentation sur SQLite</h3><a class="Link7 GLink1" style="color:lime;" target="_blank" href="https://www.sqlite.org/cintro.html">https://www.sqlite.org/cintro.html</a><br><br></div></div></div></div><br><div class="Content2 GTitle1"><div class="MainBlock2"><div class="Content"><h1 class="Title2 Center" id="Création d'une base données"><a class="Link3" href="#">Création d'une base données</a></h1><div class="Body3">Dans ce modèle, nous utilisons un fichier qui contient toutes nos requêtes SQL et un fichier qui contient la requête SQL à exécuter. Ensuite, nous chargeons la requête à exécuter et enfin, nous procédons à son exécution.<br><br><div class="Content0 GSummary2"><div class="Body0" id="Loader_1589710939725"><div class="Row26">Summary 2</div></div><script>loadSummary2("Loader_1589710939725");</script></div><br><h2 class="Title7 GTitle2" id="Création d'une base données-Résultat de la création de base de données"><a class="Link9" href="#Création d'une base données">Résultat de la création de base de données</a></h2><br><div class="Img3 GImage"><img src="img/query.png" alt="img/query.png"></div><br><h2 class="Title7 GTitle2" id="Création d'une base données-Chargement d'une requête"><a class="Link9" href="#Création d'une base données">Chargement d'une requête</a></h2><br><div class="GCode1"><pre class="Code2"><xmp class="AceCode" data-mode="c_cpp">//===============================================
