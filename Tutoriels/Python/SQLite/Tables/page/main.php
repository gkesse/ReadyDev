...
def run_CONFIG_SHOW(self):
    ...
    """, 1, [20,50], 20)
    self.G_STATE = "S_SAVE"
#================================================</xmp></pre></div><br><h2 class="Title7 GTitle2" id="Afficher les tables SQLite en Python-Programme d'affichage d'une requête"><a class="Link9" href="#Afficher les tables SQLite en Python">Programme d'affichage d'une requête</a></h2><br><div class="GCode1"><pre class="Code2"><xmp class="AceCode" data-mode="python">#================================================
