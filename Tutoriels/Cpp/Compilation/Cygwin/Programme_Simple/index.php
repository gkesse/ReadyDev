<?php
    ...
    $m_data = GJson::Instance()->getData("data/json/Cygwin_01.json");
    
    GHeader::Instance()->setTitle("Cygwin");
    GHeader::Instance()->setMenu("Tutoriels");
    GHeader::Instance()->setView("Cygwin_01");
...
<div class="pgBg">
    <div class="mrga pgBd pgCr10">
        ...
        <div class="pgCt10">
            <div class="bga">
                <h1 class="bga clrb pgCt20">Cygwin</h1>
