<?php
    ...
    $m_data = GJson::Instance()->getData("data/json/CMake_07.json");
    
    GConfig::Instance()->setData("title", "CMake");
    GConfig::Instance()->setData("menu", "Tutoriels");
    GConfig::Instance()->setData("view", "CMake_07");
...
set(GINCLUDEPATH ../../cmake/lib/hello/include)
...
set(GLIBPATH ../cmake/lib/hello/lib)
set(GLIBS Manager Hello)
include_directories(${GINCLUDEPATH})
