...
void GSectionReadyVision::slotModuleAdd(const QString& module) {
    ...
    connect(lModule, SIGNAL(emitWorkspaceShowImage(int,cv::Mat)), this, SIGNAL(emitWorkspaceShowImage(int,cv::Mat)));
    ...
    emit emitWorkspaceCreate(module, lModule->getModuleName());
