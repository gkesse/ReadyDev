...
lWindow-&gt;show();</xmp></pre></div><br><h2 class="Title7 GTitle2" id="Créer une fenêtre personnalisée Qt en C++-Fichier header"><a class="Link9" href="#Créer une fenêtre personnalisée Qt en C++">Fichier header</a></h2><br><h3 class="Title8 GTitle3">GWindow.h</h3><br><div class="GCode1"><pre class="Code2"><xmp class="AceCode" data-mode="c_cpp">//===============================================
#ifndef _GWindow_
#define _GWindow_
//===============================================
#include "GInclude.h"
