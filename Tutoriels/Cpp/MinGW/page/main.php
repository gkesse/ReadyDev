...
g++ -o bin/GProject.exe  build/main.o  build/GProcess.o -Llib/Hello/bin –lHello</xmp></pre></div></div></div></div><br><div class="pgCt00"><div class="bgra"><h1 class="bgra pgCt20 txac Title1" id="Codes sources"><a class="clrb" href="#Sommaire">Codes sources</a></h1><div class="txal pgCt10">Ajouter un texte ici...</div></div></div>