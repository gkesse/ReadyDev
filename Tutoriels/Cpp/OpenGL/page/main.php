...
//===============================================</xmp></pre></div><br><h3 class="Title8 GTitle3">Résultat</h3><div class="Img3 GImage"><img src="img/Glfw_Application.png" alt="img/Glfw_Application.png"></div></div></div></div></div><br><br>