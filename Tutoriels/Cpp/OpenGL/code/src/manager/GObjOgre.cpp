...
//===============================================
GObjOgre::GObjOgre(const char* fileName) {
    initObject(fileName);
}
//===============================================
GObjOgre::~GObjOgre() {
...
//===============================================
void GObjOgre::initObject(const char* fileName) {
    loadOBJ(fileName);
}
//===============================================
void GObjOgre::loadOBJ(const char* fileName) {
    ...
    {
        glm::vec3 &p1 = points[faces[i]];
        glm::vec3 &p2 = points[faces[i+1]];
        glm::vec3 &p3 = points[faces[i+2]];

        glm::vec2 &tc1 = texCoords[faces[i]];
        glm::vec2 &tc2 = texCoords[faces[i+1]];
        glm::vec2 &tc3 = texCoords[faces[i+2]];
...
//===============================================
void GObjOgre::trimString(string& str) {
