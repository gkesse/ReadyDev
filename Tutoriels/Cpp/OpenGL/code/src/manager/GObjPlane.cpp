...
//===============================================
GObjPlane::GObjPlane(float xsize, float zsize, int xdivs, int zdivs) {
    initObject(xsize, zsize, xdivs, zdivs);
}
//===============================================
GObjPlane::~GObjPlane() {
...
//===============================================
void GObjPlane::initObject(float xsize, float zsize, int xdivs, int zdivs) {
...
//===============================================
void GObjPlane::draw(GLuint program, glm::mat4& projection, glm::mat4& modelview) {
    glBindVertexArray(vaoHandle);
