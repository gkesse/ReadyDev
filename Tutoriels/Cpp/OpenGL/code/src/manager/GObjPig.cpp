...
//===============================================
void GObjPig::generateAveragedNormals(
...
void GObjPig::center( vector<glm::vec3> & points ) {
...
void GObjPig::storeVBO( const vector<glm::vec3> & points,
                        const vector<glm::vec3> & normals,
                        const vector<glm::vec2> &texCoords,
...
void GObjPig::trimString( string & str ) {
