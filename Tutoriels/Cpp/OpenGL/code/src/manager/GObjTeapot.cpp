...
#include "GShader.h"
#include "GDataTeapot.h"
//===============================================
GObjTeapot::GObjTeapot() {

}
//===============================================
GObjTeapot::GObjTeapot(int grid, glm::mat4 lidTransform) {
    initObject(grid, lidTransform);
}
//===============================================
GObjTeapot::~GObjTeapot() {
...
//===============================================
void GObjTeapot::initObject(int grid, glm::mat4 lidTransform) {
...
//===============================================
void GObjTeapot::generatePatches(float * v, float * n, float * tc, unsigned int* el, int grid) {
...
//===============================================
void GObjTeapot::moveLid(int grid, float *v, glm::mat4 lidTransform) {
...
//===============================================
void GObjTeapot::buildPatchReflect(int patchNum,
                                  float *B, float *dB,
                                  float *v, float *n,
...
//===============================================
void GObjTeapot::buildPatch(glm::vec3 patch[][4],
float *B, float *dB,
...
//===============================================
void GObjTeapot::getPatch( int patchNum, glm::vec3 patch[][4], bool reverseV )
{
...
//===============================================
void GObjTeapot::computeBasisFunctions( float * B, float * dB, int grid ) {
    float inc = 1.0f / grid;
    for( int i = 0; i <= grid; i++ )
    {
        float t = i * inc;
...
//===============================================
glm::vec3 GObjTeapot::evaluate( int gridU, int gridV, float *B, glm::vec3 patch[][4] )
{
...
//===============================================
glm::vec3 GObjTeapot::evaluateNormal( int gridU, int gridV, float *B, float *dB, glm::vec3 patch[][4] )
{
...
//===============================================
void GObjTeapot::draw(const GLuint program, const glm::mat4& projection, const glm::mat4& modelView) {
    glBindVertexArray(vaoHandle);
