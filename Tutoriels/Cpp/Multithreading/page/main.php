...
//===============================================</xmp></pre></div><br><h3 class="Title8 GTitle3">Résultat</h3><br><span class="GColor1" style="color:lime;">Création du processus</span><div class="Img3 GImage"><img src="img/Process_Implementation.png" alt="img/Process_Implementation.png"></div><br><span class="GColor1" style="color:lime;">Lecture de l'id du processus</span><div class="Img3 GImage"><img src="img/Process_Implementation_02.png" alt="img/Process_Implementation_02.png"></div></div></div></div></div><br>