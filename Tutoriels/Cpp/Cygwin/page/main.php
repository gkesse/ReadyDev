...
make clean</xmp></pre></div><br><b>win/cmd_compile.bat</b><br><div class="Code1"><pre><xmp class="ovfa prettyprint linenums">@echo off

set PATH=C:\cygwin\bin

make</xmp></pre></div><br><b>win/cmd_run.bat</b><br><div class="Code1"><pre><xmp class="ovfa prettyprint linenums">@echo off
...
bin\GProject.exe
echo.
pause</xmp></pre></div><br><b>Nettoyage du projet :</b><br>cmd_clean.bat<br><br><b>Compilation du projet :</b><br>cmd_compile.bat<br><br><b>Exécution du projet :</b><br>cmd_run.bat<br><br><b>Construction du projet :</b><br>cmd_build.bat<br><br><b>Construction manuel :</b><br><div class="Code1"><pre><xmp class="ovfa prettyprint linenums lang-sh">rm -f build/* bin/*
...
clean:
    rm -f $(GBUILD)/* $(GBIN)/*</xmp></pre></div><br><b>Construction du projet :</b><br>cmd_build.bat<br><br><b>Construction manuel :</b><br><div class="Code1"><pre><xmp class="ovfa prettyprint linenums lang-sh">rm -f build/* bin/*
...
bin\GProject.exe
echo.
pause</xmp></pre></div><br><b>Construction du projet :</b><br>cmd_build.bat<br><br><b>Construction manuel :</b><br><div class="Code1"><pre><xmp class="ovfa prettyprint linenums lang-sh">rm -f build/* bin/*
g++ -c ../src/main.cpp -o build/main.o -Ilib/Hello/include
...
g++ -o bin/GProject.exe  build/main.o  build/GProcess.o -Llib/Hello/bin –lHello</xmp></pre></div></div></div></div><br><div class="pgCt00"><div class="bgra"><h1 class="bgra pgCt20 txac Title1" id="Code sources"><a class="clrb" href="#Sommaire">Code sources</a></h1><div class="txal pgCt10"><b>ReadyDev</b> met à votre disposition,<br>l'ensemble des codes sources abordés dans ce tutoriel.<br><br><div class="brda Code2"><div class="bgra txal pgCt00" id="FilesystemMenu">...</div><div class="txal ovfa mxha" id="FilesystemList">...</div></div><script src="/js/class/GFilesystem.js"></script><script src="/js/filesystem.js"></script></div></div></div>