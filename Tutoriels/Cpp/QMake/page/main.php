...
set PATH=C:\QMake\bin

QMake32-make clean</xmp></pre></div><br><b>win/cmd_compile.bat</b><br><div class="Code1"><pre><xmp class="ovfa prettyprint linenums">@echo off

set PATH=C:\QMake\bin

QMake32-make</xmp></pre></div><br><b>win/cmd_run.bat</b><br><div class="Code1"><pre><xmp class="ovfa prettyprint linenums">@echo off
...
g++ -c ../src/manager/GShow.cpp -o build/GShow.o -I../src/manager
g++ -c ../src/manager/GMath.cpp -o build/GMath.o -I../src/manager
ar rcs bin/libHello.a build/GShow.o build/GMath.o</xmp></pre></div><br><h2 class="ftwn Title2" id="Utiliser une librairie statique en C++"><a class="bgra dibm ftfb ftsg clra pgCt10" href="#Gérer les librairies statiques avec QMake">Utiliser une librairie statique en C++</a></h2><br><b>Objectif :</b><br>Utiliser une librairie statique en C++.<br><br><b>Implémentation :</b><br>Utiliser la classe (GMath) de la librairie statique (libHello.a) pour réaliser des opérations arithmétiques sur deux nombres données (22, 7).<br>Utiliser la classe (GShow) de la librairie statique (libHello.a) pour afficher les résultats de calculs.<br><br><b>Résultat :</b><br> <div class="ovfa"><img src="img/Image_02.png" alt="img/Image_02.png"></div><br><b>Dossier projet :</b><br>src/main.cpp<br>win/Makeifle<br>win/bin/<br>win/build/<br><br><b>Dossier librairie :</b><br>win/lib/<br>win/lib/Hello/include/GMath.h<br>win/lib/Hello/include/GShow.h<br>win/lib/Hello/lib/libHello.a<br><br><b>src/main.cpp</b><br><div class="Code1"><pre><xmp class="ovfa prettyprint linenums">//===============================================
#include "GShow.h"
#include "GMath.h"
//===============================================
using namespace std;
...
g++ -shared -o bin/libHello.dll build/GShow.o build/GMath.o</xmp></pre></div><br><h2 class="ftwn Title2" id="Utiliser une librairie dynamique en C++"><a class="bgra dibm ftfb ftsg clra pgCt10" href="#Gérer les librairies dynamiques avec QMake">Utiliser une librairie dynamique en C++</a></h2><br><b>Objectif :</b><br>Utiliser une librairie dynamique en C++.<br><br><b>Implémentation :</b><br>Utiliser la classe (GMath) de la librairie dynamique (libHello.dll) pour réaliser des opérations arithmétiques sur deux nombres données (22, 7).<br>Utiliser la classe (GShow) de la librairie dynamique (libHello.dll) pour afficher les résultats de calculs.<br><br><b>Résultat :</b><br> <div class="ovfa"><img src="img/Image_02.png" alt="img/Image_02.png"></div><br><b>Dossier projet :</b><br>src/main.cpp<br>win/Makeifle<br>win/bin/<br>win/build/<br><br><b>Dossier librairie :</b><br>win/lib/<br>win/lib/Hello/include/GMath.h<br>win/lib/Hello/include/GShow.h<br>win/lib/Hello/bin/libHello.dll<br><b><br>src/main.cpp</b><br><div class="Code1"><pre><xmp class="ovfa prettyprint linenums">//===============================================
#include "GShow.h"
#include "GMath.h"
//===============================================
using namespace std;
