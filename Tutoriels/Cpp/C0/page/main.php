...
//===============================================</xmp></pre></div><br><h2 class="Title7 GTitle2" id="Gestionnaire de settings-Résultat"><a class="Link9" href="#Gestionnaire de settings">Résultat</a></h2><br><h3 class="Title8 GTitle3">Résultat</h3><div class="Img3 GImage"><img src="img/Setting.png" alt="img/Setting.png"></div></div></div></div></div><br>