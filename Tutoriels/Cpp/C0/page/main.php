...
//===============================================</xmp></pre></div><br><h2 class="Title7 GTitle2" id="Gestionnaire de settings-Fichier de settings"><a class="Link9" href="#Gestionnaire de settings">Fichier de settings</a></h2><br><h3 class="Title8 GTitle3">Fichier de settings</h3><span class="GColor1" style="color:lime;">data/config/config.txt</span><br><div class="Img3 GImage"><img src="img/Setting.png" alt="img/Setting.png"></div><br><h2 class="Title7 GTitle2" id="Gestionnaire de settings-Résultat"><a class="Link9" href="#Gestionnaire de settings">Résultat</a></h2><br><h3 class="Title8 GTitle3">Résultat</h3><div class="Img3 GImage"><img src="img/Setting_02.png" alt="img/Setting_02.png"></div></div></div></div></div><br>