...
//===============================================</xmp></pre></div><br><h2 class="Title7 GTitle2" id="Afficher les données d'une table SQLite C++-Affichage d'une requête"><a class="Link9" href="#Afficher les données d'une table SQLite C++">Affichage d'une requête</a></h2><br><h3 class="Title8 GTitle3">GSQLite.cpp</h3><br><div class="GCode1"><pre class="Code2"><xmp class="AceCode" data-mode="c_cpp">//===============================================
...
//===============================================</xmp></pre></div><br><h2 class="Title7 GTitle2" id="Afficher les données d'une table SQLite C++-Fonction de rappel"><a class="Link9" href="#Afficher les données d'une table SQLite C++">Fonction de rappel</a></h2><br><h3 class="Title8 GTitle3">GSQLite.cpp</h3><br><div class="GCode1"><pre class="Code2"><xmp class="AceCode" data-mode="c_cpp">//===============================================
