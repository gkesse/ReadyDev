...
%================================================
\end{document}
%================================================</xmp></pre></div><h3 class="Title8 GTitle3">Compilation du programme LaTex (cmd_latex.bat)</h3><div class="GCode1"><pre><xmp class="Code2 prettyprint linenums lang-sh">@echo off
...
-output-directory %GBUILD%</xmp></pre></div><br><h3 class="Title8 GTitle3">Création du document Pdf (cmd_pdf_create.bat)</h3><div class="GCode1"><pre><xmp class="Code2 prettyprint linenums lang-sh">@echo off
...
-o %GPDF%\main.pdf</xmp></pre></div><br><h3 class="Title8 GTitle3">Ouverture du document Pdf (cmd_pdf_open.bat)<br></h3><div class="GCode1"><pre><xmp class="Code2 prettyprint linenums lang-sh">@echo off

set PATH=C:\Program Files (x86)\Adobe\Reader 11.0\Reader

set GPDF=%cd%\pdf

AcroRd32 %GPDF%\main.pdf</xmp></pre></div><br><h3 class="Title8 GTitle3">Résultat</h3><div class="Img3"><img src="img/MiKTeX_Utilisation.png" alt="img/MiKTeX_Utilisation.png"></div></div></div></div></div><br>